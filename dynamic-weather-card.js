var t=function(i,o,a,n){var l=arguments.length,s=l<3?o:n===null?n=Object.getOwnPropertyDescriptor(o,a):n,r;if(typeof Reflect==="object"&&typeof Reflect.decorate==="function")s=Reflect.decorate(i,o,a,n);else for(var c=i.length-1;c>=0;c--)if(r=i[c])s=(l<3?r(s):l>3?r(o,a,s):r(o,a))||s;return l>3&&s&&Object.defineProperty(o,a,s),s};var ai=globalThis,wi=ai.ShadowRoot&&(ai.ShadyCSS===void 0||ai.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,mi=Symbol(),Ei=new WeakMap;class pi{constructor(i,o,a){if(this._$cssResult$=!0,a!==mi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=i,this._strings=o}get styleSheet(){let i=this._styleSheet,o=this._strings;if(wi&&i===void 0){let a=o!==void 0&&o.length===1;if(a)i=Ei.get(o);if(i===void 0){if((this._styleSheet=i=new CSSStyleSheet).replaceSync(this.cssText),a)Ei.set(o,i)}}return i}toString(){return this.cssText}}var aa=(i)=>{if(i._$cssResult$===!0)return i.cssText;else if(typeof i==="number")return i;else throw Error(`Value passed to 'css' function must be a 'css' function result: ${i}. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)},na=(i)=>new pi(typeof i==="string"?i:String(i),void 0,mi),W=(i,...o)=>{let a=i.length===1?i[0]:o.reduce((n,l,s)=>n+aa(l)+i[s+1],i[0]);return new pi(a,i,mi)},io=(i,o)=>{if(wi)i.adoptedStyleSheets=o.map((a)=>a instanceof CSSStyleSheet?a:a.styleSheet);else for(let a of o){let n=document.createElement("style"),l=ai.litNonce;if(l!==void 0)n.setAttribute("nonce",l);n.textContent=a.cssText,i.appendChild(n)}},la=(i)=>{let o="";for(let a of i.cssRules)o+=a.cssText;return na(o)},Mi=wi?(i)=>i:(i)=>i instanceof CSSStyleSheet?la(i):i;var{is:sa,defineProperty:ra,getOwnPropertyDescriptor:oo,getOwnPropertyNames:ca,getOwnPropertySymbols:_a,getPrototypeOf:ao}=Object,da=!1,F=globalThis;if(da)F.customElements??=customElements;var H=!0,A,no=F.trustedTypes,ga=no?no.emptyScript:"",so=H?F.reactiveElementPolyfillSupportDevMode:F.reactiveElementPolyfillSupport;if(H)F.litIssuedWarnings??=new Set,A=(i,o)=>{if(o+=` See https://lit.dev/msg/${i} for more information.`,!F.litIssuedWarnings.has(o)&&!F.litIssuedWarnings.has(i))console.warn(o),F.litIssuedWarnings.add(o)},queueMicrotask(()=>{if(A("dev-mode","Lit is in dev mode. Not recommended for production!"),F.ShadyDOM?.inUse&&so===void 0)A("polyfill-support-missing","Shadow DOM is being polyfilled via `ShadyDOM` but the `polyfill-support` module has not been loaded.")});var ha=H?(i)=>{if(!F.emitLitDebugLogEvents)return;F.dispatchEvent(new CustomEvent("lit-debug",{detail:i}))}:void 0,C=(i,o)=>i,D={toAttribute(i,o){switch(o){case Boolean:i=i?ga:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i);break}return i},fromAttribute(i,o){let a=i;switch(o){case Boolean:a=i!==null;break;case Number:a=i===null?null:Number(i);break;case Object:case Array:try{a=JSON.parse(i)}catch(n){a=null}break}return a}},ni=(i,o)=>!sa(i,o),lo={attribute:!0,type:String,converter:D,reflect:!1,useDefault:!1,hasChanged:ni};Symbol.metadata??=Symbol("metadata");F.litPropertyMetadata??=new WeakMap;class v extends HTMLElement{static addInitializer(i){this.__prepare(),(this._initializers??=[]).push(i)}static get observedAttributes(){return this.finalize(),this.__attributeToPropertyMap&&[...this.__attributeToPropertyMap.keys()]}static createProperty(i,o=lo){if(o.state)o.attribute=!1;if(this.__prepare(),this.prototype.hasOwnProperty(i))o=Object.create(o),o.wrapped=!0;if(this.elementProperties.set(i,o),!o.noAccessor){let a=H?Symbol.for(`${String(i)} (@property() cache)`):Symbol(),n=this.getPropertyDescriptor(i,a,o);if(n!==void 0)ra(this.prototype,i,n)}}static getPropertyDescriptor(i,o,a){let{get:n,set:l}=oo(this.prototype,i)??{get(){return this[o]},set(s){this[o]=s}};if(H&&n==null){if("value"in(oo(this.prototype,i)??{}))throw Error(`Field ${JSON.stringify(String(i))} on ${this.name} was declared as a reactive property but it's actually declared as a value on the prototype. Usually this is due to using @property or @state on a method.`);A("reactive-property-without-getter",`Field ${JSON.stringify(String(i))} on ${this.name} was declared as a reactive property but it does not have a getter. This will be an error in a future version of Lit.`)}return{get:n,set(s){let r=n?.call(this);l?.call(this,s),this.requestUpdate(i,r,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(i){return this.elementProperties.get(i)??lo}static __prepare(){if(this.hasOwnProperty(C("elementProperties",this)))return;let i=ao(this);if(i.finalize(),i._initializers!==void 0)this._initializers=[...i._initializers];this.elementProperties=new Map(i.elementProperties)}static finalize(){if(this.hasOwnProperty(C("finalized",this)))return;if(this.finalized=!0,this.__prepare(),this.hasOwnProperty(C("properties",this))){let o=this.properties,a=[...ca(o),..._a(o)];for(let n of a)this.createProperty(n,o[n])}let i=this[Symbol.metadata];if(i!==null){let o=litPropertyMetadata.get(i);if(o!==void 0)for(let[a,n]of o)this.elementProperties.set(a,n)}this.__attributeToPropertyMap=new Map;for(let[o,a]of this.elementProperties){let n=this.__attributeNameForProperty(o,a);if(n!==void 0)this.__attributeToPropertyMap.set(n,o)}if(this.elementStyles=this.finalizeStyles(this.styles),H){if(this.hasOwnProperty("createProperty"))A("no-override-create-property","Overriding ReactiveElement.createProperty() is deprecated. The override will not be called with standard decorators");if(this.hasOwnProperty("getPropertyDescriptor"))A("no-override-get-property-descriptor","Overriding ReactiveElement.getPropertyDescriptor() is deprecated. The override will not be called with standard decorators")}}static finalizeStyles(i){let o=[];if(Array.isArray(i)){let a=new Set(i.flat(1/0).reverse());for(let n of a)o.unshift(Mi(n))}else if(i!==void 0)o.push(Mi(i));return o}static __attributeNameForProperty(i,o){let a=o.attribute;return a===!1?void 0:typeof a==="string"?a:typeof i==="string"?i.toLowerCase():void 0}constructor(){super();this.__instanceProperties=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this.__reflectingProperty=null,this.__initialize()}__initialize(){this.__updatePromise=new Promise((i)=>this.enableUpdating=i),this._$changedProperties=new Map,this.__saveInstanceProperties(),this.requestUpdate(),this.constructor._initializers?.forEach((i)=>i(this))}addController(i){if((this.__controllers??=new Set).add(i),this.renderRoot!==void 0&&this.isConnected)i.hostConnected?.()}removeController(i){this.__controllers?.delete(i)}__saveInstanceProperties(){let i=new Map,o=this.constructor.elementProperties;for(let a of o.keys())if(this.hasOwnProperty(a))i.set(a,this[a]),delete this[a];if(i.size>0)this.__instanceProperties=i}createRenderRoot(){let i=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return io(i,this.constructor.elementStyles),i}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this.__controllers?.forEach((i)=>i.hostConnected?.())}enableUpdating(i){}disconnectedCallback(){this.__controllers?.forEach((i)=>i.hostDisconnected?.())}attributeChangedCallback(i,o,a){this._$attributeToProperty(i,a)}__propertyToAttribute(i,o){let n=this.constructor.elementProperties.get(i),l=this.constructor.__attributeNameForProperty(i,n);if(l!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:D).toAttribute(o,n.type);if(H&&this.constructor.enabledWarnings.includes("migration")&&r===void 0)A("undefined-attribute-value",`The attribute value for the ${i} property is undefined on element ${this.localName}. The attribute will be removed, but in the previous version of \`ReactiveElement\`, the attribute would not have changed.`);if(this.__reflectingProperty=i,r==null)this.removeAttribute(l);else this.setAttribute(l,r);this.__reflectingProperty=null}}_$attributeToProperty(i,o){let a=this.constructor,n=a.__attributeToPropertyMap.get(i);if(n!==void 0&&this.__reflectingProperty!==n){let l=a.getPropertyOptions(n),s=typeof l.converter==="function"?{fromAttribute:l.converter}:l.converter?.fromAttribute!==void 0?l.converter:D;this.__reflectingProperty=n;let r=s.fromAttribute(o,l.type);this[n]=r??this.__defaultValues?.get(n)??r,this.__reflectingProperty=null}}requestUpdate(i,o,a,n=!1,l){if(i!==void 0){if(H&&i instanceof Event)A("","The requestUpdate() method was called with an Event as the property name. This is probably a mistake caused by binding this.requestUpdate as an event listener. Instead bind a function that will call it with no arguments: () => this.requestUpdate()");let s=this.constructor;if(n===!1)l=this[i];if(a??=s.getPropertyOptions(i),(a.hasChanged??ni)(l,o)||a.useDefault&&a.reflect&&l===this.__defaultValues?.get(i)&&!this.hasAttribute(s.__attributeNameForProperty(i,a)))this._$changeProperty(i,o,a);else return}if(this.isUpdatePending===!1)this.__updatePromise=this.__enqueueUpdate()}_$changeProperty(i,o,{useDefault:a,reflect:n,wrapped:l},s){if(a&&!(this.__defaultValues??=new Map).has(i)){if(this.__defaultValues.set(i,s??o??this[i]),l!==!0||s!==void 0)return}if(!this._$changedProperties.has(i)){if(!this.hasUpdated&&!a)o=void 0;this._$changedProperties.set(i,o)}if(n===!0&&this.__reflectingProperty!==i)(this.__reflectingProperties??=new Set).add(i)}async __enqueueUpdate(){this.isUpdatePending=!0;try{await this.__updatePromise}catch(o){Promise.reject(o)}let i=this.scheduleUpdate();if(i!=null)await i;return!this.isUpdatePending}scheduleUpdate(){let i=this.performUpdate();if(H&&this.constructor.enabledWarnings.includes("async-perform-update")&&typeof i?.then==="function")A("async-perform-update",`Element ${this.localName} returned a Promise from performUpdate(). This behavior is deprecated and will be removed in a future version of ReactiveElement.`);return i}performUpdate(){if(!this.isUpdatePending)return;if(ha?.({kind:"update"}),!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),H){let l=[...this.constructor.elementProperties.keys()].filter((s)=>this.hasOwnProperty(s)&&(s in ao(this)));if(l.length)throw Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${l.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`)}if(this.__instanceProperties){for(let[n,l]of this.__instanceProperties)this[n]=l;this.__instanceProperties=void 0}let a=this.constructor.elementProperties;if(a.size>0)for(let[n,l]of a){let{wrapped:s}=l,r=this[n];if(s===!0&&!this._$changedProperties.has(n)&&r!==void 0)this._$changeProperty(n,void 0,l,r)}}let i=!1,o=this._$changedProperties;try{if(i=this.shouldUpdate(o),i)this.willUpdate(o),this.__controllers?.forEach((a)=>a.hostUpdate?.()),this.update(o);else this.__markUpdated()}catch(a){throw i=!1,this.__markUpdated(),a}if(i)this._$didUpdate(o)}willUpdate(i){}_$didUpdate(i){if(this.__controllers?.forEach((o)=>o.hostUpdated?.()),!this.hasUpdated)this.hasUpdated=!0,this.firstUpdated(i);if(this.updated(i),H&&this.isUpdatePending&&this.constructor.enabledWarnings.includes("change-in-update"))A("change-in-update",`Element ${this.localName} scheduled an update (generally because a property was set) after an update completed, causing a new update to be scheduled. This is inefficient and should be avoided unless the next update can only be scheduled as a side effect of the previous update.`)}__markUpdated(){this._$changedProperties=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.__updatePromise}shouldUpdate(i){return!0}update(i){this.__reflectingProperties&&=this.__reflectingProperties.forEach((o)=>this.__propertyToAttribute(o,this[o])),this.__markUpdated()}updated(i){}firstUpdated(i){}}v.elementStyles=[];v.shadowRootOptions={mode:"open"};v[C("elementProperties",v)]=new Map;v[C("finalized",v)]=new Map;so?.({ReactiveElement:v});if(H){v.enabledWarnings=["change-in-update","async-perform-update"];let i=function(o){if(!o.hasOwnProperty(C("enabledWarnings",o)))o.enabledWarnings=o.enabledWarnings.slice()};v.enableWarning=function(o){if(i(this),!this.enabledWarnings.includes(o))this.enabledWarnings.push(o)},v.disableWarning=function(o){i(this);let a=this.enabledWarnings.indexOf(o);if(a>=0)this.enabledWarnings.splice(a,1)}}(F.reactiveElementVersions??=[]).push("2.1.2");if(H&&F.reactiveElementVersions.length>1)queueMicrotask(()=>{A("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});var K=globalThis,k=(i)=>{if(!K.emitLitDebugLogEvents)return;K.dispatchEvent(new CustomEvent("lit-debug",{detail:i}))},ua=0,R;K.litIssuedWarnings??=new Set,R=(i,o)=>{if(o+=i?` See https://lit.dev/msg/${i} for more information.`:"",!K.litIssuedWarnings.has(o)&&!K.litIssuedWarnings.has(i))console.warn(o),K.litIssuedWarnings.add(o)},queueMicrotask(()=>{R("dev-mode","Lit is in dev mode. Not recommended for production!")});var N=K.ShadyDOM?.inUse&&K.ShadyDOM?.noPatch===!0?K.ShadyDOM.wrap:(i)=>i,li=K.trustedTypes,ro=li?li.createPolicy("lit-html",{createHTML:(i)=>i}):void 0,ea=(i)=>i,_i=(i,o,a)=>ea,ka=(i)=>{if(P!==_i)throw Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");P=i},ya=()=>{P=_i},vi=(i,o,a)=>{return P(i,o,a)},ko="$lit$",J=`lit$${Math.random().toFixed(9).slice(2)}$`,yo="?"+J,fa=`<${yo}>`,$=document,U=()=>$.createComment(""),X=(i)=>i===null||typeof i!="object"&&typeof i!="function",Ki=Array.isArray,ta=(i)=>Ki(i)||typeof i?.[Symbol.iterator]==="function",bi=`[ 	
\f\r]`,wa=`[^ 	
\f\r"'\`<>=]`,ma=`[^\\s"'>=/]`,T=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,co=1,zi=2,pa=3,_o=/-->/g,go=/>/g,x=new RegExp(`>|${bi}(?:(${ma}+)(${bi}*=${bi}*(?:${wa}|("|')|))|$)`,"g"),Ma=0,ho=1,ba=2,uo=3,Fi=/'/g,Hi=/"/g,fo=/^(?:script|style|textarea|title)$/i,za=1,si=2,ri=3,Zi=1,ci=2,Fa=3,Ha=4,va=5,Ai=6,Ka=7,Ni=(i)=>(o,...a)=>{if(o.some((n)=>n===void 0))console.warn(`Some template strings are undefined.
...
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:i,strings:o,values:a}},e=Ni(za),y=Ni(si),_n=Ni(ri),Q=Symbol.for("lit-noChange"),M=Symbol.for("lit-nothing"),eo=new WeakMap,B=$.createTreeWalker($,129),P=_i;function to(i,o){if(!Ki(i)||!i.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
...
`,Ya={sunny:y`
  ...
  `};function ii(i,...o){let a=Xa[i];if(typeof a==="function")return a(...o);return a||""}function ei(i){if(!i)return"";return Ya[i.toLowerCase()]||""}class Uo extends b{constructor(){super(...arguments);this.weather=null;this.sunData=null;this.config=null;this.entityAttributes=null;this.compact=!1}static styles=W`
    :host {
      display: block;
    }
  ...
  `;hasContent(){if(!this.weather||!this.config)return!1;return this.config.showHumidity&&this.weather.humidity!=null||this.config.showWind&&this.weather.windSpeed!=null||this.config.showSunriseSunset&&this.sunData?.hasSunData===!0}renderHumidity(){if(!this.config?.showHumidity||this.weather?.humidity==null)return e``;return e`
    ...
    `}renderSunrise(){if(!this.config?.showSunriseSunset||!this.sunData?.hasSunData||!this.sunData.sunrise)return e``;return e`
      <div class="info-item">
        ...
        <span>${Si(this.sunData.sunrise,this.config.clockFormat,d.t("am"),d.t("pm"))}</span>
      </div>
    `}renderWind(){if(!this.config?.showWind||this.weather?.windSpeed==null)return e``;let i=this.entityAttributes||{},o=Bi(this.weather.windSpeed,i,this.config.windSpeedUnit),a=Go(i,this.config.windSpeedUnit,d.t.bind(d)),n="";if(this.config.showWindGust&&this.weather.windGust)n=` / ${Bi(this.weather.windGust,i,this.config.windSpeedUnit)} ${a}`;let l=this.config.showWindDirection&&this.weather.windBearing!=null?Ro(this.weather.windBearing):ii("wind");return e`
      <div class="info-item">
...
`;class Xo extends b{constructor(){super(...arguments);this.forecast=[];this.clockFormat="24h"}static styles=ki;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=hi(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(i){return Math.round(i.temperature??i.temp??i.native_temperature??0)}render(){if(this.forecast.length===0)return e``;return e`
      <div class="forecast-container">
        <div class="forecast-title">${d.t("forecast_title")}</div>
        <div class="forecast-scroll">
          ${this.forecast.map((i)=>e`
    ...
    `}}t([w({type:Array})],Xo.prototype,"forecast",void 0),t([w({type:String})],Xo.prototype,"clockFormat",void 0);customElements.define("hourly-forecast",Xo);class Yo extends b{constructor(){super(...arguments);this.forecast=[];this.lang="en"}static styles=ki;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=hi(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(i){return Math.round(i.temperature??i.temp??i.native_temperature??0)}render(){if(this.forecast.length===0)return e``;return e`
      <div class="forecast-container">
    ...
    `}}t([w({type:Array})],Yo.prototype,"forecast",void 0),t([w({type:String})],Yo.prototype,"lang",void 0);customElements.define("daily-forecast",Yo);class Ui extends b{animationManager;forecastService;actionHandler;subscribedEntity=null;subscribedShowDaily=!1;_testTimeOfDay;static get styles(){return To}static getConfigElement(){return document.createElement("dynamic-weather-card-editor")}static getStubConfig(){return{type:"custom:dynamic-weather-card",entity:"weather.home",show_hourly_forecast:!0,hourly_forecast_hours:g.hourlyForecastHours,show_daily_forecast:!0,daily_forecast_days:g.dailyForecastDays}}constructor(){super();this.config={},this.animationManager=new Di(()=>this.getDrawParams()),this.forecastService=new Ti(()=>this.requestUpdate()),this.actionHandler=new Vi(()=>this.hass,()=>this.config,(i,o)=>this.fireEvent(i,o))}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{setTimeout(()=>{let i=this.shadowRoot?.querySelector(".canvas-container");if(i)this.animationManager.setup(i)},100)})}disconnectedCallback(){super.disconnectedCallback(),this.animationManager.destroy(),this.forecastService.unsubscribe()}updated(i){if(super.updated(i),i.has("hass")||i.has("config")){let a=this.config.entity,n=this.config.showDailyForecast??!1;if(this.hass&&a&&(a!==this.subscribedEntity||n!==this.subscribedShowDaily))this.subscribedEntity=a,this.subscribedShowDaily=n,this.forecastService.subscribe(this.hass,a,n)}let o=O({configLang:this.config?.language,hassLang:this.hass?.language});if(d.lang!==o)d.setLanguage(o)}getDrawParams(){if(!this.hass||!this.config.entity)return null;let i=Ri(this.hass,this.config.entity,this.config,this.forecastService.getHourlyData()),o=this.hass.states[this.config.entity],a=Wi(o||{},this.config.sunriseEntity,this.config.sunsetEntity,this.hass),n=this._testTimeOfDay||xi(a);return{condition:i.condition,timeOfDay:n}}getDetailsConfig(){return{showHumidity:this.config.showHumidity??!0,showWind:this.config.showWind??!0,showWindGust:this.config.showWindGust??!0,showWindDirection:this.config.showWindDirection??!0,showSunriseSunset:this.config.showSunriseSunset??!0,clockFormat:this.config.clockFormat??"24h",windSpeedUnit:this.config.windSpeedUnit??"ms"}}setConfig(i){if(!i.entity)throw Error("Please define a weather entity");let o=i.show_hourly_forecast??i.show_forecast;if(this.config={type:"custom:dynamic-weather-card",entity:i.entity,icons_path:i.icons_path,name:i.name,height:i.height||g.height,showFeelsLike:i.show_feels_like!==!1,showWind:i.show_wind!==!1,showWindGust:i.show_wind_gust!==!1,showWindDirection:i.show_wind_direction!==!1,showHumidity:i.show_humidity!==!1,showMinTemp:i.show_min_temp!==!1,showForecast:i.show_forecast===!0,showHourlyForecast:o===!0,showDailyForecast:i.show_daily_forecast===!0,hourlyForecastHours:i.hourly_forecast_hours??g.hourlyForecastHours,dailyForecastDays:i.daily_forecast_days??g.dailyForecastDays,showSunriseSunset:i.show_sunrise_sunset!==!1,showClock:i.show_clock===!0,clockPosition:i.clock_position||g.clockPosition,clockFormat:i.clock_format||g.clockFormat,overlayOpacity:i.overlay_opacity!==void 0?i.overlay_opacity:g.overlayOpacity,textShadow:i.text_shadow!==void 0?i.text_shadow:g.textShadow,language:i.language||g.language,windSpeedUnit:i.wind_speed_unit||g.windSpeedUnit,layout:i.layout||g.layout,sunriseEntity:i.sunrise_entity||null,sunsetEntity:i.sunset_entity||null,templowAttribute:i.templow_attribute||null,tapAction:i.tap_action||{action:"more-info"},holdAction:i.hold_action||{action:"none"},doubleTapAction:i.double_tap_action||{action:"none"}},this.config.language)d.setLanguage(this.config.language)}fireEvent(i,o={}){let a=new CustomEvent(i,{detail:o,bubbles:!0,composed:!0});this.dispatchEvent(a)}getCardSize(){return 1}render(){if(!this.hass)return e`<div>No Home Assistant connection</div>`;let i=Ri(this.hass,this.config.entity,this.config,this.forecastService.getHourlyData()),o=this.hass.states[this.config.entity],a=Wi(o,this.config.sunriseEntity,this.config.sunsetEntity,this.hass),n=this._testTimeOfDay||xi(a),l=`weather-card ${n.type}`,s=this.config.layout==="minimal",r=s?"56px":"200px",c=this.config.height?`${this.config.height}px`:r,_=Po(n),h=_?`background: linear-gradient(135deg, rgb(${_.start.r}, ${_.start.g}, ${_.start.b}), rgb(${_.end.r}, ${_.end.g}, ${_.end.b}));`:"",f=`--overlay-opacity: ${this.config.overlayOpacity!==void 0?this.config.overlayOpacity:g.overlayOpacity};`,m=this.config.textShadow??g.textShadow,p=m===0?"none":[`0 1px 2px rgba(0,0,0,${Math.min(1,0.4*m).toFixed(2)})`,`0 2px 6px rgba(0,0,0,${Math.min(1,0.3*m).toFixed(2)})`,`0 4px 12px rgba(0,0,0,${Math.min(1,0.2*m).toFixed(2)})`].join(", "),Z=m===0?"none":`drop-shadow(0px 1px 3px rgba(0,0,0,${Math.min(1,0.6*m).toFixed(2)}))`,fi=`--card-text-shadow: ${p}; --card-icon-filter: ${Z};`,ti=this.config.showHourlyForecast?this.forecastService.getHourlyForecast(this.config.hourlyForecastHours??g.hourlyForecastHours,i):[],oa=this.config.showDailyForecast?this.forecastService.getDailyForecast(this.config.dailyForecastDays??g.dailyForecastDays,i):[],Ii=`min-height: ${c}; ${h}; ${f} ${fi} cursor: pointer;`,Oi=this.hass;return e`
      ...
      >
        ${s?this.renderMinimal(i,a,Oi,l,Ii):this.renderDefault(i,a,ti,oa,Oi,l,Ii)}
      </ha-card>
    `}renderDefault(i,o,a,n,l,s,r){return e`
      <div class="${s}" style="${r}">
        ...
        <div class="content">
          ...
          <div class="details ${this.config.showClock&&this.config.clockPosition==="details"?"details--clock":""}">
            <weather-details
              ...
              .entityAttributes=${ui(l,this.config.entity)}
            ></weather-details>
            <weather-clock
    ...
    `}renderMinimal(i,o,a,n,l){let s=i.temperature!=null?Math.round(i.temperature)+"°":d.t("no_data"),r=i.templow!=null?`↓ ${Math.round(i.templow)}°`:null;return e`
      <div class="${n} layout--minimal" style="${l}">
        <div class="canvas-container"></div>
        <div class="content">
          <div class="mini-primary">
            <div class="mini-temp">${s}</div>
            ${this.config.showMinTemp&&r?e`<div class="mini-temp-low">${r}</div>`:""}
          </div>
    ...
    `}}t([w({type:Object})],Ui.prototype,"hass",void 0),t([w({type:Object})],Ui.prototype,"config",void 0);class Xi extends b{constructor(){super(...arguments);this._config={}}setConfig(i){this._config={name:"",layout:g.layout,height:g.height,show_feels_like:g.showFeelsLike,show_wind:g.showWind,show_wind_gust:g.showWindGust,show_wind_direction:g.showWindDirection,show_humidity:g.showHumidity,show_min_temp:g.showMinTemp,show_hourly_forecast:g.showHourlyForecast,hourly_forecast_hours:g.hourlyForecastHours,show_daily_forecast:g.showDailyForecast,daily_forecast_days:g.dailyForecastDays,show_sunrise_sunset:g.showSunriseSunset,show_clock:g.showClock,clock_position:g.clockPosition,clock_format:g.clockFormat,overlay_opacity:g.overlayOpacity,text_shadow:g.textShadow,language:g.language,wind_speed_unit:g.windSpeedUnit,sunrise_entity:"",sunset_entity:"",...i}}updated(i){if(super.updated(i),i.has("hass")){let o=O({hassLang:this.hass?.language});if(d.lang!==o)d.setLanguage(o),this.requestUpdate()}}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:["weather"]}}},{name:"name",selector:{text:{}}},{name:"layout",selector:{select:{options:[{label:d.t("editor.layout_default"),value:"default"},{label:d.t("editor.layout_minimal"),value:"minimal"}]}}},{name:"height",selector:{number:{min:50,max:800,step:10,mode:"box"}}},{name:"show_feels_like",selector:{boolean:{}}},{name:"show_wind",selector:{boolean:{}}},{name:"show_wind_gust",selector:{boolean:{}}},{name:"show_wind_direction",selector:{boolean:{}}},{name:"show_humidity",selector:{boolean:{}}},{name:"show_min_temp",selector:{boolean:{}}},{name:"show_hourly_forecast",selector:{boolean:{}}},{name:"hourly_forecast_hours",selector:{number:{min:1,max:24,step:1,mode:"box"}}},{name:"show_daily_forecast",selector:{boolean:{}}},{name:"daily_forecast_days",selector:{number:{min:1,max:14,step:1,mode:"box"}}},{name:"show_sunrise_sunset",selector:{boolean:{}}},{name:"sunrise_entity",selector:{entity:{domain:["sensor"]}}},{name:"sunset_entity",selector:{entity:{domain:["sensor"]}}},{name:"show_clock",selector:{boolean:{}}},{name:"clock_position",selector:{select:{options:[{label:d.t("editor.clock_position_top"),value:"top"},{label:d.t("editor.clock_position_details"),value:"details"}]}}},{name:"clock_format",selector:{select:{options:[{label:d.t("editor.clock_format_24h"),value:"24h"},{label:d.t("editor.clock_format_12h"),value:"12h"}]}}},{name:"overlay_opacity",selector:{number:{min:0,max:1,step:0.05,mode:"box"}}},{name:"text_shadow",selector:{number:{min:0,max:3,step:1,mode:"box"}}},{name:"language",selector:{select:{options:[{label:d.t("editor.language_auto"),value:"auto"},{label:d.t("editor.language_en"),value:"en"},{label:d.t("editor.language_ru"),value:"ru"},{label:d.t("editor.language_de"),value:"de"},{label:d.t("editor.language_nl"),value:"nl"},{label:d.t("editor.language_fr"),value:"fr"},{label:d.t("editor.language_es"),value:"es"},{label:d.t("editor.language_it"),value:"it"},{label:d.t("editor.language_sk"),value:"sk"},{label:d.t("editor.language_hu"),value:"hu"}]}}},{name:"wind_speed_unit",selector:{select:{options:[{label:d.t("editor.wind_speed_unit_ms"),value:"ms"},{label:d.t("editor.wind_speed_unit_kmh"),value:"kmh"}]}}}]}_computeLabel=(i)=>{let o=`editor.${i.name}`,a=d.t(o);return a===o?i.name:a};_valueChanged(i){let o=i.detail?.value;if(!o)return;this._config=o,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}render(){if(!this.hass)return e``;return e`
      ...
      ></ha-form>
    `}}t([w({attribute:!1})],Xi.prototype,"hass",void 0),t([di()],Xi.prototype,"_config",void 0);var Lo={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Io=(i)=>(...o)=>({["_$litDirective$"]:i,values:o});class Yi{constructor(i){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(i,o,a){this.__part=i,this._$parent=o,this.__attributeIndex=a}_$resolve(i,o){return this.update(i,o)}update(i,o){return this.render(...o)}}var La=!0,hr=La&&window.ShadyDOM?.inUse&&window.ShadyDOM?.noPatch===!0?window.ShadyDOM.wrap:(i)=>i;var Oo=(i)=>i.strings===void 0;var Ia=!0,oi=(i,o)=>{let a=i._$disconnectableChildren;if(a===void 0)return!1;for(let n of a)n._$notifyDirectiveConnectionChanged?.(o,!1),oi(n,o);return!0},yi=(i)=>{let o,a;do{if((o=i._$parent)===void 0)break;a=o._$disconnectableChildren,a.delete(i),i=o}while(a?.size===0)},Eo=(i)=>{for(let o;o=i._$parent;i=o){let a=o._$disconnectableChildren;if(a===void 0)o._$disconnectableChildren=a=new Set;else if(a.has(i))break;a.add(i),on(o)}};function Oa(i){if(this._$disconnectableChildren!==void 0)yi(this),this._$parent=i,Eo(this);else this._$parent=i}function Ea(i,o=!1,a=0){let n=this._$committedValue,l=this._$disconnectableChildren;if(l===void 0||l.size===0)return;if(o){if(Array.isArray(n))for(let s=a;s<n.length;s++)oi(n[s],!1),yi(n[s]);else if(n!=null)oi(n,!1),yi(n)}else oi(this,i)}var on=(i)=>{if(i.type==Lo.CHILD)i._$notifyConnectionChanged??=Ea,i._$reparentDisconnectables??=Oa};class Li extends Yi{constructor(){super(...arguments);this._$disconnectableChildren=void 0}_$initialize(i,o,a){super._$initialize(i,o,a),Eo(this),this.isConnected=i._$isConnected}["_$notifyDirectiveConnectionChanged"](i,o=!0){if(i!==this.isConnected)if(this.isConnected=i,i)this.reconnected?.();else this.disconnected?.();if(o)oi(this,i),yi(this)}setValue(i){if(Oo(this.__part))this.__part._$setValue(i,this);else{if(Ia&&this.__attributeIndex===void 0)throw Error("Expected this.__attributeIndex to be a number");let o=[...this.__part._$committedValue];o[this.__attributeIndex]=i,this.__part._$setValue(o,this,0)}}disconnected(){}reconnected(){}}class ia extends Li{_key="";_onLangChange=null;render(i){return this._key=i,d.t(i)}reconnected(){this._onLangChange=()=>{this.setValue(d.t(this._key))},window.addEventListener("language-changed",this._onLangChange)}disconnected(){if(this._onLangChange)window.removeEventListener("language-changed",this._onLangChange)}}var an=Io(ia);try{customElements.define("dynamic-weather-card",Ui),customElements.define("dynamic-weather-card-editor",Xi),console.log(`%cDynamic Weather Card %c${vo}`,"color: #007AFF; font-weight: bold; font-size: 14px;","color: #666; font-size: 12px;",`
Динамическая карточка погоды`),window.customCards=window.customCards||[];let i={type:"dynamic-weather-card",name:"Dynamic Weather Card",description:"Динамическая карточка погоды",preview:!0,documentationURL:"https://github.com/teuchezh/dynamic-weather-card"};window.customCards.push(i)}catch(i){console.error("❌ Ошибка при регистрации Dynamic Weather Card:",i)}export{an as t,O as resolveLanguage,d as i18n};
