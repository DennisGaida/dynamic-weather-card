var m=function(o,i,a,n){var e=arguments.length,r=e<3?i:n===null?n=Object.getOwnPropertyDescriptor(i,a):n,s;if(typeof Reflect==="object"&&typeof Reflect.decorate==="function")r=Reflect.decorate(o,i,a,n);else for(var l=o.length-1;l>=0;l--)if(s=o[l])r=(e<3?s(r):e>3?s(i,a,r):s(i,a))||r;return e>3&&r&&Object.defineProperty(i,a,r),r};var no=globalThis,mo=no.ShadowRoot&&(no.ShadyCSS===void 0||no.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,fo=Symbol(),Io=new WeakMap;class po{constructor(o,i,a){if(this._$cssResult$=!0,a!==fo)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=o,this._strings=i}get styleSheet(){let o=this._styleSheet,i=this._strings;if(mo&&o===void 0){let a=i!==void 0&&i.length===1;if(a)o=Io.get(i);if(o===void 0){if((this._styleSheet=o=new CSSStyleSheet).replaceSync(this.cssText),a)Io.set(i,o)}}return o}toString(){return this.cssText}}var na=(o)=>{if(o._$cssResult$===!0)return o.cssText;else if(typeof o==="number")return o;else throw Error(`Value passed to 'css' function must be a 'css' function result: ${o}. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)},ea=(o)=>new po(typeof o==="string"?o:String(o),void 0,fo),T=(o,...i)=>{let a=o.length===1?o[0]:i.reduce((n,e,r)=>n+na(e)+o[r+1],o[0]);return new po(a,o,fo)},Eo=(o,i)=>{if(mo)o.adoptedStyleSheets=i.map((a)=>a instanceof CSSStyleSheet?a:a.styleSheet);else for(let a of i){let n=document.createElement("style"),e=no.litNonce;if(e!==void 0)n.setAttribute("nonce",e);n.textContent=a.cssText,o.appendChild(n)}},ra=(o)=>{let i="";for(let a of o.cssRules)i+=a.cssText;return ea(i)},zo=mo?(o)=>o:(o)=>o instanceof CSSStyleSheet?ra(o):o;var{is:sa,defineProperty:la,getOwnPropertyDescriptor:oi,getOwnPropertyNames:ta,getOwnPropertySymbols:da,getPrototypeOf:ii}=Object,ca=!1,M=globalThis;if(ca)M.customElements??=customElements;var b=!0,A,ai=M.trustedTypes,ga=ai?ai.emptyScript:"",ei=b?M.reactiveElementPolyfillSupportDevMode:M.reactiveElementPolyfillSupport;if(b)M.litIssuedWarnings??=new Set,A=(o,i)=>{if(i+=` See https://lit.dev/msg/${o} for more information.`,!M.litIssuedWarnings.has(i)&&!M.litIssuedWarnings.has(o))console.warn(i),M.litIssuedWarnings.add(i)},queueMicrotask(()=>{if(A("dev-mode","Lit is in dev mode. Not recommended for production!"),M.ShadyDOM?.inUse&&ei===void 0)A("polyfill-support-missing","Shadow DOM is being polyfilled via `ShadyDOM` but the `polyfill-support` module has not been loaded.")});var ua=b?(o)=>{if(!M.emitLitDebugLogEvents)return;M.dispatchEvent(new CustomEvent("lit-debug",{detail:o}))}:void 0,x=(o,i)=>o,Q={toAttribute(o,i){switch(i){case Boolean:o=o?ga:null;break;case Object:case Array:o=o==null?o:JSON.stringify(o);break}return o},fromAttribute(o,i){let a=o;switch(i){case Boolean:a=o!==null;break;case Number:a=o===null?null:Number(o);break;case Object:case Array:try{a=JSON.parse(o)}catch(n){a=null}break}return a}},eo=(o,i)=>!sa(o,i),ni={attribute:!0,type:String,converter:Q,reflect:!1,useDefault:!1,hasChanged:eo};Symbol.metadata??=Symbol("metadata");M.litPropertyMetadata??=new WeakMap;class S extends HTMLElement{static addInitializer(o){this.__prepare(),(this._initializers??=[]).push(o)}static get observedAttributes(){return this.finalize(),this.__attributeToPropertyMap&&[...this.__attributeToPropertyMap.keys()]}static createProperty(o,i=ni){if(i.state)i.attribute=!1;if(this.__prepare(),this.prototype.hasOwnProperty(o))i=Object.create(i),i.wrapped=!0;if(this.elementProperties.set(o,i),!i.noAccessor){let a=b?Symbol.for(`${String(o)} (@property() cache)`):Symbol(),n=this.getPropertyDescriptor(o,a,i);if(n!==void 0)la(this.prototype,o,n)}}static getPropertyDescriptor(o,i,a){let{get:n,set:e}=oi(this.prototype,o)??{get(){return this[i]},set(r){this[i]=r}};if(b&&n==null){if("value"in(oi(this.prototype,o)??{}))throw Error(`Field ${JSON.stringify(String(o))} on ${this.name} was declared as a reactive property but it's actually declared as a value on the prototype. Usually this is due to using @property or @state on a method.`);A("reactive-property-without-getter",`Field ${JSON.stringify(String(o))} on ${this.name} was declared as a reactive property but it does not have a getter. This will be an error in a future version of Lit.`)}return{get:n,set(r){let s=n?.call(this);e?.call(this,r),this.requestUpdate(o,s,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(o){return this.elementProperties.get(o)??ni}static __prepare(){if(this.hasOwnProperty(x("elementProperties",this)))return;let o=ii(this);if(o.finalize(),o._initializers!==void 0)this._initializers=[...o._initializers];this.elementProperties=new Map(o.elementProperties)}static finalize(){if(this.hasOwnProperty(x("finalized",this)))return;if(this.finalized=!0,this.__prepare(),this.hasOwnProperty(x("properties",this))){let i=this.properties,a=[...ta(i),...da(i)];for(let n of a)this.createProperty(n,i[n])}let o=this[Symbol.metadata];if(o!==null){let i=litPropertyMetadata.get(o);if(i!==void 0)for(let[a,n]of i)this.elementProperties.set(a,n)}this.__attributeToPropertyMap=new Map;for(let[i,a]of this.elementProperties){let n=this.__attributeNameForProperty(i,a);if(n!==void 0)this.__attributeToPropertyMap.set(n,i)}if(this.elementStyles=this.finalizeStyles(this.styles),b){if(this.hasOwnProperty("createProperty"))A("no-override-create-property","Overriding ReactiveElement.createProperty() is deprecated. The override will not be called with standard decorators");if(this.hasOwnProperty("getPropertyDescriptor"))A("no-override-get-property-descriptor","Overriding ReactiveElement.getPropertyDescriptor() is deprecated. The override will not be called with standard decorators")}}static finalizeStyles(o){let i=[];if(Array.isArray(o)){let a=new Set(o.flat(1/0).reverse());for(let n of a)i.unshift(zo(n))}else if(o!==void 0)i.push(zo(o));return i}static __attributeNameForProperty(o,i){let a=i.attribute;return a===!1?void 0:typeof a==="string"?a:typeof o==="string"?o.toLowerCase():void 0}constructor(){super();this.__instanceProperties=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this.__reflectingProperty=null,this.__initialize()}__initialize(){this.__updatePromise=new Promise((o)=>this.enableUpdating=o),this._$changedProperties=new Map,this.__saveInstanceProperties(),this.requestUpdate(),this.constructor._initializers?.forEach((o)=>o(this))}addController(o){if((this.__controllers??=new Set).add(o),this.renderRoot!==void 0&&this.isConnected)o.hostConnected?.()}removeController(o){this.__controllers?.delete(o)}__saveInstanceProperties(){let o=new Map,i=this.constructor.elementProperties;for(let a of i.keys())if(this.hasOwnProperty(a))o.set(a,this[a]),delete this[a];if(o.size>0)this.__instanceProperties=o}createRenderRoot(){let o=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Eo(o,this.constructor.elementStyles),o}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this.__controllers?.forEach((o)=>o.hostConnected?.())}enableUpdating(o){}disconnectedCallback(){this.__controllers?.forEach((o)=>o.hostDisconnected?.())}attributeChangedCallback(o,i,a){this._$attributeToProperty(o,a)}__propertyToAttribute(o,i){let n=this.constructor.elementProperties.get(o),e=this.constructor.__attributeNameForProperty(o,n);if(e!==void 0&&n.reflect===!0){let s=(n.converter?.toAttribute!==void 0?n.converter:Q).toAttribute(i,n.type);if(b&&this.constructor.enabledWarnings.includes("migration")&&s===void 0)A("undefined-attribute-value",`The attribute value for the ${o} property is undefined on element ${this.localName}. The attribute will be removed, but in the previous version of \`ReactiveElement\`, the attribute would not have changed.`);if(this.__reflectingProperty=o,s==null)this.removeAttribute(e);else this.setAttribute(e,s);this.__reflectingProperty=null}}_$attributeToProperty(o,i){let a=this.constructor,n=a.__attributeToPropertyMap.get(o);if(n!==void 0&&this.__reflectingProperty!==n){let e=a.getPropertyOptions(n),r=typeof e.converter==="function"?{fromAttribute:e.converter}:e.converter?.fromAttribute!==void 0?e.converter:Q;this.__reflectingProperty=n;let s=r.fromAttribute(i,e.type);this[n]=s??this.__defaultValues?.get(n)??s,this.__reflectingProperty=null}}requestUpdate(o,i,a,n=!1,e){if(o!==void 0){if(b&&o instanceof Event)A("","The requestUpdate() method was called with an Event as the property name. This is probably a mistake caused by binding this.requestUpdate as an event listener. Instead bind a function that will call it with no arguments: () => this.requestUpdate()");let r=this.constructor;if(n===!1)e=this[o];if(a??=r.getPropertyOptions(o),(a.hasChanged??eo)(e,i)||a.useDefault&&a.reflect&&e===this.__defaultValues?.get(o)&&!this.hasAttribute(r.__attributeNameForProperty(o,a)))this._$changeProperty(o,i,a);else return}if(this.isUpdatePending===!1)this.__updatePromise=this.__enqueueUpdate()}_$changeProperty(o,i,{useDefault:a,reflect:n,wrapped:e},r){if(a&&!(this.__defaultValues??=new Map).has(o)){if(this.__defaultValues.set(o,r??i??this[o]),e!==!0||r!==void 0)return}if(!this._$changedProperties.has(o)){if(!this.hasUpdated&&!a)i=void 0;this._$changedProperties.set(o,i)}if(n===!0&&this.__reflectingProperty!==o)(this.__reflectingProperties??=new Set).add(o)}async __enqueueUpdate(){this.isUpdatePending=!0;try{await this.__updatePromise}catch(i){Promise.reject(i)}let o=this.scheduleUpdate();if(o!=null)await o;return!this.isUpdatePending}scheduleUpdate(){let o=this.performUpdate();if(b&&this.constructor.enabledWarnings.includes("async-perform-update")&&typeof o?.then==="function")A("async-perform-update",`Element ${this.localName} returned a Promise from performUpdate(). This behavior is deprecated and will be removed in a future version of ReactiveElement.`);return o}performUpdate(){if(!this.isUpdatePending)return;if(ua?.({kind:"update"}),!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),b){let e=[...this.constructor.elementProperties.keys()].filter((r)=>this.hasOwnProperty(r)&&(r in ii(this)));if(e.length)throw Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${e.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`)}if(this.__instanceProperties){for(let[n,e]of this.__instanceProperties)this[n]=e;this.__instanceProperties=void 0}let a=this.constructor.elementProperties;if(a.size>0)for(let[n,e]of a){let{wrapped:r}=e,s=this[n];if(r===!0&&!this._$changedProperties.has(n)&&s!==void 0)this._$changeProperty(n,void 0,e,s)}}let o=!1,i=this._$changedProperties;try{if(o=this.shouldUpdate(i),o)this.willUpdate(i),this.__controllers?.forEach((a)=>a.hostUpdate?.()),this.update(i);else this.__markUpdated()}catch(a){throw o=!1,this.__markUpdated(),a}if(o)this._$didUpdate(i)}willUpdate(o){}_$didUpdate(o){if(this.__controllers?.forEach((i)=>i.hostUpdated?.()),!this.hasUpdated)this.hasUpdated=!0,this.firstUpdated(o);if(this.updated(o),b&&this.isUpdatePending&&this.constructor.enabledWarnings.includes("change-in-update"))A("change-in-update",`Element ${this.localName} scheduled an update (generally because a property was set) after an update completed, causing a new update to be scheduled. This is inefficient and should be avoided unless the next update can only be scheduled as a side effect of the previous update.`)}__markUpdated(){this._$changedProperties=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.__updatePromise}shouldUpdate(o){return!0}update(o){this.__reflectingProperties&&=this.__reflectingProperties.forEach((i)=>this.__propertyToAttribute(i,this[i])),this.__markUpdated()}updated(o){}firstUpdated(o){}}S.elementStyles=[];S.shadowRootOptions={mode:"open"};S[x("elementProperties",S)]=new Map;S[x("finalized",S)]=new Map;ei?.({ReactiveElement:S});if(b){S.enabledWarnings=["change-in-update","async-perform-update"];let o=function(i){if(!i.hasOwnProperty(x("enabledWarnings",i)))i.enabledWarnings=i.enabledWarnings.slice()};S.enableWarning=function(i){if(o(this),!this.enabledWarnings.includes(i))this.enabledWarnings.push(i)},S.disableWarning=function(i){o(this);let a=this.enabledWarnings.indexOf(i);if(a>=0)this.enabledWarnings.splice(a,1)}}(M.reactiveElementVersions??=[]).push("2.1.2");if(b&&M.reactiveElementVersions.length>1)queueMicrotask(()=>{A("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});var P=globalThis,_=(o)=>{if(!P.emitLitDebugLogEvents)return;P.dispatchEvent(new CustomEvent("lit-debug",{detail:o}))},_a=0,R;P.litIssuedWarnings??=new Set,R=(o,i)=>{if(i+=o?` See https://lit.dev/msg/${o} for more information.`:"",!P.litIssuedWarnings.has(i)&&!P.litIssuedWarnings.has(o))console.warn(i),P.litIssuedWarnings.add(i)},queueMicrotask(()=>{R("dev-mode","Lit is in dev mode. Not recommended for production!")});var H=P.ShadyDOM?.inUse&&P.ShadyDOM?.noPatch===!0?P.ShadyDOM.wrap:(o)=>o,ro=P.trustedTypes,ri=ro?ro.createPolicy("lit-html",{createHTML:(o)=>o}):void 0,ha=(o)=>o,co=(o,i,a)=>ha,ka=(o)=>{if($!==co)throw Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");$=o},ya=()=>{$=co},So=(o,i,a)=>{return $(o,i,a)},ui="$lit$",K=`lit$${Math.random().toFixed(9).slice(2)}$`,_i="?"+K,wa=`<${_i}>`,W=document,L=()=>W.createComment(""),X=(o)=>o===null||typeof o!="object"&&typeof o!="function",Po=Array.isArray,ma=(o)=>Po(o)||typeof o?.[Symbol.iterator]==="function",vo=`[ 	
\f\r]`,fa=`[^ 	
\f\r"'\`<>=]`,pa=`[^\\s"'>=/]`,V=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,si=1,Fo=2,za=3,li=/-->/g,ti=/>/g,C=new RegExp(`>|${vo}(?:(${pa}+)(${vo}*=${vo}*(?:${fa}|("|')|))|$)`,"g"),va=0,di=1,Fa=2,ci=3,Mo=/'/g,bo=/"/g,hi=/^(?:script|style|textarea|title)$/i,Ma=1,so=2,lo=3,jo=1,to=2,ba=3,Sa=4,Pa=5,Ao=6,ja=7,Ho=(o)=>(i,...a)=>{if(i.some((n)=>n===void 0))console.warn(`Some template strings are undefined.
This is probably caused by illegal octal escape sequences.`);if(a.some((n)=>n?._$litStatic$))R("",`Static values 'literal' or 'unsafeStatic' cannot be used as values to non-static templates.
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:o,strings:i,values:a}},h=Ho(Ma),k=Ho(so),hn=Ho(lo),q=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),gi=new WeakMap,J=W.createTreeWalker(W,129),$=co;function ki(o,i){if(!Po(o)||!o.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
...
`;class F{ctx;constructor(o){this.ctx=o}drawCloud(o,i,a,n){let e=this.ctx.shadowBlur,r=this.ctx.shadowColor,s=this.ctx.globalAlpha;this.ctx.shadowBlur=a*0.25,this.ctx.shadowColor=`rgba(255, 255, 255, ${n*0.4})`,this.ctx.globalAlpha=n*0.85,this.ctx.fillStyle="rgba(255, 255, 255, 1)",[{x:o,y:i,r:a*0.4},{x:o+a*0.35,y:i,r:a*0.5},{x:o+a*0.65,y:i,r:a*0.48},{x:o+a*0.92,y:i,r:a*0.38},{x:o+a*0.18,y:i-a*0.28,r:a*0.38},{x:o+a*0.52,y:i-a*0.32,r:a*0.42},{x:o+a*0.78,y:i-a*0.28,r:a*0.38},{x:o+a*0.32,y:i-a*0.42,r:a*0.32},{x:o+a*0.62,y:i-a*0.48,r:a*0.36},{x:o+a*0.82,y:i-a*0.42,r:a*0.32}].forEach((t)=>{this.ctx.beginPath(),this.ctx.arc(t.x,t.y,t.r,0,Math.PI*2),this.ctx.fill()}),this.ctx.shadowBlur=e,this.ctx.shadowColor=r,this.ctx.globalAlpha=s}drawClouds(o,i,a,n=0.5){let e=Math.max(2,Math.floor(i/150*n));for(let r=0;r<e;r++){let s=(o*3+r*150)%(i+200)-100,l=a*(0.2+r%3*0.15)+Math.sin(o*0.2+r)*8,t=40+r%3*15,u=0.6+r%2*0.2;this.drawCloud(s,l,t,u)}}}class Bo extends F{draw(o,i,a,n){let e=Date.now()*0.001,r=qi(n,i,a),s=r.x,l=r.y;if(n.type==="day"||n.type==="sunrise"||n.type==="sunset"){if(this.drawSun(s,l,e),n.type==="sunrise"||n.type==="sunset")this.drawHorizonReflection(s,l,a,e)}else if(n.type==="night")this.drawNightSky(i,a,e);this.drawClouds(e,i,a,0.3)}drawSun(o,i,a){let n=48+Math.sin(a*0.15)*1.5,e=this.ctx.createRadialGradient(o,i,n*0.3,o,i,n*3.5);e.addColorStop(0,"rgba(255, 248, 230, 0.25)"),e.addColorStop(0.15,"rgba(255, 240, 200, 0.2)"),e.addColorStop(0.3,"rgba(255, 230, 170, 0.15)"),e.addColorStop(0.5,"rgba(255, 220, 140, 0.1)"),e.addColorStop(0.7,"rgba(255, 210, 120, 0.06)"),e.addColorStop(0.85,"rgba(255, 200, 100, 0.03)"),e.addColorStop(1,"rgba(255, 190, 90, 0)"),this.ctx.fillStyle=e,this.ctx.beginPath(),this.ctx.arc(o,i,n*3.5,0,Math.PI*2),this.ctx.fill();let r=this.ctx.createRadialGradient(o,i,n*0.5,o,i,n*2.2);r.addColorStop(0,"rgba(255, 250, 220, 0.35)"),r.addColorStop(0.3,"rgba(255, 240, 190, 0.25)"),r.addColorStop(0.6,"rgba(255, 230, 160, 0.15)"),r.addColorStop(0.85,"rgba(255, 220, 140, 0.08)"),r.addColorStop(1,"rgba(255, 210, 120, 0)"),this.ctx.fillStyle=r,this.ctx.beginPath(),this.ctx.arc(o,i,n*2.2,0,Math.PI*2),this.ctx.fill();let s=this.ctx.createRadialGradient(o,i,n*0.6,o,i,n*1.6);s.addColorStop(0,"rgba(255, 252, 240, 0.5)"),s.addColorStop(0.4,"rgba(255, 245, 210, 0.35)"),s.addColorStop(0.7,"rgba(255, 235, 180, 0.2)"),s.addColorStop(1,"rgba(255, 225, 150, 0)"),this.ctx.fillStyle=s,this.ctx.beginPath(),this.ctx.arc(o,i,n*1.6,0,Math.PI*2),this.ctx.fill();let l=this.ctx.createRadialGradient(o-n*0.1,i-n*0.1,0,o,i,n);l.addColorStop(0,"#FFFEF5"),l.addColorStop(0.15,"#FFF9E6"),l.addColorStop(0.3,"#FFF4D6"),l.addColorStop(0.5,"#FFEDC0"),l.addColorStop(0.7,"#FFE4A8"),l.addColorStop(0.85,"#FFDC95"),l.addColorStop(1,"#FFD37F"),this.ctx.fillStyle=l,this.ctx.beginPath(),this.ctx.arc(o,i,n,0,Math.PI*2),this.ctx.fill()}drawHorizonReflection(o,i,a,n){let e=48+Math.sin(n*0.15)*1.5,r=a*0.85;if(i>=r-50){let s=Math.max(0,(r-i)/50)*0.3;this.ctx.fillStyle=`rgba(255, 140, 0, ${s})`,this.ctx.beginPath(),this.ctx.ellipse(o,r,e*1.5,e*0.5,0,0,Math.PI*2),this.ctx.fill()}}drawNightSky(o,i,a){this.ctx.fillStyle="#FFFFFF";for(let r=0;r<20;r++){let s=(o*0.2+r*47)%o,l=(i*0.2+r*23)%(i*0.6),t=Math.sin(a*0.8+r)*0.5+0.5;this.ctx.globalAlpha=t*0.8,this.ctx.beginPath(),this.ctx.arc(s,l,1.5,0,Math.PI*2),this.ctx.fill()}let n=o*0.75,e=i*0.3;this.ctx.globalAlpha=0.9,this.ctx.fillStyle="#F0F0F0",this.ctx.beginPath(),this.ctx.arc(n,e,25,0,Math.PI*2),this.ctx.fill(),this.ctx.fillStyle="#1a1a2e",this.ctx.beginPath(),this.ctx.arc(n-8,e-5,22,0,Math.PI*2),this.ctx.fill(),this.ctx.globalAlpha=1}}class oo extends F{rainDrops=[];lastTime=0;draw(o,i,a,n,e=!1){let r=Date.now()*0.001;this.drawClouds(r,i,a,e?1:0.8),this.drawRain(i,a,e)}drawRain(o,i,a){let n=a?130:90;if(this.rainDrops.length!==n){this.rainDrops=[];for(let l=0;l<n;l++)this.rainDrops.push({x:Math.random()*o,y:Math.random()*i-Math.random()*200,speed:a?80+Math.random()*100:60+Math.random()*80,windOffset:(Math.random()-0.5)*30,width:a?1.2+Math.random()*1:0.8+Math.random()*0.7,length:a?8+Math.random()*10:6+Math.random()*8,alpha:a?0.75+Math.random()*0.15:0.65+Math.random()*0.2,phase:Math.random()*Math.PI*2})}let e=Date.now()*0.001,r=this.lastTime>0?Math.min(e-this.lastTime,0.1):0.016666666666666666;this.lastTime=e;let s=e;for(let l=0;l<this.rainDrops.length;l++){let t=this.rainDrops[l];if(t.y+=t.speed*r,t.y>i+50)t.y=-50-Math.random()*100,t.x=Math.random()*o;let u=t.windOffset*(1+Math.sin(s*0.5+t.phase)*0.2),c=t.x+u;if(c<-10)t.x=o+10;else if(c>o+10)t.x=-10;this.drawRainDrop(c,t.y,t)}}drawRainDrop(o,i,a){this.ctx.save(),this.ctx.globalAlpha=a.alpha;let n=i-a.length*0.5,e=i+a.length*0.5,r=a.alpha,s=a.alpha*0.5;this.ctx.fillStyle="rgba(220, 240, 255, "+r+")",this.ctx.strokeStyle="rgba(240, 250, 255, "+s+")",this.ctx.lineWidth=0.4,this.ctx.beginPath(),this.ctx.moveTo(o,n),this.ctx.quadraticCurveTo(o-a.width*0.3,i,o-a.width,e-a.width*0.3),this.ctx.arc(o,e,a.width,Math.PI,0,!1),this.ctx.quadraticCurveTo(o+a.width*0.3,i,o,n),this.ctx.closePath(),this.ctx.fill(),this.ctx.stroke(),this.ctx.restore()}}class Jo extends F{snowflakes=[];lastTime=0;draw(o,i,a,n){let e=Date.now()*0.001;this.drawClouds(e,i,a,0.7),this.drawSnowflakes(i,a)}drawSnowflakes(o,i){let a=Math.floor(o*i/5000),n=Math.max(30,Math.min(a,80));if(this.snowflakes.length!==n){this.snowflakes=[];for(let l=0;l<n;l++)this.snowflakes.push({x:Math.random()*o,y:Math.random()*i-Math.random()*100,speedY:15+Math.random()*10,speedX:(Math.random()-0.5)*8,size:1.5+Math.random()*1.5,alpha:0.6+Math.random()*0.3,rotation:Math.random()*Math.PI*2,rotationSpeed:(Math.random()-0.5)*0.3,swayPhase:Math.random()*Math.PI*2,swaySpeed:0.5+Math.random()*0.5})}let e=Date.now()*0.001,r=this.lastTime>0?Math.min(e-this.lastTime,0.1):0.016666666666666666;this.lastTime=e;let s=e;this.ctx.lineCap="round";for(let l=0;l<this.snowflakes.length;l++){let t=this.snowflakes[l],u=Math.sin(s*t.swaySpeed+t.swayPhase)*2;if(t.y+=t.speedY*r,t.x+=(t.speedX+u)*r,t.rotation+=t.rotationSpeed*r,t.y>i+20)t.y=-20-Math.random()*50,t.x=Math.random()*o;if(t.x<-10)t.x=o+10;else if(t.x>o+10)t.x=-10;this.drawSnowflake(t.x,t.y,t.size,t.alpha,t.rotation)}}drawSnowflake(o,i,a,n,e){this.ctx.save(),this.ctx.translate(o,i),this.ctx.rotate(e),this.ctx.strokeStyle=`rgba(255, 255, 255, ${n})`,this.ctx.lineWidth=1,this.ctx.beginPath();for(let r=0;r<6;r++){let s=Math.PI/3*r,l=Math.cos(s),t=Math.sin(s);this.ctx.moveTo(0,0),this.ctx.lineTo(t*a*2.5,l*a*2.5);let u=t*a*1.5+l*a*0.5,c=l*a*1.5-t*a*0.5,y=t*a*1.8+l*a*1.2,v=l*a*1.8-t*a*1.2;this.ctx.moveTo(u,c),this.ctx.lineTo(y,v);let w=t*a*1.5-l*a*0.5,j=l*a*1.5+t*a*0.5,wo=t*a*1.8-l*a*1.2,B=l*a*1.8+t*a*1.2;this.ctx.moveTo(w,j),this.ctx.lineTo(wo,B)}this.ctx.stroke(),this.ctx.restore()}}class Wo extends F{draw(o,i,a,n){let e=Date.now()*0.001;this.drawClouds(e,i,a,0.7)}}class qo extends F{draw(o,i,a,n){let e=Date.now()*0.0003;this.ctx.fillStyle="rgba(200, 200, 200, 0.4)";for(let r=0;r<3;r++){let s=a*(0.4+r*0.2),l=Math.sin(e+r)*20;this.ctx.beginPath(),this.ctx.moveTo(0,s);for(let t=0;t<=i;t+=5){let u=Math.sin((t/i+e)*Math.PI*4+r)*15;this.ctx.lineTo(t,s+u+l)}this.ctx.lineTo(i,a),this.ctx.lineTo(0,a),this.ctx.closePath(),this.ctx.fill()}}}class $o extends F{hailStones=[];draw(o,i,a,n){let e=Date.now()*0.001;this.drawClouds(e,i,a,1),this.drawHailStones(i,a)}drawHailStones(o,i){if(this.hailStones.length!==60){this.hailStones=[];for(let e=0;e<60;e++)this.hailStones.push({startX:Math.random()*o,startY:Math.random()*(i+150)-75,speed:120+Math.random()*80,windOffset:(Math.random()-0.5)*20,size:2+Math.random()*3,alpha:0.8+Math.random()*0.15,phase:Math.random()*Math.PI*2})}let n=Date.now()*0.002;this.ctx.fillStyle="rgba(240, 250, 255, 1)",this.ctx.strokeStyle="rgba(255, 255, 255, 0.9)",this.ctx.lineWidth=0.5;for(let e=0;e<this.hailStones.length;e++){let r=this.hailStones[e],s=(r.startY+n*r.speed)%(i+150);if(s>i+30)r.startY=-30-Math.random()*30,r.startX=Math.random()*o;let l=r.windOffset*(1+Math.sin(n*0.6+r.phase)*0.15),t=(r.startX+l+n*20%o)%o;if(t<-5)r.startX=o+5;else if(t>o+5)r.startX=-5;this.drawHailStone(t,s,r)}}drawHailStone(o,i,a){this.ctx.save(),this.ctx.globalAlpha=a.alpha,this.ctx.beginPath(),this.ctx.ellipse(o,i,a.size,a.size*0.9,0,0,Math.PI*2),this.ctx.fill(),this.ctx.stroke(),this.ctx.fillStyle="rgba(255, 255, 255, 0.6)",this.ctx.beginPath(),this.ctx.ellipse(o-a.size*0.3,i-a.size*0.3,a.size*0.3,a.size*0.25,0,0,Math.PI*2),this.ctx.fill(),this.ctx.fillStyle="rgba(240, 250, 255, 1)",this.ctx.restore()}}class xo extends F{rainyAnimation;constructor(o){super(o);this.rainyAnimation=new oo(o)}draw(o,i,a,n,e=!0){let r=Date.now()*0.001;if(this.drawClouds(r,i,a,1),e)this.rainyAnimation.draw(o,i,a,n,!1);this.drawLightning(i,a,r)}drawLightning(o,i,a){let n=Math.sin(a*2.5)*Math.sin(a*5.3)*Math.sin(a*7.1),e=Math.max(0,n);if(e>0.4){let r=(e-0.4)/0.6,s=r*0.6,l=Math.min(s,Math.sin(r*Math.PI)*0.6);this.ctx.fillStyle=`rgba(255, 255, 255, ${l})`,this.ctx.fillRect(0,0,o,i)}}}class Go{canvas=null;ctx=null;animationFrame=null;animations={};resizeObserver=null;width=0;height=0;container=null;getDrawParams;handleVisibilityChange=()=>{if(document.hidden)this.stopAnimation();else this.startAnimation()};constructor(o){this.getDrawParams=o}setup(o){if(this.container=o,this.setupCanvas(),this.canvas&&this.ctx)this.initializeAnimations(),this.startAnimation(),this.setupResizeObserver(),document.addEventListener("visibilitychange",this.handleVisibilityChange)}destroy(){if(document.removeEventListener("visibilitychange",this.handleVisibilityChange),this.stopAnimation(),this.resizeObserver)this.resizeObserver.disconnect(),this.resizeObserver=null;this.canvas=null,this.ctx=null,this.container=null}resize(){if(this.canvas&&this.ctx)this.resizeCanvas()}setupCanvas(){if(!this.container)return;let o=this.container.querySelector("canvas");if(o)o.remove();this.canvas=document.createElement("canvas"),this.container.appendChild(this.canvas),this.resizeCanvas()}resizeCanvas(){if(!this.canvas||!this.container)return;let o=this.container.getBoundingClientRect();if(o.width===0||o.height===0)return;let i=window.devicePixelRatio||2;if(this.canvas.width=o.width*i,this.canvas.height=o.height*i,this.canvas.style.width="100%",this.canvas.style.height="100%",this.ctx=this.canvas.getContext("2d"),this.ctx)this.ctx.scale(i,i);this.width=o.width,this.height=o.height,this.initializeAnimations()}setupResizeObserver(){if(!this.container)return;this.resizeObserver=new ResizeObserver(()=>{this.resizeCanvas()}),this.resizeObserver.observe(this.container)}initializeAnimations(){if(!this.ctx)return;this.animations={sunny:new Bo(this.ctx),rainy:new oo(this.ctx),snowy:new Jo(this.ctx),cloudy:new Wo(this.ctx),foggy:new qo(this.ctx),hail:new $o(this.ctx),thunderstorm:new xo(this.ctx)}}startAnimation(){if(this.animationFrame)return;let o=()=>{this.draw(),this.animationFrame=requestAnimationFrame(o)};o()}stopAnimation(){if(this.animationFrame)cancelAnimationFrame(this.animationFrame),this.animationFrame=null}draw(){if(!this.ctx||!this.canvas)return;if(!this.width||!this.height){if(this.resizeCanvas(),!this.width||!this.height)return}let o=this.getDrawParams();if(!o)return;let{condition:i,timeOfDay:a}=o,n=this.width,e=this.height;switch(this.ctx.clearRect(0,0,n,e),i.toLowerCase()){case"sunny":case"clear":this.animations.sunny?.draw(Date.now(),n,e,a);break;case"clear-night":this.animations.sunny?.draw(Date.now(),n,e,{type:"night",progress:0});break;case"rainy":case"rain":this.animations.rainy?.draw(Date.now(),n,e,a,!1);break;case"pouring":this.animations.rainy?.draw(Date.now(),n,e,a,!0);break;case"snowy":case"snow":this.animations.snowy?.draw(Date.now(),n,e,a);break;case"snowy-rainy":this.animations.rainy?.draw(Date.now(),n,e,a,!1),this.animations.snowy?.draw(Date.now(),n,e,a);break;case"hail":this.animations.hail?.draw(Date.now(),n,e,a);break;case"foggy":case"fog":this.animations.foggy?.draw(Date.now(),n,e,a);break;case"lightning":this.animations.thunderstorm?.draw(Date.now(),n,e,a,!1);break;case"lightning-rainy":this.animations.thunderstorm?.draw(Date.now(),n,e,a,!0);break;case"cloudy":case"partlycloudy":default:this.animations.cloudy?.draw(Date.now(),n,e,a);break}}}class Qo{hourlyForecast=[];dailyForecast=[];hourlySubscription=null;dailySubscription=null;onUpdate;constructor(o){this.onUpdate=o}getHourlyData(){return this.hourlyForecast}getDailyData(){return this.dailyForecast}async subscribe(o,i,a){if(!o||!i)return;await this.unsubscribe();try{if(this.hourlySubscription=o.connection.subscribeMessage((n)=>{if(n.forecast&&n.forecast.length>0)this.hourlyForecast=n.forecast,this.onUpdate()},{type:"weather/subscribe_forecast",forecast_type:"hourly",entity_id:i}),a)this.dailySubscription=o.connection.subscribeMessage((n)=>{if(n.forecast&&n.forecast.length>0)this.dailyForecast=n.forecast,this.onUpdate()},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:i})}catch{}}async unsubscribe(){if(this.hourlySubscription){try{(await this.hourlySubscription)()}catch{}this.hourlySubscription=null}if(this.dailySubscription){try{(await this.dailySubscription)()}catch{}this.dailySubscription=null}}getHourlyForecast(o,i){let a=Math.max(1,Math.floor(Number(o??g.hourlyForecastHours)));if(this.hourlyForecast&&this.hourlyForecast.length>0)return this.hourlyForecast.slice(0,a);if(!i?.forecast||i.forecast.length===0)return[];let n=new Date,e=new Date(n.getFullYear(),n.getMonth(),n.getDate()),r=new Date(e);return r.setDate(r.getDate()+1),i.forecast.filter((l)=>{if(!l.datetime)return!1;let t=new Date(l.datetime),u=new Date(t.getFullYear(),t.getMonth(),t.getDate());return u.getTime()===e.getTime()||u.getTime()===r.getTime()&&t.getHours()<=n.getHours()}).sort((l,t)=>new Date(l.datetime).getTime()-new Date(t.datetime).getTime()).slice(0,a)}getDailyForecast(o,i){let a=Math.max(1,Math.floor(Number(o??g.dailyForecastDays)));if(this.dailyForecast&&this.dailyForecast.length>0)return this.dailyForecast.slice(0,a);if(!i?.forecast||i.forecast.length===0)return[];let n=new Date,e=new Date(n.getFullYear(),n.getMonth(),n.getDate()),r=new Date(e);r.setDate(r.getDate()+a);let s=(t)=>{let u=t.getFullYear(),c=String(t.getMonth()+1).padStart(2,"0"),y=String(t.getDate()).padStart(2,"0");return`${u}-${c}-${y}`},l=new Map;return i.forecast.forEach((t)=>{if(!t.datetime)return;let u=new Date(t.datetime);if(Number.isNaN(u.getTime()))return;if(u<e||u>=r)return;let c=s(u),y=Math.abs(u.getHours()+u.getMinutes()/60-12),v=l.get(c);if(!v||y<v.hourScore)l.set(c,{item:t,itemDate:u,hourScore:y})}),Array.from(l.values()).sort((t,u)=>t.itemDate.getTime()-u.itemDate.getTime()).map((t)=>t.item).slice(0,a)}}class Vo{holdTimer=null;lastTap=null;holdFired=!1;holdDelay=500;getHass;getConfig;fireEvent;constructor(o,i,a){this.getHass=o,this.getConfig=i,this.fireEvent=a}handleTap(o){if(o.target.closest(".forecast-item")||o.target.closest(".info-item"))return;if(this.lastTap&&Date.now()-this.lastTap<300){this.handleDoubleTap(),this.lastTap=null;return}this.lastTap=Date.now(),setTimeout(()=>{if(this.lastTap)this.handleAction(this.getConfig().tapAction),this.lastTap=null},300)}handlePointerDown(){this.holdTimer=window.setTimeout(()=>{this.handleHold(),this.holdFired=!0},this.holdDelay)}handlePointerUp(o){if(this.holdTimer)clearTimeout(this.holdTimer);if(this.holdFired)o.preventDefault(),o.stopPropagation(),this.holdFired=!1}handleHold(){this.handleAction(this.getConfig().holdAction)}handleDoubleTap(){this.handleAction(this.getConfig().doubleTapAction)}handleAction(o){let i=this.getHass(),a=this.getConfig();if(!o||!i)return;switch(o.action||"more-info"){case"more-info":this.fireEvent("hass-more-info",{entityId:o.entity||a.entity});break;case"toggle":i.callService("homeassistant","toggle",{entity_id:o.entity||a.entity});break;case"call-service":if(o.service){let[e,r]=o.service.split(".");i.callService(e,r,o.service_data||{})}break;case"navigate":if(o.navigation_path)window.history.pushState(null,"",o.navigation_path),this.fireEvent("location-changed",{replace:!1});break;case"url":if(o.url_path)window.open(o.url_path);break;case"none":default:break}}}function Ia(o,i){if(!o||!i)return null;let a=o.states[i];return a?a.state:null}function Uo(o,i){if(!o||!i)return{};let a=o.states[i];return a?a.attributes:{}}function Ro(o,i,a,n){let e=Ia(o,i),r=Uo(o,i),s=r.condition||e||"sunny",l=null;if(a.templowAttribute&&r[a.templowAttribute]!=null)l=r[a.templowAttribute];else{for(let t of bi)if(r[t]!=null){l=r[t];break}if(l==null)l=(r.forecast&&r.forecast[0]?r.forecast[0].templow??null:null)||(r.forecast_hourly&&r.forecast_hourly[0]?r.forecast_hourly[0].native_templow??null:null)}return{condition:s,temperature:r.temperature!=null?r.temperature:null,apparentTemperature:r.apparent_temperature||null,humidity:r.humidity!=null?r.humidity:null,windSpeed:r.wind_speed!=null?r.wind_speed:null,windGust:r.wind_gust_speed||r.wind_gust||null,windBearing:r.wind_bearing!=null?r.wind_bearing:null,windDirection:r.wind_direction||null,pressure:r.pressure||null,forecast:r.forecast||r.forecast_hourly||n||[],friendlyName:r.friendly_name||d.t("weather"),templow:l}}class Ri extends z{constructor(){super(...arguments);this.format=null;this.currentTime=""}clockInterval=null;static styles=T`
    :host {
      display: block;
    }
...
`,on={sunny:k`
  ...
  `};function io(o,...i){let a=Ea[o];if(typeof a==="function")return a(...i);return a||""}function ho(o){if(!o)return"";return on[o.toLowerCase()]||""}class Xi extends z{constructor(){super(...arguments);this.weather=null;this.sunData=null;this.config=null;this.entityAttributes=null}static styles=T`
    :host {
      display: block;
    }
  ...
  `;hasContent(){if(!this.weather||!this.config)return!1;return this.config.showHumidity&&this.weather.humidity!=null||this.config.showWind&&this.weather.windSpeed!=null||this.config.showSunriseSunset&&this.sunData?.hasSunData===!0}renderHumidity(){if(!this.config?.showHumidity||this.weather?.humidity==null)return h``;return h`
      <div class="info-item">
        <span class="info-icon">${io("humidity")}</span>
        <span>${this.weather.humidity} %</span>
      </div>
    `}renderSunrise(){if(!this.config?.showSunriseSunset||!this.sunData?.hasSunData||!this.sunData.sunrise)return h``;return h`
      <div class="info-item">
        <span class="info-icon">${io("sunrise")}</span>
        <span>${Zo(this.sunData.sunrise,this.config.clockFormat,d.t("am"),d.t("pm"))}</span>
      </div>
    `}renderWind(){if(!this.config?.showWind||this.weather?.windSpeed==null)return h``;let o=this.entityAttributes||{},i=Co(this.weather.windSpeed,o,this.config.windSpeedUnit),a=Qi(o,this.config.windSpeedUnit,d.t.bind(d)),n="";if(this.config.showWindGust&&this.weather.windGust)n=` / ${Co(this.weather.windGust,o,this.config.windSpeedUnit)} ${a}`;let e=this.config.showWindDirection&&this.weather.windBearing!=null?Li(this.weather.windBearing):io("wind");return h`
      <div class="info-item">
        <span class="info-icon">${e}</span>
        <span>${i} ${a}${n}</span>
      </div>
    `}renderSunset(){if(!this.config?.showSunriseSunset||!this.sunData?.hasSunData||!this.sunData.sunset)return h``;return h`
      <div class="info-item">
        <span class="info-icon">${io("sunset")}</span>
        <span>${Zo(this.sunData.sunset,this.config.clockFormat,d.t("am"),d.t("pm"))}</span>
      </div>
    `}render(){if(!this.hasContent())return h``;return h`
      <div class="info-grid">
        ${this.renderHumidity()}
        ${this.renderSunrise()}
        ${this.renderWind()}
    ...
    `}}m([f({type:Object})],Xi.prototype,"weather",void 0),m([f({type:Object})],Xi.prototype,"sunData",void 0),m([f({type:Object})],Xi.prototype,"config",void 0),m([f({type:Object})],Xi.prototype,"entityAttributes",void 0);customElements.define("weather-details",Xi);var ko=T`
  :host {
    display: block;
  }
...
`;class Yi extends z{constructor(){super(...arguments);this.forecast=[];this.clockFormat="24h"}static styles=ko;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=_o(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(o){return Math.round(o.temperature??o.temp??o.native_temperature??0)}render(){if(this.forecast.length===0)return h``;return h`
      <div class="forecast-container">
        <div class="forecast-title">${d.t("forecast_title")}</div>
        <div class="forecast-scroll">
          ${this.forecast.map((o)=>h`
            <div class="forecast-item">
              <div class="forecast-time">${xi(o.datetime,this.clockFormat,d.t("am"),d.t("pm"))}</div>
              <div class="forecast-icon">${ho(o.condition||"sunny")}</div>
              <div class="forecast-temp">${this.getTemperature(o)}°</div>
            </div>
          `)}
        </div>
      </div>
    `}}m([f({type:Array})],Yi.prototype,"forecast",void 0),m([f({type:String})],Yi.prototype,"clockFormat",void 0);customElements.define("hourly-forecast",Yi);class Oi extends z{constructor(){super(...arguments);this.forecast=[];this.lang="en"}static styles=ko;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=_o(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(o){return Math.round(o.temperature??o.temp??o.native_temperature??0)}render(){if(this.forecast.length===0)return h``;return h`
      <div class="forecast-container">
    ...
    `}}m([f({type:Array})],Oi.prototype,"forecast",void 0),m([f({type:String})],Oi.prototype,"lang",void 0);customElements.define("daily-forecast",Oi);class Lo extends z{animationManager;forecastService;actionHandler;subscribedEntity=null;subscribedShowDaily=!1;_testTimeOfDay;static get styles(){return Ui}static getConfigElement(){return document.createElement("dynamic-weather-card-editor")}static getStubConfig(){return{type:"custom:dynamic-weather-card",entity:"weather.home",show_hourly_forecast:!0,hourly_forecast_hours:g.hourlyForecastHours,show_daily_forecast:!0,daily_forecast_days:g.dailyForecastDays}}constructor(){super();this.config={},this.animationManager=new Go(()=>this.getDrawParams()),this.forecastService=new Qo(()=>this.requestUpdate()),this.actionHandler=new Vo(()=>this.hass,()=>this.config,(o,i)=>this.fireEvent(o,i))}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{setTimeout(()=>{let o=this.shadowRoot?.querySelector(".canvas-container");if(o)this.animationManager.setup(o)},100)})}disconnectedCallback(){super.disconnectedCallback(),this.animationManager.destroy(),this.forecastService.unsubscribe()}updated(o){if(super.updated(o),o.has("config")){let a=o.get("config"),n=a?a.showAnimations!==!1:!0,e=this.config.showAnimations!==!1;if(n&&!e)this.animationManager.destroy();else if(!n&&e)this.updateComplete.then(()=>{let r=this.shadowRoot?.querySelector(".canvas-container");if(r)this.animationManager.setup(r)})}if(o.has("hass")||o.has("config")){let a=this.config.entity,n=this.config.showDailyForecast??!1;if(this.hass&&a&&(a!==this.subscribedEntity||n!==this.subscribedShowDaily))this.subscribedEntity=a,this.subscribedShowDaily=n,this.forecastService.subscribe(this.hass,a,n)}let i=E({configLang:this.config?.language,hassLang:this.hass?.language});if(d.lang!==i)d.setLanguage(i)}getDrawParams(){if(!this.hass||!this.config.entity)return null;let o=Ro(this.hass,this.config.entity,this.config,this.forecastService.getHourlyData()),i=this.hass.states[this.config.entity],a=Do(i||{},this.config.sunriseEntity,this.config.sunsetEntity,this.hass),n=this._testTimeOfDay||To(a);return{condition:o.condition,timeOfDay:n}}getDetailsConfig(){return{showHumidity:this.config.showHumidity??!0,showWind:this.config.showWind??!0,showWindGust:this.config.showWindGust??!0,showWindDirection:this.config.showWindDirection??!0,showSunriseSunset:this.config.showSunriseSunset??!0,clockFormat:this.config.clockFormat??"24h",windSpeedUnit:this.config.windSpeedUnit??"ms"}}setConfig(o){if(!o.entity)throw Error("Please define a weather entity");let i=o.show_hourly_forecast??o.show_forecast;if(this.config={type:"custom:dynamic-weather-card",entity:o.entity,icons_path:o.icons_path,name:o.name,height:o.height||g.height,showFeelsLike:o.show_feels_like!==!1,showWind:o.show_wind!==!1,showWindGust:o.show_wind_gust!==!1,showWindDirection:o.show_wind_direction!==!1,showHumidity:o.show_humidity!==!1,showMinTemp:o.show_min_temp!==!1,showForecast:o.show_forecast===!0,showHourlyForecast:i===!0,showDailyForecast:o.show_daily_forecast===!0,hourlyForecastHours:o.hourly_forecast_hours??g.hourlyForecastHours,dailyForecastDays:o.daily_forecast_days??g.dailyForecastDays,showSunriseSunset:o.show_sunrise_sunset!==!1,showClock:o.show_clock===!0,clockPosition:o.clock_position||g.clockPosition,clockFormat:o.clock_format||g.clockFormat,overlayOpacity:o.overlay_opacity!==void 0?o.overlay_opacity:g.overlayOpacity,textShadow:o.text_shadow!==void 0?o.text_shadow:g.textShadow,language:o.language||g.language,windSpeedUnit:o.wind_speed_unit||g.windSpeedUnit,showAnimations:o.show_animations!==!1,sunriseEntity:o.sunrise_entity||null,sunsetEntity:o.sunset_entity||null,templowAttribute:o.templow_attribute||null,tapAction:o.tap_action||{action:"more-info"},holdAction:o.hold_action||{action:"none"},doubleTapAction:o.double_tap_action||{action:"none"}},this.config.language)d.setLanguage(this.config.language)}fireEvent(o,i={}){let a=new CustomEvent(o,{detail:i,bubbles:!0,composed:!0});this.dispatchEvent(a)}getCardSize(){return 1}render(){if(!this.hass)return h`<div>No Home Assistant connection</div>`;let o=Ro(this.hass,this.config.entity,this.config,this.forecastService.getHourlyData()),i=this.hass.states[this.config.entity],a=Do(i,this.config.sunriseEntity,this.config.sunsetEntity,this.hass),n=this._testTimeOfDay||To(a),e=`weather-card ${n.type}`,r=this.config.height?`${this.config.height}px`:"200px",s=$i(n),l=s?`background: linear-gradient(135deg, rgb(${s.start.r}, ${s.start.g}, ${s.start.b}), rgb(${s.end.r}, ${s.end.g}, ${s.end.b}));`:"",u=`--overlay-opacity: ${this.config.overlayOpacity!==void 0?this.config.overlayOpacity:g.overlayOpacity};`,c=this.config.textShadow??g.textShadow,y=c===0?"none":[`0 1px 2px rgba(0,0,0,${Math.min(1,0.4*c).toFixed(2)})`,`0 2px 6px rgba(0,0,0,${Math.min(1,0.3*c).toFixed(2)})`,`0 4px 12px rgba(0,0,0,${Math.min(1,0.2*c).toFixed(2)})`].join(", "),v=c===0?"none":`drop-shadow(0px 1px 3px rgba(0,0,0,${Math.min(1,0.6*c).toFixed(2)}))`,w=`--card-text-shadow: ${y}; --card-icon-filter: ${v};`,j=this.config.showHourlyForecast?this.forecastService.getHourlyForecast(this.config.hourlyForecastHours??g.hourlyForecastHours,o):[],wo=this.config.showDailyForecast?this.forecastService.getDailyForecast(this.config.dailyForecastDays??g.dailyForecastDays,o):[];return h`
      <ha-card
        @click=${(B)=>this.actionHandler.handleTap(B)}
        @pointerdown=${()=>this.actionHandler.handlePointerDown()}
        @pointerup=${(B)=>this.actionHandler.handlePointerUp(B)}
        @pointercancel=${(B)=>this.actionHandler.handlePointerUp(B)}
      >
        <div class="${e}" style="min-height: ${r}; ${l}; ${u} ${w} cursor: pointer;">
          ${this.config.showAnimations!==!1?h`<div class="canvas-container"></div>`:""}
          <div class="content">
            ${this.config.name&&this.config.name.trim()!==""?h`
              <div class="header">
            ...
            <div class="details ${this.config.showClock&&this.config.clockPosition==="details"?"details--clock":""}">
              <weather-details
                ...
                .entityAttributes=${Uo(this.hass,this.config.entity)}
              ></weather-details>
              <weather-clock
    ...
    `}}m([f({type:Object})],Lo.prototype,"hass",void 0),m([f({type:Object})],Lo.prototype,"config",void 0);var an=(o)=>{let i=`editor.language_${o}`,a=d.t(i);if(a!==i)return a;try{return new Intl.DisplayNames([d.lang],{type:"language"}).of(o)??o}catch{return o}};class Xo extends z{constructor(){super(...arguments);this._config={}}setConfig(o){this._config={name:"",height:g.height,show_feels_like:g.showFeelsLike,show_wind:g.showWind,show_wind_gust:g.showWindGust,show_wind_direction:g.showWindDirection,show_humidity:g.showHumidity,show_min_temp:g.showMinTemp,show_hourly_forecast:g.showHourlyForecast,hourly_forecast_hours:g.hourlyForecastHours,show_daily_forecast:g.showDailyForecast,daily_forecast_days:g.dailyForecastDays,show_sunrise_sunset:g.showSunriseSunset,show_animations:g.showAnimations,show_clock:g.showClock,clock_position:g.clockPosition,clock_format:g.clockFormat,overlay_opacity:g.overlayOpacity,text_shadow:g.textShadow,language:g.language,wind_speed_unit:g.windSpeedUnit,sunrise_entity:"",sunset_entity:"",...o}}updated(o){if(super.updated(o),o.has("hass")){let i=E({hassLang:this.hass?.language});if(d.lang!==i)d.setLanguage(i),this.requestUpdate()}}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:["weather"]}}},{name:"name",selector:{text:{}}},{name:"height",selector:{number:{min:200,max:800,step:10,mode:"box"}}},{name:"show_feels_like",selector:{boolean:{}}},{name:"show_wind",selector:{boolean:{}}},{name:"show_wind_gust",selector:{boolean:{}}},{name:"show_wind_direction",selector:{boolean:{}}},{name:"show_humidity",selector:{boolean:{}}},{name:"show_min_temp",selector:{boolean:{}}},{name:"show_hourly_forecast",selector:{boolean:{}}},{name:"hourly_forecast_hours",selector:{number:{min:1,max:24,step:1,mode:"box"}}},{name:"show_daily_forecast",selector:{boolean:{}}},{name:"daily_forecast_days",selector:{number:{min:1,max:14,step:1,mode:"box"}}},{name:"show_sunrise_sunset",selector:{boolean:{}}},{name:"sunrise_entity",selector:{entity:{domain:["sensor"]}}},{name:"sunset_entity",selector:{entity:{domain:["sensor"]}}},{name:"show_clock",selector:{boolean:{}}},{name:"clock_position",selector:{select:{options:[{label:d.t("editor.clock_position_top"),value:"top"},{label:d.t("editor.clock_position_details"),value:"details"}]}}},{name:"clock_format",selector:{select:{options:[{label:d.t("editor.clock_format_24h"),value:"24h"},{label:d.t("editor.clock_format_12h"),value:"12h"}]}}},{name:"show_animations",selector:{boolean:{}}},{name:"overlay_opacity",selector:{number:{min:0,max:1,step:0.05,mode:"box"}}},{name:"text_shadow",selector:{number:{min:0,max:3,step:1,mode:"box"}}},{name:"language",selector:{select:{options:[{label:d.t("editor.language_auto"),value:"auto"},...Object.keys(D).map((o)=>({label:an(o),value:o}))]}}},{name:"wind_speed_unit",selector:{select:{options:[{label:d.t("editor.wind_speed_unit_ms"),value:"ms"},{label:d.t("editor.wind_speed_unit_kmh"),value:"kmh"}]}}}]}_computeLabel=(o)=>{let i=`editor.${o.name}`,a=d.t(i);return a===i?o.name:a};_valueChanged(o){let i=o.detail?.value;if(!i)return;this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}render(){if(!this.hass)return h``;return h`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
      ...
      ></ha-form>
    `}}m([f({attribute:!1})],Xo.prototype,"hass",void 0),m([go()],Xo.prototype,"_config",void 0);var Ii={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ei=(o)=>(...i)=>({["_$litDirective$"]:o,values:i});class Yo{constructor(o){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(o,i,a){this.__part=o,this._$parent=i,this.__attributeIndex=a}_$resolve(o,i){return this.update(o,i)}update(o,i){return this.render(...i)}}var nn=!0,As=nn&&window.ShadyDOM?.inUse&&window.ShadyDOM?.noPatch===!0?window.ShadyDOM.wrap:(o)=>o;var oa=(o)=>o.strings===void 0;var en=!0,ao=(o,i)=>{let a=o._$disconnectableChildren;if(a===void 0)return!1;for(let n of a)n._$notifyDirectiveConnectionChanged?.(i,!1),ao(n,i);return!0},yo=(o)=>{let i,a;do{if((i=o._$parent)===void 0)break;a=i._$disconnectableChildren,a.delete(o),o=i}while(a?.size===0)},ia=(o)=>{for(let i;i=o._$parent;o=i){let a=i._$disconnectableChildren;if(a===void 0)i._$disconnectableChildren=a=new Set;else if(a.has(o))break;a.add(o),ln(i)}};function rn(o){if(this._$disconnectableChildren!==void 0)yo(this),this._$parent=o,ia(this);else this._$parent=o}function sn(o,i=!1,a=0){let n=this._$committedValue,e=this._$disconnectableChildren;if(e===void 0||e.size===0)return;if(i){if(Array.isArray(n))for(let r=a;r<n.length;r++)ao(n[r],!1),yo(n[r]);else if(n!=null)ao(n,!1),yo(n)}else ao(this,o)}var ln=(o)=>{if(o.type==Ii.CHILD)o._$notifyConnectionChanged??=sn,o._$reparentDisconnectables??=rn};class Oo extends Yo{constructor(){super(...arguments);this._$disconnectableChildren=void 0}_$initialize(o,i,a){super._$initialize(o,i,a),ia(this),this.isConnected=o._$isConnected}["_$notifyDirectiveConnectionChanged"](o,i=!0){if(o!==this.isConnected)if(this.isConnected=o,o)this.reconnected?.();else this.disconnected?.();if(i)ao(this,o),yo(this)}setValue(o){if(oa(this.__part))this.__part._$setValue(o,this);else{if(en&&this.__attributeIndex===void 0)throw Error("Expected this.__attributeIndex to be a number");let i=[...this.__part._$committedValue];i[this.__attributeIndex]=o,this.__part._$setValue(i,this,0)}}disconnected(){}reconnected(){}}class aa extends Oo{_key="";_onLangChange=null;render(o){return this._key=o,d.t(o)}reconnected(){this._onLangChange=()=>{this.setValue(d.t(this._key))},window.addEventListener("language-changed",this._onLangChange)}disconnected(){if(this._onLangChange)window.removeEventListener("language-changed",this._onLangChange)}}var tn=Ei(aa);try{customElements.define("dynamic-weather-card",Lo),customElements.define("dynamic-weather-card-editor",Xo),console.log(`%cDynamic Weather Card %c${Mi}`,"color: #007AFF; font-weight: bold; font-size: 14px;","color: #666; font-size: 12px;",`
Динамическая карточка погоды`),window.customCards=window.customCards||[];let o={type:"dynamic-weather-card",name:"Dynamic Weather Card",description:"Динамическая карточка погоды",preview:!0,documentationURL:"https://github.com/teuchezh/dynamic-weather-card"};window.customCards.push(o)}catch(o){console.error("❌ Ошибка при регистрации Dynamic Weather Card:",o)}export{tn as t,E as resolveLanguage,d as i18n};
