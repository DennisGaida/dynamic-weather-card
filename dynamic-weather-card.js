var w=function(i,o,a,n){var e=arguments.length,r=e<3?o:n===null?n=Object.getOwnPropertyDescriptor(o,a):n,l;if(typeof Reflect==="object"&&typeof Reflect.decorate==="function")r=Reflect.decorate(i,o,a,n);else for(var s=i.length-1;s>=0;s--)if(l=i[s])r=(e<3?l(r):e>3?l(o,a,r):l(o,a))||r;return e>3&&r&&Object.defineProperty(o,a,r),r};var ai=globalThis,ki=ai.ShadowRoot&&(ai.ShadyCSS===void 0||ai.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,yi=Symbol(),Xi=new WeakMap;class wi{constructor(i,o,a){if(this._$cssResult$=!0,a!==yi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=i,this._strings=o}get styleSheet(){let i=this._styleSheet,o=this._strings;if(ki&&i===void 0){let a=o!==void 0&&o.length===1;if(a)i=Xi.get(o);if(i===void 0){if((this._styleSheet=i=new CSSStyleSheet).replaceSync(this.cssText),a)Xi.set(o,i)}}return i}toString(){return this.cssText}}var na=(i)=>{if(i._$cssResult$===!0)return i.cssText;else if(typeof i==="number")return i;else throw Error(`Value passed to 'css' function must be a 'css' function result: ${i}. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)},ea=(i)=>new wi(typeof i==="string"?i:String(i),void 0,yi),T=(i,...o)=>{let a=i.length===1?i[0]:o.reduce((n,e,r)=>n+na(e)+i[r+1],i[0]);return new wi(a,i,yi)},Yi=(i,o)=>{if(ki)i.adoptedStyleSheets=o.map((a)=>a instanceof CSSStyleSheet?a:a.styleSheet);else for(let a of o){let n=document.createElement("style"),e=ai.litNonce;if(e!==void 0)n.setAttribute("nonce",e);n.textContent=a.cssText,i.appendChild(n)}},ra=(i)=>{let o="";for(let a of i.cssRules)o+=a.cssText;return ea(o)},mi=ki?(i)=>i:(i)=>i instanceof CSSStyleSheet?ra(i):i;var{is:la,defineProperty:sa,getOwnPropertyDescriptor:Oi,getOwnPropertyNames:ta,getOwnPropertySymbols:da,getPrototypeOf:Ii}=Object,ca=!1,b=globalThis;if(ca)b.customElements??=customElements;var M=!0,A,Ei=b.trustedTypes,ga=Ei?Ei.emptyScript:"",oo=M?b.reactiveElementPolyfillSupportDevMode:b.reactiveElementPolyfillSupport;if(M)b.litIssuedWarnings??=new Set,A=(i,o)=>{if(o+=` See https://lit.dev/msg/${i} for more information.`,!b.litIssuedWarnings.has(o)&&!b.litIssuedWarnings.has(i))console.warn(o),b.litIssuedWarnings.add(o)},queueMicrotask(()=>{if(A("dev-mode","Lit is in dev mode. Not recommended for production!"),b.ShadyDOM?.inUse&&oo===void 0)A("polyfill-support-missing","Shadow DOM is being polyfilled via `ShadyDOM` but the `polyfill-support` module has not been loaded.")});var ua=M?(i)=>{if(!b.emitLitDebugLogEvents)return;b.dispatchEvent(new CustomEvent("lit-debug",{detail:i}))}:void 0,$=(i,o)=>i,Q={toAttribute(i,o){switch(o){case Boolean:i=i?ga:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i);break}return i},fromAttribute(i,o){let a=i;switch(o){case Boolean:a=i!==null;break;case Number:a=i===null?null:Number(i);break;case Object:case Array:try{a=JSON.parse(i)}catch(n){a=null}break}return a}},ni=(i,o)=>!la(i,o),io={attribute:!0,type:String,converter:Q,reflect:!1,useDefault:!1,hasChanged:ni};Symbol.metadata??=Symbol("metadata");b.litPropertyMetadata??=new WeakMap;class S extends HTMLElement{static addInitializer(i){this.__prepare(),(this._initializers??=[]).push(i)}static get observedAttributes(){return this.finalize(),this.__attributeToPropertyMap&&[...this.__attributeToPropertyMap.keys()]}static createProperty(i,o=io){if(o.state)o.attribute=!1;if(this.__prepare(),this.prototype.hasOwnProperty(i))o=Object.create(o),o.wrapped=!0;if(this.elementProperties.set(i,o),!o.noAccessor){let a=M?Symbol.for(`${String(i)} (@property() cache)`):Symbol(),n=this.getPropertyDescriptor(i,a,o);if(n!==void 0)sa(this.prototype,i,n)}}static getPropertyDescriptor(i,o,a){let{get:n,set:e}=Oi(this.prototype,i)??{get(){return this[o]},set(r){this[o]=r}};if(M&&n==null){if("value"in(Oi(this.prototype,i)??{}))throw Error(`Field ${JSON.stringify(String(i))} on ${this.name} was declared as a reactive property but it's actually declared as a value on the prototype. Usually this is due to using @property or @state on a method.`);A("reactive-property-without-getter",`Field ${JSON.stringify(String(i))} on ${this.name} was declared as a reactive property but it does not have a getter. This will be an error in a future version of Lit.`)}return{get:n,set(r){let l=n?.call(this);e?.call(this,r),this.requestUpdate(i,l,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(i){return this.elementProperties.get(i)??io}static __prepare(){if(this.hasOwnProperty($("elementProperties",this)))return;let i=Ii(this);if(i.finalize(),i._initializers!==void 0)this._initializers=[...i._initializers];this.elementProperties=new Map(i.elementProperties)}static finalize(){if(this.hasOwnProperty($("finalized",this)))return;if(this.finalized=!0,this.__prepare(),this.hasOwnProperty($("properties",this))){let o=this.properties,a=[...ta(o),...da(o)];for(let n of a)this.createProperty(n,o[n])}let i=this[Symbol.metadata];if(i!==null){let o=litPropertyMetadata.get(i);if(o!==void 0)for(let[a,n]of o)this.elementProperties.set(a,n)}this.__attributeToPropertyMap=new Map;for(let[o,a]of this.elementProperties){let n=this.__attributeNameForProperty(o,a);if(n!==void 0)this.__attributeToPropertyMap.set(n,o)}if(this.elementStyles=this.finalizeStyles(this.styles),M){if(this.hasOwnProperty("createProperty"))A("no-override-create-property","Overriding ReactiveElement.createProperty() is deprecated. The override will not be called with standard decorators");if(this.hasOwnProperty("getPropertyDescriptor"))A("no-override-get-property-descriptor","Overriding ReactiveElement.getPropertyDescriptor() is deprecated. The override will not be called with standard decorators")}}static finalizeStyles(i){let o=[];if(Array.isArray(i)){let a=new Set(i.flat(1/0).reverse());for(let n of a)o.unshift(mi(n))}else if(i!==void 0)o.push(mi(i));return o}static __attributeNameForProperty(i,o){let a=o.attribute;return a===!1?void 0:typeof a==="string"?a:typeof i==="string"?i.toLowerCase():void 0}constructor(){super();this.__instanceProperties=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this.__reflectingProperty=null,this.__initialize()}__initialize(){this.__updatePromise=new Promise((i)=>this.enableUpdating=i),this._$changedProperties=new Map,this.__saveInstanceProperties(),this.requestUpdate(),this.constructor._initializers?.forEach((i)=>i(this))}addController(i){if((this.__controllers??=new Set).add(i),this.renderRoot!==void 0&&this.isConnected)i.hostConnected?.()}removeController(i){this.__controllers?.delete(i)}__saveInstanceProperties(){let i=new Map,o=this.constructor.elementProperties;for(let a of o.keys())if(this.hasOwnProperty(a))i.set(a,this[a]),delete this[a];if(i.size>0)this.__instanceProperties=i}createRenderRoot(){let i=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Yi(i,this.constructor.elementStyles),i}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this.__controllers?.forEach((i)=>i.hostConnected?.())}enableUpdating(i){}disconnectedCallback(){this.__controllers?.forEach((i)=>i.hostDisconnected?.())}attributeChangedCallback(i,o,a){this._$attributeToProperty(i,a)}__propertyToAttribute(i,o){let n=this.constructor.elementProperties.get(i),e=this.constructor.__attributeNameForProperty(i,n);if(e!==void 0&&n.reflect===!0){let l=(n.converter?.toAttribute!==void 0?n.converter:Q).toAttribute(o,n.type);if(M&&this.constructor.enabledWarnings.includes("migration")&&l===void 0)A("undefined-attribute-value",`The attribute value for the ${i} property is undefined on element ${this.localName}. The attribute will be removed, but in the previous version of \`ReactiveElement\`, the attribute would not have changed.`);if(this.__reflectingProperty=i,l==null)this.removeAttribute(e);else this.setAttribute(e,l);this.__reflectingProperty=null}}_$attributeToProperty(i,o){let a=this.constructor,n=a.__attributeToPropertyMap.get(i);if(n!==void 0&&this.__reflectingProperty!==n){let e=a.getPropertyOptions(n),r=typeof e.converter==="function"?{fromAttribute:e.converter}:e.converter?.fromAttribute!==void 0?e.converter:Q;this.__reflectingProperty=n;let l=r.fromAttribute(o,e.type);this[n]=l??this.__defaultValues?.get(n)??l,this.__reflectingProperty=null}}requestUpdate(i,o,a,n=!1,e){if(i!==void 0){if(M&&i instanceof Event)A("","The requestUpdate() method was called with an Event as the property name. This is probably a mistake caused by binding this.requestUpdate as an event listener. Instead bind a function that will call it with no arguments: () => this.requestUpdate()");let r=this.constructor;if(n===!1)e=this[i];if(a??=r.getPropertyOptions(i),(a.hasChanged??ni)(e,o)||a.useDefault&&a.reflect&&e===this.__defaultValues?.get(i)&&!this.hasAttribute(r.__attributeNameForProperty(i,a)))this._$changeProperty(i,o,a);else return}if(this.isUpdatePending===!1)this.__updatePromise=this.__enqueueUpdate()}_$changeProperty(i,o,{useDefault:a,reflect:n,wrapped:e},r){if(a&&!(this.__defaultValues??=new Map).has(i)){if(this.__defaultValues.set(i,r??o??this[i]),e!==!0||r!==void 0)return}if(!this._$changedProperties.has(i)){if(!this.hasUpdated&&!a)o=void 0;this._$changedProperties.set(i,o)}if(n===!0&&this.__reflectingProperty!==i)(this.__reflectingProperties??=new Set).add(i)}async __enqueueUpdate(){this.isUpdatePending=!0;try{await this.__updatePromise}catch(o){Promise.reject(o)}let i=this.scheduleUpdate();if(i!=null)await i;return!this.isUpdatePending}scheduleUpdate(){let i=this.performUpdate();if(M&&this.constructor.enabledWarnings.includes("async-perform-update")&&typeof i?.then==="function")A("async-perform-update",`Element ${this.localName} returned a Promise from performUpdate(). This behavior is deprecated and will be removed in a future version of ReactiveElement.`);return i}performUpdate(){if(!this.isUpdatePending)return;if(ua?.({kind:"update"}),!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),M){let e=[...this.constructor.elementProperties.keys()].filter((r)=>this.hasOwnProperty(r)&&(r in Ii(this)));if(e.length)throw Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${e.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`)}if(this.__instanceProperties){for(let[n,e]of this.__instanceProperties)this[n]=e;this.__instanceProperties=void 0}let a=this.constructor.elementProperties;if(a.size>0)for(let[n,e]of a){let{wrapped:r}=e,l=this[n];if(r===!0&&!this._$changedProperties.has(n)&&l!==void 0)this._$changeProperty(n,void 0,e,l)}}let i=!1,o=this._$changedProperties;try{if(i=this.shouldUpdate(o),i)this.willUpdate(o),this.__controllers?.forEach((a)=>a.hostUpdate?.()),this.update(o);else this.__markUpdated()}catch(a){throw i=!1,this.__markUpdated(),a}if(i)this._$didUpdate(o)}willUpdate(i){}_$didUpdate(i){if(this.__controllers?.forEach((o)=>o.hostUpdated?.()),!this.hasUpdated)this.hasUpdated=!0,this.firstUpdated(i);if(this.updated(i),M&&this.isUpdatePending&&this.constructor.enabledWarnings.includes("change-in-update"))A("change-in-update",`Element ${this.localName} scheduled an update (generally because a property was set) after an update completed, causing a new update to be scheduled. This is inefficient and should be avoided unless the next update can only be scheduled as a side effect of the previous update.`)}__markUpdated(){this._$changedProperties=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.__updatePromise}shouldUpdate(i){return!0}update(i){this.__reflectingProperties&&=this.__reflectingProperties.forEach((o)=>this.__propertyToAttribute(o,this[o])),this.__markUpdated()}updated(i){}firstUpdated(i){}}S.elementStyles=[];S.shadowRootOptions={mode:"open"};S[$("elementProperties",S)]=new Map;S[$("finalized",S)]=new Map;oo?.({ReactiveElement:S});if(M){S.enabledWarnings=["change-in-update","async-perform-update"];let i=function(o){if(!o.hasOwnProperty($("enabledWarnings",o)))o.enabledWarnings=o.enabledWarnings.slice()};S.enableWarning=function(o){if(i(this),!this.enabledWarnings.includes(o))this.enabledWarnings.push(o)},S.disableWarning=function(o){i(this);let a=this.enabledWarnings.indexOf(o);if(a>=0)this.enabledWarnings.splice(a,1)}}(b.reactiveElementVersions??=[]).push("2.1.2");if(M&&b.reactiveElementVersions.length>1)queueMicrotask(()=>{A("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});var P=globalThis,_=(i)=>{if(!P.emitLitDebugLogEvents)return;P.dispatchEvent(new CustomEvent("lit-debug",{detail:i}))},_a=0,U;P.litIssuedWarnings??=new Set,U=(i,o)=>{if(o+=i?` See https://lit.dev/msg/${i} for more information.`:"",!P.litIssuedWarnings.has(o)&&!P.litIssuedWarnings.has(i))console.warn(o),P.litIssuedWarnings.add(o)},queueMicrotask(()=>{U("dev-mode","Lit is in dev mode. Not recommended for production!")});var N=P.ShadyDOM?.inUse&&P.ShadyDOM?.noPatch===!0?P.ShadyDOM.wrap:(i)=>i,ei=P.trustedTypes,ao=ei?ei.createPolicy("lit-html",{createHTML:(i)=>i}):void 0,ha=(i)=>i,ti=(i,o,a)=>ha,ka=(i)=>{if(q!==ti)throw Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");q=i},ya=()=>{q=ti},Fi=(i,o,a)=>{return q(i,o,a)},co="$lit$",K=`lit$${Math.random().toFixed(9).slice(2)}$`,go="?"+K,wa=`<${go}>`,J=document,R=()=>J.createComment(""),L=(i)=>i===null||typeof i!="object"&&typeof i!="function",bi=Array.isArray,ma=(i)=>bi(i)||typeof i?.[Symbol.iterator]==="function",fi=`[ 	
\f\r]`,fa=`[^ 	
\f\r"'\`<>=]`,pa=`[^\\s"'>=/]`,x=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,no=1,pi=2,za=3,eo=/-->/g,ro=/>/g,C=new RegExp(`>|${fi}(?:(${pa}+)(${fi}*=${fi}*(?:${fa}|("|')|))|$)`,"g"),va=0,lo=1,Fa=2,so=3,zi=/'/g,vi=/"/g,uo=/^(?:script|style|textarea|title)$/i,ba=1,ri=2,li=3,Mi=1,si=2,Ma=3,Sa=4,Pa=5,Si=6,Aa=7,Pi=(i)=>(o,...a)=>{if(o.some((n)=>n===void 0))console.warn(`Some template strings are undefined.
...
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:i,strings:o,values:a}},h=Pi(ba),k=Pi(ri),hn=Pi(li),W=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),to=new WeakMap,B=J.createTreeWalker(J,129),q=ti;function _o(i,o){if(!bi(i)||!i.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
...
`;class F{ctx;constructor(i){this.ctx=i}drawCloud(i,o,a,n){let e=this.ctx.shadowBlur,r=this.ctx.shadowColor,l=this.ctx.globalAlpha;this.ctx.shadowBlur=a*0.25,this.ctx.shadowColor=`rgba(255, 255, 255, ${n*0.4})`,this.ctx.globalAlpha=n*0.85,this.ctx.fillStyle="rgba(255, 255, 255, 1)",[{x:i,y:o,r:a*0.4},{x:i+a*0.35,y:o,r:a*0.5},{x:i+a*0.65,y:o,r:a*0.48},{x:i+a*0.92,y:o,r:a*0.38},{x:i+a*0.18,y:o-a*0.28,r:a*0.38},{x:i+a*0.52,y:o-a*0.32,r:a*0.42},{x:i+a*0.78,y:o-a*0.28,r:a*0.38},{x:i+a*0.32,y:o-a*0.42,r:a*0.32},{x:i+a*0.62,y:o-a*0.48,r:a*0.36},{x:i+a*0.82,y:o-a*0.42,r:a*0.32}].forEach((t)=>{this.ctx.beginPath(),this.ctx.arc(t.x,t.y,t.r,0,Math.PI*2),this.ctx.fill()}),this.ctx.shadowBlur=e,this.ctx.shadowColor=r,this.ctx.globalAlpha=l}drawClouds(i,o,a,n=0.5){let e=Math.max(2,Math.floor(o/150*n));for(let r=0;r<e;r++){let l=(i*3+r*150)%(o+200)-100,s=a*(0.2+r%3*0.15)+Math.sin(i*0.2+r)*8,t=40+r%3*15,g=0.6+r%2*0.2;this.drawCloud(l,s,t,g)}}}class Di extends F{draw(i,o,a,n){let e=Date.now()*0.001,r=Jo(n,o,a),l=r.x,s=r.y;if(n.type==="day"||n.type==="sunrise"||n.type==="sunset"){if(this.drawSun(l,s,e),n.type==="sunrise"||n.type==="sunset")this.drawHorizonReflection(l,s,a,e)}else if(n.type==="night")this.drawNightSky(o,a,e);this.drawClouds(e,o,a,0.3)}drawSun(i,o,a){let n=48+Math.sin(a*0.15)*1.5,e=this.ctx.createRadialGradient(i,o,n*0.3,i,o,n*3.5);e.addColorStop(0,"rgba(255, 248, 230, 0.25)"),e.addColorStop(0.15,"rgba(255, 240, 200, 0.2)"),e.addColorStop(0.3,"rgba(255, 230, 170, 0.15)"),e.addColorStop(0.5,"rgba(255, 220, 140, 0.1)"),e.addColorStop(0.7,"rgba(255, 210, 120, 0.06)"),e.addColorStop(0.85,"rgba(255, 200, 100, 0.03)"),e.addColorStop(1,"rgba(255, 190, 90, 0)"),this.ctx.fillStyle=e,this.ctx.beginPath(),this.ctx.arc(i,o,n*3.5,0,Math.PI*2),this.ctx.fill();let r=this.ctx.createRadialGradient(i,o,n*0.5,i,o,n*2.2);r.addColorStop(0,"rgba(255, 250, 220, 0.35)"),r.addColorStop(0.3,"rgba(255, 240, 190, 0.25)"),r.addColorStop(0.6,"rgba(255, 230, 160, 0.15)"),r.addColorStop(0.85,"rgba(255, 220, 140, 0.08)"),r.addColorStop(1,"rgba(255, 210, 120, 0)"),this.ctx.fillStyle=r,this.ctx.beginPath(),this.ctx.arc(i,o,n*2.2,0,Math.PI*2),this.ctx.fill();let l=this.ctx.createRadialGradient(i,o,n*0.6,i,o,n*1.6);l.addColorStop(0,"rgba(255, 252, 240, 0.5)"),l.addColorStop(0.4,"rgba(255, 245, 210, 0.35)"),l.addColorStop(0.7,"rgba(255, 235, 180, 0.2)"),l.addColorStop(1,"rgba(255, 225, 150, 0)"),this.ctx.fillStyle=l,this.ctx.beginPath(),this.ctx.arc(i,o,n*1.6,0,Math.PI*2),this.ctx.fill();let s=this.ctx.createRadialGradient(i-n*0.1,o-n*0.1,0,i,o,n);s.addColorStop(0,"#FFFEF5"),s.addColorStop(0.15,"#FFF9E6"),s.addColorStop(0.3,"#FFF4D6"),s.addColorStop(0.5,"#FFEDC0"),s.addColorStop(0.7,"#FFE4A8"),s.addColorStop(0.85,"#FFDC95"),s.addColorStop(1,"#FFD37F"),this.ctx.fillStyle=s,this.ctx.beginPath(),this.ctx.arc(i,o,n,0,Math.PI*2),this.ctx.fill()}drawHorizonReflection(i,o,a,n){let e=48+Math.sin(n*0.15)*1.5,r=a*0.85;if(o>=r-50){let l=Math.max(0,(r-o)/50)*0.3;this.ctx.fillStyle=`rgba(255, 140, 0, ${l})`,this.ctx.beginPath(),this.ctx.ellipse(i,r,e*1.5,e*0.5,0,0,Math.PI*2),this.ctx.fill()}}drawNightSky(i,o,a){this.ctx.fillStyle="#FFFFFF";for(let r=0;r<20;r++){let l=(i*0.2+r*47)%i,s=(o*0.2+r*23)%(o*0.6),t=Math.sin(a*0.8+r)*0.5+0.5;this.ctx.globalAlpha=t*0.8,this.ctx.beginPath(),this.ctx.arc(l,s,1.5,0,Math.PI*2),this.ctx.fill()}let n=i*0.75,e=o*0.3;this.ctx.globalAlpha=0.9,this.ctx.fillStyle="#F0F0F0",this.ctx.beginPath(),this.ctx.arc(n,e,25,0,Math.PI*2),this.ctx.fill(),this.ctx.fillStyle="#1a1a2e",this.ctx.beginPath(),this.ctx.arc(n-8,e-5,22,0,Math.PI*2),this.ctx.fill(),this.ctx.globalAlpha=1}}class E extends F{rainDrops=[];lastTime=0;draw(i,o,a,n,e=!1){let r=Date.now()*0.001;this.drawClouds(r,o,a,e?1:0.8),this.drawRain(o,a,e)}drawRain(i,o,a){let n=a?130:90;if(this.rainDrops.length!==n){this.rainDrops=[];for(let s=0;s<n;s++)this.rainDrops.push({x:Math.random()*i,y:Math.random()*o-Math.random()*200,speed:a?80+Math.random()*100:60+Math.random()*80,windOffset:(Math.random()-0.5)*30,width:a?1.2+Math.random()*1:0.8+Math.random()*0.7,length:a?8+Math.random()*10:6+Math.random()*8,alpha:a?0.75+Math.random()*0.15:0.65+Math.random()*0.2,phase:Math.random()*Math.PI*2})}let e=Date.now()*0.001,r=this.lastTime>0?Math.min(e-this.lastTime,0.1):0.016666666666666666;this.lastTime=e;let l=e;for(let s=0;s<this.rainDrops.length;s++){let t=this.rainDrops[s];if(t.y+=t.speed*r,t.y>o+50)t.y=-50-Math.random()*100,t.x=Math.random()*i;let g=t.windOffset*(1+Math.sin(l*0.5+t.phase)*0.2),c=t.x+g;if(c<-10)t.x=i+10;else if(c>i+10)t.x=-10;this.drawRainDrop(c,t.y,t)}}drawRainDrop(i,o,a){this.ctx.save(),this.ctx.globalAlpha=a.alpha;let n=o-a.length*0.5,e=o+a.length*0.5,r=a.alpha,l=a.alpha*0.5;this.ctx.fillStyle="rgba(220, 240, 255, "+r+")",this.ctx.strokeStyle="rgba(240, 250, 255, "+l+")",this.ctx.lineWidth=0.4,this.ctx.beginPath(),this.ctx.moveTo(i,n),this.ctx.quadraticCurveTo(i-a.width*0.3,o,i-a.width,e-a.width*0.3),this.ctx.arc(i,e,a.width,Math.PI,0,!1),this.ctx.quadraticCurveTo(i+a.width*0.3,o,i,n),this.ctx.closePath(),this.ctx.fill(),this.ctx.stroke(),this.ctx.restore()}}class Ti extends F{snowflakes=[];lastTime=0;draw(i,o,a,n){let e=Date.now()*0.001;this.drawClouds(e,o,a,0.7),this.drawSnowflakes(o,a)}drawSnowflakes(i,o){let a=Math.floor(i*o/5000),n=Math.max(30,Math.min(a,80));if(this.snowflakes.length!==n){this.snowflakes=[];for(let s=0;s<n;s++)this.snowflakes.push({x:Math.random()*i,y:Math.random()*o-Math.random()*100,speedY:15+Math.random()*10,speedX:(Math.random()-0.5)*8,size:1.5+Math.random()*1.5,alpha:0.6+Math.random()*0.3,rotation:Math.random()*Math.PI*2,rotationSpeed:(Math.random()-0.5)*0.3,swayPhase:Math.random()*Math.PI*2,swaySpeed:0.5+Math.random()*0.5})}let e=Date.now()*0.001,r=this.lastTime>0?Math.min(e-this.lastTime,0.1):0.016666666666666666;this.lastTime=e;let l=e;this.ctx.lineCap="round";for(let s=0;s<this.snowflakes.length;s++){let t=this.snowflakes[s],g=Math.sin(l*t.swaySpeed+t.swayPhase)*2;if(t.y+=t.speedY*r,t.x+=(t.speedX+g)*r,t.rotation+=t.rotationSpeed*r,t.y>o+20)t.y=-20-Math.random()*50,t.x=Math.random()*i;if(t.x<-10)t.x=i+10;else if(t.x>i+10)t.x=-10;this.drawSnowflake(t.x,t.y,t.size,t.alpha,t.rotation)}}drawSnowflake(i,o,a,n,e){this.ctx.save(),this.ctx.translate(i,o),this.ctx.rotate(e),this.ctx.strokeStyle=`rgba(255, 255, 255, ${n})`,this.ctx.lineWidth=1,this.ctx.beginPath();for(let r=0;r<6;r++){let l=Math.PI/3*r,s=Math.cos(l),t=Math.sin(l);this.ctx.moveTo(0,0),this.ctx.lineTo(t*a*2.5,s*a*2.5);let g=t*a*1.5+s*a*0.5,c=s*a*1.5-t*a*0.5,y=t*a*1.8+s*a*1.2,f=s*a*1.8-t*a*1.2;this.ctx.moveTo(g,c),this.ctx.lineTo(y,f);let z=t*a*1.5-s*a*0.5,j=s*a*1.5+t*a*0.5,oa=t*a*1.8-s*a*1.2,aa=s*a*1.8+t*a*1.2;this.ctx.moveTo(z,j),this.ctx.lineTo(oa,aa)}this.ctx.stroke(),this.ctx.restore()}}class Ci extends F{draw(i,o,a,n){let e=Date.now()*0.001;this.drawClouds(e,o,a,0.7)}}class Bi extends F{draw(i,o,a,n){let e=Date.now()*0.0003;this.ctx.fillStyle="rgba(200, 200, 200, 0.4)";for(let r=0;r<3;r++){let l=a*(0.4+r*0.2),s=Math.sin(e+r)*20;this.ctx.beginPath(),this.ctx.moveTo(0,l);for(let t=0;t<=o;t+=5){let g=Math.sin((t/o+e)*Math.PI*4+r)*15;this.ctx.lineTo(t,l+g+s)}this.ctx.lineTo(o,a),this.ctx.lineTo(0,a),this.ctx.closePath(),this.ctx.fill()}}}class Ji extends F{hailStones=[];draw(i,o,a,n){let e=Date.now()*0.001;this.drawClouds(e,o,a,1),this.drawHailStones(o,a)}drawHailStones(i,o){if(this.hailStones.length!==60){this.hailStones=[];for(let e=0;e<60;e++)this.hailStones.push({startX:Math.random()*i,startY:Math.random()*(o+150)-75,speed:120+Math.random()*80,windOffset:(Math.random()-0.5)*20,size:2+Math.random()*3,alpha:0.8+Math.random()*0.15,phase:Math.random()*Math.PI*2})}let n=Date.now()*0.002;this.ctx.fillStyle="rgba(240, 250, 255, 1)",this.ctx.strokeStyle="rgba(255, 255, 255, 0.9)",this.ctx.lineWidth=0.5;for(let e=0;e<this.hailStones.length;e++){let r=this.hailStones[e],l=(r.startY+n*r.speed)%(o+150);if(l>o+30)r.startY=-30-Math.random()*30,r.startX=Math.random()*i;let s=r.windOffset*(1+Math.sin(n*0.6+r.phase)*0.15),t=(r.startX+s+n*20%i)%i;if(t<-5)r.startX=i+5;else if(t>i+5)r.startX=-5;this.drawHailStone(t,l,r)}}drawHailStone(i,o,a){this.ctx.save(),this.ctx.globalAlpha=a.alpha,this.ctx.beginPath(),this.ctx.ellipse(i,o,a.size,a.size*0.9,0,0,Math.PI*2),this.ctx.fill(),this.ctx.stroke(),this.ctx.fillStyle="rgba(255, 255, 255, 0.6)",this.ctx.beginPath(),this.ctx.ellipse(i-a.size*0.3,o-a.size*0.3,a.size*0.3,a.size*0.25,0,0,Math.PI*2),this.ctx.fill(),this.ctx.fillStyle="rgba(240, 250, 255, 1)",this.ctx.restore()}}class Wi extends F{rainyAnimation;constructor(i){super(i);this.rainyAnimation=new E(i)}draw(i,o,a,n,e=!0){let r=Date.now()*0.001;if(this.drawClouds(r,o,a,1),e)this.rainyAnimation.draw(i,o,a,n,!1);this.drawLightning(o,a,r)}drawLightning(i,o,a){let n=Math.sin(a*2.5)*Math.sin(a*5.3)*Math.sin(a*7.1),e=Math.max(0,n);if(e>0.4){let r=(e-0.4)/0.6,l=r*0.6,s=Math.min(l,Math.sin(r*Math.PI)*0.6);this.ctx.fillStyle=`rgba(255, 255, 255, ${s})`,this.ctx.fillRect(0,0,i,o)}}}class qi{canvas=null;ctx=null;animationFrame=null;animations={};resizeObserver=null;width=0;height=0;container=null;getDrawParams;handleVisibilityChange=()=>{if(document.hidden)this.stopAnimation();else this.startAnimation()};constructor(i){this.getDrawParams=i}setup(i){if(this.container=i,this.setupCanvas(),this.canvas&&this.ctx)this.initializeAnimations(),this.startAnimation(),this.setupResizeObserver(),document.addEventListener("visibilitychange",this.handleVisibilityChange)}destroy(){if(document.removeEventListener("visibilitychange",this.handleVisibilityChange),this.stopAnimation(),this.resizeObserver)this.resizeObserver.disconnect(),this.resizeObserver=null;this.canvas=null,this.ctx=null,this.container=null}resize(){if(this.canvas&&this.ctx)this.resizeCanvas()}setupCanvas(){if(!this.container)return;let i=this.container.querySelector("canvas");if(i)i.remove();this.canvas=document.createElement("canvas"),this.container.appendChild(this.canvas),this.resizeCanvas()}resizeCanvas(){if(!this.canvas||!this.container)return;let i=this.container.getBoundingClientRect();if(i.width===0||i.height===0)return;let o=window.devicePixelRatio||2;if(this.canvas.width=i.width*o,this.canvas.height=i.height*o,this.canvas.style.width="100%",this.canvas.style.height="100%",this.ctx=this.canvas.getContext("2d"),this.ctx)this.ctx.scale(o,o);this.width=i.width,this.height=i.height,this.initializeAnimations()}setupResizeObserver(){if(!this.container)return;this.resizeObserver=new ResizeObserver(()=>{this.resizeCanvas()}),this.resizeObserver.observe(this.container)}initializeAnimations(){if(!this.ctx)return;this.animations={sunny:new Di(this.ctx),rainy:new E(this.ctx),snowy:new Ti(this.ctx),cloudy:new Ci(this.ctx),foggy:new Bi(this.ctx),hail:new Ji(this.ctx),thunderstorm:new Wi(this.ctx)}}startAnimation(){if(this.animationFrame)return;let i=()=>{this.draw(),this.animationFrame=requestAnimationFrame(i)};i()}stopAnimation(){if(this.animationFrame)cancelAnimationFrame(this.animationFrame),this.animationFrame=null}draw(){if(!this.ctx||!this.canvas)return;if(!this.width||!this.height){if(this.resizeCanvas(),!this.width||!this.height)return}let i=this.getDrawParams();if(!i)return;let{condition:o,timeOfDay:a}=i,n=this.width,e=this.height;switch(this.ctx.clearRect(0,0,n,e),o.toLowerCase()){case"sunny":case"clear":this.animations.sunny?.draw(Date.now(),n,e,a);break;case"clear-night":this.animations.sunny?.draw(Date.now(),n,e,{type:"night",progress:0});break;case"rainy":case"rain":this.animations.rainy?.draw(Date.now(),n,e,a,!1);break;case"pouring":this.animations.rainy?.draw(Date.now(),n,e,a,!0);break;case"snowy":case"snow":this.animations.snowy?.draw(Date.now(),n,e,a);break;case"snowy-rainy":this.animations.rainy?.draw(Date.now(),n,e,a,!1),this.animations.snowy?.draw(Date.now(),n,e,a);break;case"hail":this.animations.hail?.draw(Date.now(),n,e,a);break;case"foggy":case"fog":this.animations.foggy?.draw(Date.now(),n,e,a);break;case"lightning":this.animations.thunderstorm?.draw(Date.now(),n,e,a,!1);break;case"lightning-rainy":this.animations.thunderstorm?.draw(Date.now(),n,e,a,!0);break;case"cloudy":case"partlycloudy":default:this.animations.cloudy?.draw(Date.now(),n,e,a);break}}}class $i{hourlyForecast=[];dailyForecast=[];hourlySubscription=null;dailySubscription=null;onUpdate;constructor(i){this.onUpdate=i}getHourlyData(){return this.hourlyForecast}getDailyData(){return this.dailyForecast}async subscribe(i,o,a){if(!i||!o)return;this.unsubscribe();try{if(this.hourlySubscription=i.connection.subscribeMessage((n)=>{if(n.forecast&&n.forecast.length>0)this.hourlyForecast=n.forecast,this.onUpdate()},{type:"weather/subscribe_forecast",forecast_type:"hourly",entity_id:o}),a)this.dailySubscription=i.connection.subscribeMessage((n)=>{if(n.forecast&&n.forecast.length>0)this.dailyForecast=n.forecast,this.onUpdate()},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:o})}catch{}}async unsubscribe(){if(this.hourlySubscription){try{(await this.hourlySubscription)()}catch{}this.hourlySubscription=null}if(this.dailySubscription){try{(await this.dailySubscription)()}catch{}this.dailySubscription=null}}getHourlyForecast(i,o){let a=Math.max(1,Math.floor(Number(i??u.hourlyForecastHours)));if(this.hourlyForecast&&this.hourlyForecast.length>0)return this.hourlyForecast.slice(0,a);if(!o?.forecast||o.forecast.length===0)return[];let n=new Date,e=new Date(n.getFullYear(),n.getMonth(),n.getDate()),r=new Date(e);return r.setDate(r.getDate()+1),o.forecast.filter((s)=>{if(!s.datetime)return!1;let t=new Date(s.datetime),g=new Date(t.getFullYear(),t.getMonth(),t.getDate());return g.getTime()===e.getTime()||g.getTime()===r.getTime()&&t.getHours()<=n.getHours()}).sort((s,t)=>new Date(s.datetime).getTime()-new Date(t.datetime).getTime()).slice(0,a)}getDailyForecast(i,o){let a=Math.max(1,Math.floor(Number(i??u.dailyForecastDays)));if(this.dailyForecast&&this.dailyForecast.length>0)return this.dailyForecast.slice(0,a);if(!o?.forecast||o.forecast.length===0)return[];let n=new Date,e=new Date(n.getFullYear(),n.getMonth(),n.getDate()),r=new Date(e);r.setDate(r.getDate()+a);let l=(t)=>{let g=t.getFullYear(),c=String(t.getMonth()+1).padStart(2,"0"),y=String(t.getDate()).padStart(2,"0");return`${g}-${c}-${y}`},s=new Map;return o.forecast.forEach((t)=>{if(!t.datetime)return;let g=new Date(t.datetime);if(Number.isNaN(g.getTime()))return;if(g<e||g>=r)return;let c=l(g),y=Math.abs(g.getHours()+g.getMinutes()/60-12),f=s.get(c);if(!f||y<f.hourScore)s.set(c,{item:t,itemDate:g,hourScore:y})}),Array.from(s.values()).sort((t,g)=>t.itemDate.getTime()-g.itemDate.getTime()).map((t)=>t.item).slice(0,a)}}class Gi{holdTimer=null;lastTap=null;holdFired=!1;holdDelay=500;getHass;getConfig;fireEvent;constructor(i,o,a){this.getHass=i,this.getConfig=o,this.fireEvent=a}handleTap(i){if(i.target.closest(".forecast-item")||i.target.closest(".info-item"))return;if(this.lastTap&&Date.now()-this.lastTap<300){this.handleDoubleTap(),this.lastTap=null;return}this.lastTap=Date.now(),setTimeout(()=>{if(this.lastTap)this.handleAction(this.getConfig().tapAction),this.lastTap=null},300)}handlePointerDown(){this.holdTimer=window.setTimeout(()=>{this.handleHold(),this.holdFired=!0},this.holdDelay)}handlePointerUp(i){if(this.holdTimer)clearTimeout(this.holdTimer);if(this.holdFired)i.preventDefault(),i.stopPropagation(),this.holdFired=!1}handleHold(){this.handleAction(this.getConfig().holdAction)}handleDoubleTap(){this.handleAction(this.getConfig().doubleTapAction)}handleAction(i){let o=this.getHass(),a=this.getConfig();if(!i||!o)return;switch(i.action||"more-info"){case"more-info":this.fireEvent("hass-more-info",{entityId:i.entity||a.entity});break;case"toggle":o.callService("homeassistant","toggle",{entity_id:i.entity||a.entity});break;case"call-service":if(i.service){let[e,r]=i.service.split(".");o.callService(e,r,i.service_data||{})}break;case"navigate":if(i.navigation_path)window.history.pushState(null,"",i.navigation_path),this.fireEvent("location-changed",{replace:!1});break;case"url":if(i.url_path)window.open(i.url_path);break;case"none":default:break}}}function Ia(i,o){if(!i||!o)return null;let a=i.states[o];return a?a.state:null}function Qi(i,o){if(!i||!o)return{};let a=i.states[o];return a?a.attributes:{}}function xi(i,o,a,n){let e=Ia(i,o),r=Qi(i,o),l=r.condition||e||"sunny",s=null;if(a.templowAttribute&&r[a.templowAttribute]!=null)s=r[a.templowAttribute];else{for(let t of Fo)if(r[t]!=null){s=r[t];break}if(s==null)s=(r.forecast&&r.forecast[0]?r.forecast[0].templow??null:null)||(r.forecast_hourly&&r.forecast_hourly[0]?r.forecast_hourly[0].native_templow??null:null)}return{condition:l,temperature:r.temperature!=null?r.temperature:null,apparentTemperature:r.apparent_temperature||null,humidity:r.humidity!=null?r.humidity:null,windSpeed:r.wind_speed!=null?r.wind_speed:null,windGust:r.wind_gust_speed||r.wind_gust||null,windBearing:r.wind_bearing!=null?r.wind_bearing:null,windDirection:r.wind_direction||null,pressure:r.pressure||null,forecast:r.forecast||r.forecast_hourly||n||[],friendlyName:r.friendly_name||d.t("weather"),templow:s}}class Vo extends v{constructor(){super(...arguments);this.format=null;this.currentTime=""}clockInterval=null;static styles=T`
    :host {
      display: block;
    }
...
`,on={sunny:k`
  ...
  `};function ii(i,...o){let a=Ea[i];if(typeof a==="function")return a(...o);return a||""}function ui(i){if(!i)return"";return on[i.toLowerCase()]||""}class Ro extends v{constructor(){super(...arguments);this.weather=null;this.sunData=null;this.config=null;this.entityAttributes=null}static styles=T`
    :host {
      display: block;
    }
  ...
  `;hasContent(){if(!this.weather||!this.config)return!1;return this.config.showHumidity&&this.weather.humidity!=null||this.config.showWind&&this.weather.windSpeed!=null||this.config.showSunriseSunset&&this.sunData?.hasSunData===!0}renderHumidity(){if(!this.config?.showHumidity||this.weather?.humidity==null)return h``;return h`
    ...
    `}renderSunrise(){if(!this.config?.showSunriseSunset||!this.sunData?.hasSunData||!this.sunData.sunrise)return h``;return h`
      <div class="info-item">
        ...
        <span>${Hi(this.sunData.sunrise,this.config.clockFormat,d.t("am"),d.t("pm"))}</span>
      </div>
    `}renderWind(){if(!this.config?.showWind||this.weather?.windSpeed==null)return h``;let i=this.entityAttributes||{},o=Zi(this.weather.windSpeed,i,this.config.windSpeedUnit),a=Go(i,this.config.windSpeedUnit,d.t.bind(d)),n="";if(this.config.showWindGust&&this.weather.windGust)n=` / ${Zi(this.weather.windGust,i,this.config.windSpeedUnit)} ${a}`;let e=this.config.showWindDirection&&this.weather.windBearing!=null?Uo(this.weather.windBearing):ii("wind");return h`
      <div class="info-item">
    ...
    `}renderSunset(){if(!this.config?.showSunriseSunset||!this.sunData?.hasSunData||!this.sunData.sunset)return h``;return h`
      <div class="info-item">
        ...
        <span>${Hi(this.sunData.sunset,this.config.clockFormat,d.t("am"),d.t("pm"))}</span>
      </div>
    ...
    `}}w([m({type:Object})],Ro.prototype,"weather",void 0),w([m({type:Object})],Ro.prototype,"sunData",void 0),w([m({type:Object})],Ro.prototype,"config",void 0),w([m({type:Object})],Ro.prototype,"entityAttributes",void 0);customElements.define("weather-details",Ro);var _i=T`
  :host {
    display: block;
  }
...
`;class Lo extends v{constructor(){super(...arguments);this.forecast=[];this.clockFormat="24h"}static styles=_i;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=gi(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(i){return Math.round(i.temperature??i.temp??i.native_temperature??0)}render(){if(this.forecast.length===0)return h``;return h`
      <div class="forecast-container">
        <div class="forecast-title">${d.t("forecast_title")}</div>
        <div class="forecast-scroll">
          ${this.forecast.map((i)=>h`
            <div class="forecast-item">
              <div class="forecast-time">${qo(i.datetime,this.clockFormat,d.t("am"),d.t("pm"))}</div>
              <div class="forecast-icon">${ui(i.condition||"sunny")}</div>
              <div class="forecast-temp">${this.getTemperature(i)}°</div>
            </div>
          `)}
        </div>
      </div>
    `}}w([m({type:Array})],Lo.prototype,"forecast",void 0),w([m({type:String})],Lo.prototype,"clockFormat",void 0);customElements.define("hourly-forecast",Lo);class Xo extends v{constructor(){super(...arguments);this.forecast=[];this.lang="en"}static styles=_i;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=gi(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(i){return Math.round(i.temperature??i.temp??i.native_temperature??0)}render(){if(this.forecast.length===0)return h``;return h`
      <div class="forecast-container">
        <div class="forecast-title">${d.t("daily_forecast_title")}</div>
        <div class="forecast-scroll">
          ${this.forecast.map((i)=>h`
            <div class="forecast-item">
              <div class="forecast-time">${$o(i.datetime,this.lang)}</div>
              <div class="forecast-icon">${ui(i.condition||"sunny")}</div>
              <div class="forecast-temp">${this.getTemperature(i)}°</div>
            </div>
          `)}
    ...
    `}}w([m({type:Array})],Xo.prototype,"forecast",void 0),w([m({type:String})],Xo.prototype,"lang",void 0);customElements.define("daily-forecast",Xo);class Vi extends v{animationManager;forecastService;actionHandler;subscribedEntity=null;subscribedShowDaily=!1;_testTimeOfDay;static get styles(){return xo}static getConfigElement(){return document.createElement("dynamic-weather-card-editor")}static getStubConfig(){return{type:"custom:dynamic-weather-card",entity:"weather.home",show_hourly_forecast:!0,hourly_forecast_hours:u.hourlyForecastHours,show_daily_forecast:!0,daily_forecast_days:u.dailyForecastDays}}constructor(){super();this.config={},this.animationManager=new qi(()=>this.getDrawParams()),this.forecastService=new $i(()=>this.requestUpdate()),this.actionHandler=new Gi(()=>this.hass,()=>this.config,(i,o)=>this.fireEvent(i,o))}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{setTimeout(()=>{let i=this.shadowRoot?.querySelector(".canvas-container");if(i)this.animationManager.setup(i)},100)})}disconnectedCallback(){super.disconnectedCallback(),this.animationManager.destroy(),this.forecastService.unsubscribe()}updated(i){if(super.updated(i),i.has("hass")||i.has("config")){let a=this.config.entity,n=this.config.showDailyForecast??!1;if(this.hass&&a&&(a!==this.subscribedEntity||n!==this.subscribedShowDaily))this.subscribedEntity=a,this.subscribedShowDaily=n,this.forecastService.subscribe(this.hass,a,n)}let o=I({configLang:this.config?.language,hassLang:this.hass?.language});if(d.lang!==o)d.setLanguage(o)}getDrawParams(){if(!this.hass||!this.config.entity)return null;let i=xi(this.hass,this.config.entity,this.config,this.forecastService.getHourlyData()),o=this.hass.states[this.config.entity],a=ji(o||{},this.config.sunriseEntity,this.config.sunsetEntity,this.hass),n=this._testTimeOfDay||Ki(a);return{condition:i.condition,timeOfDay:n}}getDetailsConfig(){return{showHumidity:this.config.showHumidity??!0,showWind:this.config.showWind??!0,showWindGust:this.config.showWindGust??!0,showWindDirection:this.config.showWindDirection??!0,showSunriseSunset:this.config.showSunriseSunset??!0,clockFormat:this.config.clockFormat??"24h",windSpeedUnit:this.config.windSpeedUnit??"ms"}}setConfig(i){if(!i.entity)throw Error("Please define a weather entity");let o=i.show_hourly_forecast??i.show_forecast;if(this.config={type:"custom:dynamic-weather-card",entity:i.entity,icons_path:i.icons_path,name:i.name,height:i.height||u.height,showFeelsLike:i.show_feels_like!==!1,showWind:i.show_wind!==!1,showWindGust:i.show_wind_gust!==!1,showWindDirection:i.show_wind_direction!==!1,showHumidity:i.show_humidity!==!1,showMinTemp:i.show_min_temp!==!1,showForecast:i.show_forecast===!0,showHourlyForecast:o===!0,showDailyForecast:i.show_daily_forecast===!0,hourlyForecastHours:i.hourly_forecast_hours??u.hourlyForecastHours,dailyForecastDays:i.daily_forecast_days??u.dailyForecastDays,showSunriseSunset:i.show_sunrise_sunset!==!1,showClock:i.show_clock===!0,clockPosition:i.clock_position||u.clockPosition,clockFormat:i.clock_format||u.clockFormat,overlayOpacity:i.overlay_opacity!==void 0?i.overlay_opacity:u.overlayOpacity,language:i.language||u.language,windSpeedUnit:i.wind_speed_unit||u.windSpeedUnit,sunriseEntity:i.sunrise_entity||null,sunsetEntity:i.sunset_entity||null,templowAttribute:i.templow_attribute||null,tapAction:i.tap_action||{action:"more-info"},holdAction:i.hold_action||{action:"none"},doubleTapAction:i.double_tap_action||{action:"none"}},this.config.language)d.setLanguage(this.config.language)}fireEvent(i,o={}){let a=new CustomEvent(i,{detail:o,bubbles:!0,composed:!0});this.dispatchEvent(a)}getCardSize(){return 1}render(){if(!this.hass)return h`<div>No Home Assistant connection</div>`;let i=xi(this.hass,this.config.entity,this.config,this.forecastService.getHourlyData()),o=this.hass.states[this.config.entity],a=ji(o,this.config.sunriseEntity,this.config.sunsetEntity,this.hass),n=this._testTimeOfDay||Ki(a),e=`weather-card ${n.type}`,r=this.config.height?`${this.config.height}px`:"200px",l=Wo(n),s=l?`background: linear-gradient(135deg, rgb(${l.start.r}, ${l.start.g}, ${l.start.b}), rgb(${l.end.r}, ${l.end.g}, ${l.end.b}));`:"",g=`--overlay-opacity: ${this.config.overlayOpacity!==void 0?this.config.overlayOpacity:u.overlayOpacity};`,c=this.config.showHourlyForecast?this.forecastService.getHourlyForecast(this.config.hourlyForecastHours??u.hourlyForecastHours,i):[],y=this.config.showDailyForecast?this.forecastService.getDailyForecast(this.config.dailyForecastDays??u.dailyForecastDays,i):[];return h`
      <ha-card
      ...
      >
        <div class="${e}" style="min-height: ${r}; ${s}; ${g} cursor: pointer;">
          ...
          <div class="content">
            ...
            <div class="details ${this.config.showClock&&this.config.clockPosition==="details"?"details--clock":""}">
              <weather-details
                ...
                .entityAttributes=${Qi(this.hass,this.config.entity)}
              ></weather-details>
              <weather-clock
    ...
    `}}w([m({type:Object})],Vi.prototype,"hass",void 0),w([m({type:Object})],Vi.prototype,"config",void 0);var an=(i)=>{let o=`editor.language_${i}`,a=d.t(o);if(a!==o)return a;try{return new Intl.DisplayNames([d.lang],{type:"language"}).of(i)??i}catch{return i}};class Ui extends v{constructor(){super(...arguments);this._config={}}setConfig(i){this._config={name:"",height:u.height,show_feels_like:u.showFeelsLike,show_wind:u.showWind,show_wind_gust:u.showWindGust,show_wind_direction:u.showWindDirection,show_humidity:u.showHumidity,show_min_temp:u.showMinTemp,show_hourly_forecast:u.showHourlyForecast,hourly_forecast_hours:u.hourlyForecastHours,show_daily_forecast:u.showDailyForecast,daily_forecast_days:u.dailyForecastDays,show_sunrise_sunset:u.showSunriseSunset,show_clock:u.showClock,clock_position:u.clockPosition,clock_format:u.clockFormat,overlay_opacity:u.overlayOpacity,language:u.language,wind_speed_unit:u.windSpeedUnit,sunrise_entity:"",sunset_entity:"",...i}}updated(i){if(super.updated(i),i.has("hass")){let o=I({hassLang:this.hass?.language});if(d.lang!==o)d.setLanguage(o),this.requestUpdate()}}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:["weather"]}}},{name:"name",selector:{text:{}}},{name:"height",selector:{number:{min:200,max:800,step:10,mode:"box"}}},{name:"show_feels_like",selector:{boolean:{}}},{name:"show_wind",selector:{boolean:{}}},{name:"show_wind_gust",selector:{boolean:{}}},{name:"show_wind_direction",selector:{boolean:{}}},{name:"show_humidity",selector:{boolean:{}}},{name:"show_min_temp",selector:{boolean:{}}},{name:"show_hourly_forecast",selector:{boolean:{}}},{name:"hourly_forecast_hours",selector:{number:{min:1,max:24,step:1,mode:"box"}}},{name:"show_daily_forecast",selector:{boolean:{}}},{name:"daily_forecast_days",selector:{number:{min:1,max:14,step:1,mode:"box"}}},{name:"show_sunrise_sunset",selector:{boolean:{}}},{name:"sunrise_entity",selector:{entity:{domain:["sensor"]}}},{name:"sunset_entity",selector:{entity:{domain:["sensor"]}}},{name:"show_clock",selector:{boolean:{}}},{name:"clock_position",selector:{select:{options:[{label:d.t("editor.clock_position_top"),value:"top"},{label:d.t("editor.clock_position_details"),value:"details"}]}}},{name:"clock_format",selector:{select:{options:[{label:d.t("editor.clock_format_24h"),value:"24h"},{label:d.t("editor.clock_format_12h"),value:"12h"}]}}},{name:"overlay_opacity",selector:{number:{min:0,max:1,step:0.05,mode:"box"}}},{name:"language",selector:{select:{options:[{label:d.t("editor.language_auto"),value:"auto"},...Object.keys(D).map((i)=>({label:an(i),value:i}))]}}},{name:"wind_speed_unit",selector:{select:{options:[{label:d.t("editor.wind_speed_unit_ms"),value:"ms"},{label:d.t("editor.wind_speed_unit_kmh"),value:"kmh"}]}}}]}_computeLabel=(i)=>{let o=`editor.${i.name}`,a=d.t(o);return a===o?i.name:a};_valueChanged(i){let o=i.detail?.value;if(!o)return;this._config=o,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}render(){if(!this.hass)return h``;return h`
      ...
      ></ha-form>
    `}}w([m({attribute:!1})],Ui.prototype,"hass",void 0),w([di()],Ui.prototype,"_config",void 0);var Yo={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Oo=(i)=>(...o)=>({["_$litDirective$"]:i,values:o});class Ri{constructor(i){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(i,o,a){this.__part=i,this._$parent=o,this.__attributeIndex=a}_$resolve(i,o){return this.update(i,o)}update(i,o){return this.render(...o)}}var nn=!0,Nl=nn&&window.ShadyDOM?.inUse&&window.ShadyDOM?.noPatch===!0?window.ShadyDOM.wrap:(i)=>i;var Io=(i)=>i.strings===void 0;var en=!0,oi=(i,o)=>{let a=i._$disconnectableChildren;if(a===void 0)return!1;for(let n of a)n._$notifyDirectiveConnectionChanged?.(o,!1),oi(n,o);return!0},hi=(i)=>{let o,a;do{if((o=i._$parent)===void 0)break;a=o._$disconnectableChildren,a.delete(i),i=o}while(a?.size===0)},Eo=(i)=>{for(let o;o=i._$parent;i=o){let a=o._$disconnectableChildren;if(a===void 0)o._$disconnectableChildren=a=new Set;else if(a.has(i))break;a.add(i),sn(o)}};function rn(i){if(this._$disconnectableChildren!==void 0)hi(this),this._$parent=i,Eo(this);else this._$parent=i}function ln(i,o=!1,a=0){let n=this._$committedValue,e=this._$disconnectableChildren;if(e===void 0||e.size===0)return;if(o){if(Array.isArray(n))for(let r=a;r<n.length;r++)oi(n[r],!1),hi(n[r]);else if(n!=null)oi(n,!1),hi(n)}else oi(this,i)}var sn=(i)=>{if(i.type==Yo.CHILD)i._$notifyConnectionChanged??=ln,i._$reparentDisconnectables??=rn};class Li extends Ri{constructor(){super(...arguments);this._$disconnectableChildren=void 0}_$initialize(i,o,a){super._$initialize(i,o,a),Eo(this),this.isConnected=i._$isConnected}["_$notifyDirectiveConnectionChanged"](i,o=!0){if(i!==this.isConnected)if(this.isConnected=i,i)this.reconnected?.();else this.disconnected?.();if(o)oi(this,i),hi(this)}setValue(i){if(Io(this.__part))this.__part._$setValue(i,this);else{if(en&&this.__attributeIndex===void 0)throw Error("Expected this.__attributeIndex to be a number");let o=[...this.__part._$committedValue];o[this.__attributeIndex]=i,this.__part._$setValue(o,this,0)}}disconnected(){}reconnected(){}}class ia extends Li{_key="";_onLangChange=null;render(i){return this._key=i,d.t(i)}reconnected(){this._onLangChange=()=>{this.setValue(d.t(this._key))},window.addEventListener("language-changed",this._onLangChange)}disconnected(){if(this._onLangChange)window.removeEventListener("language-changed",this._onLangChange)}}var tn=Oo(ia);try{customElements.define("dynamic-weather-card",Vi),customElements.define("dynamic-weather-card-editor",Ui),console.log(`%cDynamic Weather Card %c${vo}`,"color: #007AFF; font-weight: bold; font-size: 14px;","color: #666; font-size: 12px;",`
Динамическая карточка погоды`),window.customCards=window.customCards||[];let i={type:"dynamic-weather-card",name:"Dynamic Weather Card",description:"Динамическая карточка погоды",preview:!0,documentationURL:"https://github.com/teuchezh/dynamic-weather-card"};window.customCards.push(i)}catch(i){console.error("❌ Ошибка при регистрации Dynamic Weather Card:",i)}export{tn as t,I as resolveLanguage,d as i18n};
