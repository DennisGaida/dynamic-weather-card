var t=function(o,i,a,n){var l=arguments.length,s=l<3?i:n===null?n=Object.getOwnPropertyDescriptor(i,a):n,r;if(typeof Reflect==="object"&&typeof Reflect.decorate==="function")s=Reflect.decorate(o,i,a,n);else for(var c=o.length-1;c>=0;c--)if(r=o[c])s=(l<3?r(s):l>3?r(i,a,s):r(i,a))||s;return l>3&&s&&Object.defineProperty(i,a,s),s};var ao=globalThis,wo=ao.ShadowRoot&&(ao.ShadyCSS===void 0||ao.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,to=Symbol(),Io=new WeakMap;class mo{constructor(o,i,a){if(this._$cssResult$=!0,a!==to)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=o,this._strings=i}get styleSheet(){let o=this._styleSheet,i=this._strings;if(wo&&o===void 0){let a=i!==void 0&&i.length===1;if(a)o=Io.get(i);if(o===void 0){if((this._styleSheet=o=new CSSStyleSheet).replaceSync(this.cssText),a)Io.set(i,o)}}return o}toString(){return this.cssText}}var Oi=(o)=>{if(o._$cssResult$===!0)return o.cssText;else if(typeof o==="number")return o;else throw Error(`Value passed to 'css' function must be a 'css' function result: ${o}. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)},Ei=(o)=>new mo(typeof o==="string"?o:String(o),void 0,to),W=(o,...i)=>{let a=o.length===1?o[0]:i.reduce((n,l,s)=>n+Oi(l)+o[s+1],o[0]);return new mo(a,o,to)},Oo=(o,i)=>{if(wo)o.adoptedStyleSheets=i.map((a)=>a instanceof CSSStyleSheet?a:a.styleSheet);else for(let a of i){let n=document.createElement("style"),l=ao.litNonce;if(l!==void 0)n.setAttribute("nonce",l);n.textContent=a.cssText,o.appendChild(n)}},oa=(o)=>{let i="";for(let a of o.cssRules)i+=a.cssText;return Ei(i)},po=wo?(o)=>o:(o)=>o instanceof CSSStyleSheet?oa(o):o;var{is:ia,defineProperty:aa,getOwnPropertyDescriptor:Eo,getOwnPropertyNames:na,getOwnPropertySymbols:la,getPrototypeOf:oi}=Object,sa=!1,z=globalThis;if(sa)z.customElements??=customElements;var H=!0,Z,ii=z.trustedTypes,ra=ii?ii.emptyScript:"",ni=H?z.reactiveElementPolyfillSupportDevMode:z.reactiveElementPolyfillSupport;if(H)z.litIssuedWarnings??=new Set,Z=(o,i)=>{if(i+=` See https://lit.dev/msg/${o} for more information.`,!z.litIssuedWarnings.has(i)&&!z.litIssuedWarnings.has(o))console.warn(i),z.litIssuedWarnings.add(i)},queueMicrotask(()=>{if(Z("dev-mode","Lit is in dev mode. Not recommended for production!"),z.ShadyDOM?.inUse&&ni===void 0)Z("polyfill-support-missing","Shadow DOM is being polyfilled via `ShadyDOM` but the `polyfill-support` module has not been loaded.")});var ca=H?(o)=>{if(!z.emitLitDebugLogEvents)return;z.dispatchEvent(new CustomEvent("lit-debug",{detail:o}))}:void 0,j=(o,i)=>o,D={toAttribute(o,i){switch(i){case Boolean:o=o?ra:null;break;case Object:case Array:o=o==null?o:JSON.stringify(o);break}return o},fromAttribute(o,i){let a=o;switch(i){case Boolean:a=o!==null;break;case Number:a=o===null?null:Number(o);break;case Object:case Array:try{a=JSON.parse(o)}catch(n){a=null}break}return a}},no=(o,i)=>!ia(o,i),ai={attribute:!0,type:String,converter:D,reflect:!1,useDefault:!1,hasChanged:no};Symbol.metadata??=Symbol("metadata");z.litPropertyMetadata??=new WeakMap;class A extends HTMLElement{static addInitializer(o){this.__prepare(),(this._initializers??=[]).push(o)}static get observedAttributes(){return this.finalize(),this.__attributeToPropertyMap&&[...this.__attributeToPropertyMap.keys()]}static createProperty(o,i=ai){if(i.state)i.attribute=!1;if(this.__prepare(),this.prototype.hasOwnProperty(o))i=Object.create(i),i.wrapped=!0;if(this.elementProperties.set(o,i),!i.noAccessor){let a=H?Symbol.for(`${String(o)} (@property() cache)`):Symbol(),n=this.getPropertyDescriptor(o,a,i);if(n!==void 0)aa(this.prototype,o,n)}}static getPropertyDescriptor(o,i,a){let{get:n,set:l}=Eo(this.prototype,o)??{get(){return this[i]},set(s){this[i]=s}};if(H&&n==null){if("value"in(Eo(this.prototype,o)??{}))throw Error(`Field ${JSON.stringify(String(o))} on ${this.name} was declared as a reactive property but it's actually declared as a value on the prototype. Usually this is due to using @property or @state on a method.`);Z("reactive-property-without-getter",`Field ${JSON.stringify(String(o))} on ${this.name} was declared as a reactive property but it does not have a getter. This will be an error in a future version of Lit.`)}return{get:n,set(s){let r=n?.call(this);l?.call(this,s),this.requestUpdate(o,r,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(o){return this.elementProperties.get(o)??ai}static __prepare(){if(this.hasOwnProperty(j("elementProperties",this)))return;let o=oi(this);if(o.finalize(),o._initializers!==void 0)this._initializers=[...o._initializers];this.elementProperties=new Map(o.elementProperties)}static finalize(){if(this.hasOwnProperty(j("finalized",this)))return;if(this.finalized=!0,this.__prepare(),this.hasOwnProperty(j("properties",this))){let i=this.properties,a=[...na(i),...la(i)];for(let n of a)this.createProperty(n,i[n])}let o=this[Symbol.metadata];if(o!==null){let i=litPropertyMetadata.get(o);if(i!==void 0)for(let[a,n]of i)this.elementProperties.set(a,n)}this.__attributeToPropertyMap=new Map;for(let[i,a]of this.elementProperties){let n=this.__attributeNameForProperty(i,a);if(n!==void 0)this.__attributeToPropertyMap.set(n,i)}if(this.elementStyles=this.finalizeStyles(this.styles),H){if(this.hasOwnProperty("createProperty"))Z("no-override-create-property","Overriding ReactiveElement.createProperty() is deprecated. The override will not be called with standard decorators");if(this.hasOwnProperty("getPropertyDescriptor"))Z("no-override-get-property-descriptor","Overriding ReactiveElement.getPropertyDescriptor() is deprecated. The override will not be called with standard decorators")}}static finalizeStyles(o){let i=[];if(Array.isArray(o)){let a=new Set(o.flat(1/0).reverse());for(let n of a)i.unshift(po(n))}else if(o!==void 0)i.push(po(o));return i}static __attributeNameForProperty(o,i){let a=i.attribute;return a===!1?void 0:typeof a==="string"?a:typeof o==="string"?o.toLowerCase():void 0}constructor(){super();this.__instanceProperties=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this.__reflectingProperty=null,this.__initialize()}__initialize(){this.__updatePromise=new Promise((o)=>this.enableUpdating=o),this._$changedProperties=new Map,this.__saveInstanceProperties(),this.requestUpdate(),this.constructor._initializers?.forEach((o)=>o(this))}addController(o){if((this.__controllers??=new Set).add(o),this.renderRoot!==void 0&&this.isConnected)o.hostConnected?.()}removeController(o){this.__controllers?.delete(o)}__saveInstanceProperties(){let o=new Map,i=this.constructor.elementProperties;for(let a of i.keys())if(this.hasOwnProperty(a))o.set(a,this[a]),delete this[a];if(o.size>0)this.__instanceProperties=o}createRenderRoot(){let o=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Oo(o,this.constructor.elementStyles),o}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this.__controllers?.forEach((o)=>o.hostConnected?.())}enableUpdating(o){}disconnectedCallback(){this.__controllers?.forEach((o)=>o.hostDisconnected?.())}attributeChangedCallback(o,i,a){this._$attributeToProperty(o,a)}__propertyToAttribute(o,i){let n=this.constructor.elementProperties.get(o),l=this.constructor.__attributeNameForProperty(o,n);if(l!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:D).toAttribute(i,n.type);if(H&&this.constructor.enabledWarnings.includes("migration")&&r===void 0)Z("undefined-attribute-value",`The attribute value for the ${o} property is undefined on element ${this.localName}. The attribute will be removed, but in the previous version of \`ReactiveElement\`, the attribute would not have changed.`);if(this.__reflectingProperty=o,r==null)this.removeAttribute(l);else this.setAttribute(l,r);this.__reflectingProperty=null}}_$attributeToProperty(o,i){let a=this.constructor,n=a.__attributeToPropertyMap.get(o);if(n!==void 0&&this.__reflectingProperty!==n){let l=a.getPropertyOptions(n),s=typeof l.converter==="function"?{fromAttribute:l.converter}:l.converter?.fromAttribute!==void 0?l.converter:D;this.__reflectingProperty=n;let r=s.fromAttribute(i,l.type);this[n]=r??this.__defaultValues?.get(n)??r,this.__reflectingProperty=null}}requestUpdate(o,i,a,n=!1,l){if(o!==void 0){if(H&&o instanceof Event)Z("","The requestUpdate() method was called with an Event as the property name. This is probably a mistake caused by binding this.requestUpdate as an event listener. Instead bind a function that will call it with no arguments: () => this.requestUpdate()");let s=this.constructor;if(n===!1)l=this[o];if(a??=s.getPropertyOptions(o),(a.hasChanged??no)(l,i)||a.useDefault&&a.reflect&&l===this.__defaultValues?.get(o)&&!this.hasAttribute(s.__attributeNameForProperty(o,a)))this._$changeProperty(o,i,a);else return}if(this.isUpdatePending===!1)this.__updatePromise=this.__enqueueUpdate()}_$changeProperty(o,i,{useDefault:a,reflect:n,wrapped:l},s){if(a&&!(this.__defaultValues??=new Map).has(o)){if(this.__defaultValues.set(o,s??i??this[o]),l!==!0||s!==void 0)return}if(!this._$changedProperties.has(o)){if(!this.hasUpdated&&!a)i=void 0;this._$changedProperties.set(o,i)}if(n===!0&&this.__reflectingProperty!==o)(this.__reflectingProperties??=new Set).add(o)}async __enqueueUpdate(){this.isUpdatePending=!0;try{await this.__updatePromise}catch(i){Promise.reject(i)}let o=this.scheduleUpdate();if(o!=null)await o;return!this.isUpdatePending}scheduleUpdate(){let o=this.performUpdate();if(H&&this.constructor.enabledWarnings.includes("async-perform-update")&&typeof o?.then==="function")Z("async-perform-update",`Element ${this.localName} returned a Promise from performUpdate(). This behavior is deprecated and will be removed in a future version of ReactiveElement.`);return o}performUpdate(){if(!this.isUpdatePending)return;if(ca?.({kind:"update"}),!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),H){let l=[...this.constructor.elementProperties.keys()].filter((s)=>this.hasOwnProperty(s)&&(s in oi(this)));if(l.length)throw Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${l.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`)}if(this.__instanceProperties){for(let[n,l]of this.__instanceProperties)this[n]=l;this.__instanceProperties=void 0}let a=this.constructor.elementProperties;if(a.size>0)for(let[n,l]of a){let{wrapped:s}=l,r=this[n];if(s===!0&&!this._$changedProperties.has(n)&&r!==void 0)this._$changeProperty(n,void 0,l,r)}}let o=!1,i=this._$changedProperties;try{if(o=this.shouldUpdate(i),o)this.willUpdate(i),this.__controllers?.forEach((a)=>a.hostUpdate?.()),this.update(i);else this.__markUpdated()}catch(a){throw o=!1,this.__markUpdated(),a}if(o)this._$didUpdate(i)}willUpdate(o){}_$didUpdate(o){if(this.__controllers?.forEach((i)=>i.hostUpdated?.()),!this.hasUpdated)this.hasUpdated=!0,this.firstUpdated(o);if(this.updated(o),H&&this.isUpdatePending&&this.constructor.enabledWarnings.includes("change-in-update"))Z("change-in-update",`Element ${this.localName} scheduled an update (generally because a property was set) after an update completed, causing a new update to be scheduled. This is inefficient and should be avoided unless the next update can only be scheduled as a side effect of the previous update.`)}__markUpdated(){this._$changedProperties=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.__updatePromise}shouldUpdate(o){return!0}update(o){this.__reflectingProperties&&=this.__reflectingProperties.forEach((i)=>this.__propertyToAttribute(i,this[i])),this.__markUpdated()}updated(o){}firstUpdated(o){}}A.elementStyles=[];A.shadowRootOptions={mode:"open"};A[j("elementProperties",A)]=new Map;A[j("finalized",A)]=new Map;ni?.({ReactiveElement:A});if(H){A.enabledWarnings=["change-in-update","async-perform-update"];let o=function(i){if(!i.hasOwnProperty(j("enabledWarnings",i)))i.enabledWarnings=i.enabledWarnings.slice()};A.enableWarning=function(i){if(o(this),!this.enabledWarnings.includes(i))this.enabledWarnings.push(i)},A.disableWarning=function(i){o(this);let a=this.enabledWarnings.indexOf(i);if(a>=0)this.enabledWarnings.splice(a,1)}}(z.reactiveElementVersions??=[]).push("2.1.2");if(H&&z.reactiveElementVersions.length>1)queueMicrotask(()=>{Z("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});var v=globalThis,k=(o)=>{if(!v.emitLitDebugLogEvents)return;v.dispatchEvent(new CustomEvent("lit-debug",{detail:o}))},_a=0,U;v.litIssuedWarnings??=new Set,U=(o,i)=>{if(i+=o?` See https://lit.dev/msg/${o} for more information.`:"",!v.litIssuedWarnings.has(i)&&!v.litIssuedWarnings.has(o))console.warn(i),v.litIssuedWarnings.add(i)},queueMicrotask(()=>{U("dev-mode","Lit is in dev mode. Not recommended for production!")});var N=v.ShadyDOM?.inUse&&v.ShadyDOM?.noPatch===!0?v.ShadyDOM.wrap:(o)=>o,lo=v.trustedTypes,li=lo?lo.createPolicy("lit-html",{createHTML:(o)=>o}):void 0,da=(o)=>o,_o=(o,i,a)=>da,ha=(o)=>{if(G!==_o)throw Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");G=o},ga=()=>{G=_o},Ho=(o,i,a)=>{return G(o,i,a)},gi="$lit$",q=`lit$${Math.random().toFixed(9).slice(2)}$`,ei="?"+q,ea=`<${ei}>`,C=document,R=()=>C.createComment(""),X=(o)=>o===null||typeof o!="object"&&typeof o!="function",Ao=Array.isArray,ka=(o)=>Ao(o)||typeof o?.[Symbol.iterator]==="function",Fo=`[ 	
\f\r]`,ua=`[^ 	
\f\r"'\`<>=]`,ya=`[^\\s"'>=/]`,T=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,si=1,bo=2,fa=3,ri=/-->/g,ci=/>/g,B=new RegExp(`>|${Fo}(?:(${ya}+)(${Fo}*=${Fo}*(?:${ua}|("|')|))|$)`,"g"),wa=0,_i=1,ta=2,di=3,Mo=/'/g,zo=/"/g,ki=/^(?:script|style|textarea|title)$/i,ma=1,so=2,ro=3,vo=1,co=2,pa=3,Fa=4,ba=5,Ko=6,Ma=7,Zo=(o)=>(i,...a)=>{if(i.some((n)=>n===void 0))console.warn(`Some template strings are undefined.
...
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:o,strings:i,values:a}},u=Zo(ma),y=Zo(so),ln=Zo(ro),P=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),hi=new WeakMap,Q=C.createTreeWalker(C,129),G=_o;function ui(o,i){if(!Ao(o)||!o.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
...
`,Va={sunny:y`
  ...
  `};function oo(o,...i){let a=Ta[o];if(typeof a==="function")return a(...i);return a||""}function ko(o){if(!o)return"";return Va[o.toLowerCase()]||""}class Ti extends F{constructor(){super(...arguments);this.weather=null;this.sunData=null;this.config=null;this.entityAttributes=null}static styles=W`
    :host {
      display: block;
    }
  ...
  `;hasContent(){if(!this.weather||!this.config)return!1;return this.config.showHumidity&&this.weather.humidity!=null||this.config.showWind&&this.weather.windSpeed!=null||this.config.showSunriseSunset&&this.sunData?.hasSunData===!0}renderHumidity(){if(!this.config?.showHumidity||this.weather?.humidity==null)return u``;return u`
      <div class="info-item">
        <span class="info-icon">${oo("humidity")}</span>
    ...
    `}renderSunrise(){if(!this.config?.showSunriseSunset||!this.sunData?.hasSunData||!this.sunData.sunrise)return u``;return u`
      <div class="info-item">
        <span class="info-icon">${oo("sunrise")}</span>
        <span>${qo(this.sunData.sunrise,this.config.clockFormat,d.t("am"),d.t("pm"))}</span>
      </div>
    `}renderWind(){if(!this.config?.showWind||this.weather?.windSpeed==null)return u``;let o=this.entityAttributes||{},i=Bo(this.weather.windSpeed,o,this.config.windSpeedUnit),a=Pi(o,this.config.windSpeedUnit,d.t.bind(d)),n="";if(this.config.showWindGust&&this.weather.windGust)n=` / ${Bo(this.weather.windGust,o,this.config.windSpeedUnit)} ${a}`;let l=this.config.showWindDirection&&this.weather.windBearing!=null?Di(this.weather.windBearing):oo("wind");return u`
      <div class="info-item">
    ...
    `}renderSunset(){if(!this.config?.showSunriseSunset||!this.sunData?.hasSunData||!this.sunData.sunset)return u``;return u`
      <div class="info-item">
        <span class="info-icon">${oo("sunset")}</span>
        <span>${qo(this.sunData.sunset,this.config.clockFormat,d.t("am"),d.t("pm"))}</span>
      </div>
    ...
    `}}t([m({type:Object})],Ti.prototype,"weather",void 0),t([m({type:Object})],Ti.prototype,"sunData",void 0),t([m({type:Object})],Ti.prototype,"config",void 0),t([m({type:Object})],Ti.prototype,"entityAttributes",void 0);customElements.define("weather-details",Ti);var uo=W`
  :host {
    display: block;
  }
...
`;class Vi extends F{constructor(){super(...arguments);this.forecast=[];this.clockFormat="24h"}static styles=uo;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=eo(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(o){return Math.round(o.temperature??o.temp??o.native_temperature??0)}render(){if(this.forecast.length===0)return u``;return u`
        ...
        <div class="forecast-scroll">
          ${this.forecast.map((o)=>u`
            <div class="forecast-item">
              <div class="forecast-time">${Qi(o.datetime,this.clockFormat,d.t("am"),d.t("pm"))}</div>
    ...
    `}}t([m({type:Array})],Vi.prototype,"forecast",void 0),t([m({type:String})],Vi.prototype,"clockFormat",void 0);customElements.define("hourly-forecast",Vi);class Ui extends F{constructor(){super(...arguments);this.forecast=[];this.lang="en"}static styles=uo;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=eo(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(o){return Math.round(o.temperature??o.temp??o.native_temperature??0)}render(){if(this.forecast.length===0)return u``;return u`
      <div class="forecast-container">
        <div class="forecast-title">${d.t("daily_forecast_title")}</div>
        <div class="forecast-scroll">
          ${this.forecast.map((o)=>u`
            <div class="forecast-item">
              <div class="forecast-time">${Ci(o.datetime,this.lang)}</div>
              <div class="forecast-icon">${ko(o.condition||"sunny")}</div>
              <div class="forecast-temp">${this.getTemperature(o)}°</div>
            </div>
          `)}
          ...
          <div class="content">
            ...
            <div class="details ${this.config.showClock&&this.config.clockPosition==="details"?"details--clock":""}">
              <weather-details
                ...
                .entityAttributes=${Vo(this.hass,this.config.entity)}
              ></weather-details>
              <weather-clock
    ...
    `}}t([m({type:Object})],Ro.prototype,"hass",void 0),t([m({type:Object})],Ro.prototype,"config",void 0);class Xo extends F{constructor(){super(...arguments);this._config={}}setConfig(o){this._config={name:"",height:e.height,show_feels_like:e.showFeelsLike,show_wind:e.showWind,show_wind_gust:e.showWindGust,show_wind_direction:e.showWindDirection,show_humidity:e.showHumidity,show_min_temp:e.showMinTemp,show_hourly_forecast:e.showHourlyForecast,hourly_forecast_hours:e.hourlyForecastHours,show_daily_forecast:e.showDailyForecast,daily_forecast_days:e.dailyForecastDays,show_sunrise_sunset:e.showSunriseSunset,show_clock:e.showClock,clock_position:e.clockPosition,clock_format:e.clockFormat,overlay_opacity:e.overlayOpacity,language:e.language,wind_speed_unit:e.windSpeedUnit,sunrise_entity:"",sunset_entity:"",...o}}updated(o){if(super.updated(o),o.has("hass")){let i=O({hassLang:this.hass?.language});if(d.lang!==i)d.setLanguage(i),this.requestUpdate()}}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:["weather"]}}},{name:"name",selector:{text:{}}},{name:"height",selector:{number:{min:200,max:800,step:10,mode:"box"}}},{name:"show_feels_like",selector:{boolean:{}}},{name:"show_wind",selector:{boolean:{}}},{name:"show_wind_gust",selector:{boolean:{}}},{name:"show_wind_direction",selector:{boolean:{}}},{name:"show_humidity",selector:{boolean:{}}},{name:"show_min_temp",selector:{boolean:{}}},{name:"show_hourly_forecast",selector:{boolean:{}}},{name:"hourly_forecast_hours",selector:{number:{min:1,max:24,step:1,mode:"box"}}},{name:"show_daily_forecast",selector:{boolean:{}}},{name:"daily_forecast_days",selector:{number:{min:1,max:14,step:1,mode:"box"}}},{name:"show_sunrise_sunset",selector:{boolean:{}}},{name:"sunrise_entity",selector:{entity:{domain:["sensor"]}}},{name:"sunset_entity",selector:{entity:{domain:["sensor"]}}},{name:"show_clock",selector:{boolean:{}}},{name:"clock_position",selector:{select:{options:[{label:d.t("editor.clock_position_top"),value:"top"},{label:d.t("editor.clock_position_details"),value:"details"}]}}},{name:"clock_format",selector:{select:{options:[{label:d.t("editor.clock_format_24h"),value:"24h"},{label:d.t("editor.clock_format_12h"),value:"12h"}]}}},{name:"overlay_opacity",selector:{number:{min:0,max:1,step:0.05,mode:"box"}}},{name:"language",selector:{select:{options:[{label:d.t("editor.language_auto"),value:"auto"},{label:d.t("editor.language_en"),value:"en"},{label:d.t("editor.language_ru"),value:"ru"},{label:d.t("editor.language_de"),value:"de"},{label:d.t("editor.language_nl"),value:"nl"},{label:d.t("editor.language_fr"),value:"fr"},{label:d.t("editor.language_es"),value:"es"},{label:d.t("editor.language_it"),value:"it"},{label:d.t("editor.language_sk"),value:"sk"},{label:d.t("editor.language_hu"),value:"hu"}]}}},{name:"wind_speed_unit",selector:{select:{options:[{label:d.t("editor.wind_speed_unit_ms"),value:"ms"},{label:d.t("editor.wind_speed_unit_kmh"),value:"kmh"}]}}}]}_computeLabel=(o)=>{let i=`editor.${o.name}`,a=d.t(i);return a===i?o.name:a};_valueChanged(o){let i=o.detail?.value;if(!i)return;this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}render(){if(!this.hass)return u``;return u`
      ...
      ></ha-form>
    `}}t([m({attribute:!1})],Xo.prototype,"hass",void 0),t([ho()],Xo.prototype,"_config",void 0);var Ri={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Xi=(o)=>(...i)=>({["_$litDirective$"]:o,values:i});class Yo{constructor(o){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(o,i,a){this.__part=o,this._$parent=i,this.__attributeIndex=a}_$resolve(o,i){return this.update(o,i)}update(o,i){return this.render(...i)}}var Ua=!0,cr=Ua&&window.ShadyDOM?.inUse&&window.ShadyDOM?.noPatch===!0?window.ShadyDOM.wrap:(o)=>o;var Yi=(o)=>o.strings===void 0;var Ra=!0,io=(o,i)=>{let a=o._$disconnectableChildren;if(a===void 0)return!1;for(let n of a)n._$notifyDirectiveConnectionChanged?.(i,!1),io(n,i);return!0},yo=(o)=>{let i,a;do{if((i=o._$parent)===void 0)break;a=i._$disconnectableChildren,a.delete(o),o=i}while(a?.size===0)},Li=(o)=>{for(let i;i=o._$parent;o=i){let a=i._$disconnectableChildren;if(a===void 0)i._$disconnectableChildren=a=new Set;else if(a.has(o))break;a.add(o),La(i)}};function Xa(o){if(this._$disconnectableChildren!==void 0)yo(this),this._$parent=o,Li(this);else this._$parent=o}function Ya(o,i=!1,a=0){let n=this._$committedValue,l=this._$disconnectableChildren;if(l===void 0||l.size===0)return;if(i){if(Array.isArray(n))for(let s=a;s<n.length;s++)io(n[s],!1),yo(n[s]);else if(n!=null)io(n,!1),yo(n)}else io(this,o)}var La=(o)=>{if(o.type==Ri.CHILD)o._$notifyConnectionChanged??=Ya,o._$reparentDisconnectables??=Xa};class Lo extends Yo{constructor(){super(...arguments);this._$disconnectableChildren=void 0}_$initialize(o,i,a){super._$initialize(o,i,a),Li(this),this.isConnected=o._$isConnected}["_$notifyDirectiveConnectionChanged"](o,i=!0){if(o!==this.isConnected)if(this.isConnected=o,o)this.reconnected?.();else this.disconnected?.();if(i)io(this,o),yo(this)}setValue(o){if(Yi(this.__part))this.__part._$setValue(o,this);else{if(Ra&&this.__attributeIndex===void 0)throw Error("Expected this.__attributeIndex to be a number");let i=[...this.__part._$committedValue];i[this.__attributeIndex]=o,this.__part._$setValue(i,this,0)}}disconnected(){}reconnected(){}}class Ii extends Lo{_key="";_onLangChange=null;render(o){return this._key=o,d.t(o)}reconnected(){this._onLangChange=()=>{this.setValue(d.t(this._key))},window.addEventListener("language-changed",this._onLangChange)}disconnected(){if(this._onLangChange)window.removeEventListener("language-changed",this._onLangChange)}}var Ia=Xi(Ii);try{customElements.define("dynamic-weather-card",Ro),customElements.define("dynamic-weather-card-editor",Xo),console.log(`%cDynamic Weather Card %c${Mi}`,"color: #007AFF; font-weight: bold; font-size: 14px;","color: #666; font-size: 12px;",`
Динамическая карточка погоды`),window.customCards=window.customCards||[];let o={type:"dynamic-weather-card",name:"Dynamic Weather Card",description:"Динамическая карточка погоды",preview:!0,documentationURL:"https://github.com/teuchezh/dynamic-weather-card"};window.customCards.push(o)}catch(o){console.error("❌ Ошибка при регистрации Dynamic Weather Card:",o)}export{Ia as t,O as resolveLanguage,d as i18n};
