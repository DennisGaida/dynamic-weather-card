...
`,Va={sunny:y`
  ...
  `;hasContent(){if(!this.weather||!this.config)return!1;return this.config.showHumidity&&this.weather.humidity!=null||this.config.showWind&&this.weather.windSpeed!=null||this.config.showSunriseSunset&&this.sunData?.hasSunData===!0}renderHumidity(){if(!this.config?.showHumidity||this.weather?.humidity==null)return u``;return u`
    ...
    `}renderWind(){if(!this.config?.showWind||this.weather?.windSpeed==null)return u``;let i=this.entityAttributes||{},o=Bi(this.weather.windSpeed,i,this.config.windSpeedUnit),a=Po(i,this.config.windSpeedUnit,d.t.bind(d)),n="";if(this.config.showWindGust&&this.weather.windGust)n=` / ${Bi(this.weather.windGust,i,this.config.windSpeedUnit)} ${a}`;let l=this.config.showWindDirection&&this.weather.windBearing!=null?Do(this.weather.windBearing):ii("wind");return u`
      <div class="info-item">
...
`;class Vo extends b{constructor(){super(...arguments);this.forecast=[];this.clockFormat="24h"}static styles=yi;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=ui(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(i){return Math.round(i.temperature??i.temp??i.native_temperature??0)}render(){if(this.forecast.length===0)return u``;return u`
    ...
    `}renderDefault(i,o,a,n,l,s,r){return u`
      <div class="${s}" style="${r}">
    ...
    `}renderMinimal(i,o,a,n,l){let s=i.temperature!=null?Math.round(i.temperature)+"°":d.t("no_data"),r=i.templow!=null?`↓ ${Math.round(i.templow)}°`:null;return u`
