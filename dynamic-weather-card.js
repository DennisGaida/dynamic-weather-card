...
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:o,strings:i,values:a}},u=Zo(ma),y=Zo(lo),ln=Zo(so),C=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),_i=new WeakMap,$=Q.createTreeWalker(Q,129),P=co;function ei(o,i){if(!zo(o)||!o.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
...
`,Va={sunny:y`
  ...
  `};function E(o,...i){let a=Ta[o];if(typeof a==="function")return a(...i);return a||""}function eo(o){if(!o)return"";return Va[o.toLowerCase()]||""}class ji extends F{constructor(){super(...arguments);this.weather=null;this.sunData=null;this.config=null;this.entityAttributes=null}static styles=W`
    :host {
      display: block;
    }
  ...
  `;hasContent(){if(!this.weather||!this.config)return!1;return this.config.showHumidity&&this.weather.humidity!=null||this.config.showWind&&this.weather.windSpeed!=null||this.config.showSunriseSunset&&this.sunData?.hasSunData===!0}renderHumidity(){if(!this.config?.showHumidity||this.weather?.humidity==null)return u``;return u`
    ...
    `}renderWind(){if(!this.config?.showWind||this.weather?.windSpeed==null)return u``;let o=this.entityAttributes||{},i=Jo(this.weather.windSpeed,o,this.config.windSpeedUnit),a=Qi(o,this.config.windSpeedUnit,d.t.bind(d)),n="";if(this.config.showWindGust&&this.weather.windGust)n=` / ${Jo(this.weather.windGust,o,this.config.windSpeedUnit)} ${a}`;let l=this.config.showWindDirection&&this.weather.windBearing!=null?Gi(this.weather.windBearing):E("wind");return u`
      <div class="info-item">
    ...
    `}}w([t({type:Object})],ji.prototype,"weather",void 0),w([t({type:Object})],ji.prototype,"sunData",void 0),w([t({type:Object})],ji.prototype,"config",void 0),w([t({type:Object})],ji.prototype,"entityAttributes",void 0);customElements.define("weather-details",ji);var ko=W`
  :host {
    display: block;
  }
...
`;class Di extends F{constructor(){super(...arguments);this.forecast=[];this.clockFormat="24h"}static styles=ko;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=go(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(o){return Math.round(o.temperature??o.temp??o.native_temperature??0)}render(){if(this.forecast.length===0)return u``;return u`
    ...
    `}}w([t({type:Array})],Di.prototype,"forecast",void 0),w([t({type:String})],Di.prototype,"clockFormat",void 0);customElements.define("hourly-forecast",Di);class Ti extends F{constructor(){super(...arguments);this.forecast=[];this.lang="en"}static styles=ko;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=go(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(o){return Math.round(o.temperature??o.temp??o.native_temperature??0)}render(){if(this.forecast.length===0)return u``;return u`
      <div class="forecast-container">
