var t=function(i,o,a,l){var n=arguments.length,s=n<3?o:l===null?l=Object.getOwnPropertyDescriptor(o,a):l,r;if(typeof Reflect==="object"&&typeof Reflect.decorate==="function")s=Reflect.decorate(i,o,a,l);else for(var c=i.length-1;c>=0;c--)if(r=i[c])s=(n<3?r(s):n>3?r(o,a,s):r(o,a))||s;return n>3&&s&&Object.defineProperty(o,a,s),s};var ai=globalThis,wi=ai.ShadowRoot&&(ai.ShadyCSS===void 0||ai.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,mi=Symbol(),Ei=new WeakMap;class pi{constructor(i,o,a){if(this._$cssResult$=!0,a!==mi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=i,this._strings=o}get styleSheet(){let i=this._styleSheet,o=this._strings;if(wi&&i===void 0){let a=o!==void 0&&o.length===1;if(a)i=Ei.get(o);if(i===void 0){if((this._styleSheet=i=new CSSStyleSheet).replaceSync(this.cssText),a)Ei.set(o,i)}}return i}toString(){return this.cssText}}var aa=(i)=>{if(i._$cssResult$===!0)return i.cssText;else if(typeof i==="number")return i;else throw Error(`Value passed to 'css' function must be a 'css' function result: ${i}. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)},la=(i)=>new pi(typeof i==="string"?i:String(i),void 0,mi),S=(i,...o)=>{let a=i.length===1?i[0]:o.reduce((l,n,s)=>l+aa(n)+i[s+1],i[0]);return new pi(a,i,mi)},io=(i,o)=>{if(wi)i.adoptedStyleSheets=o.map((a)=>a instanceof CSSStyleSheet?a:a.styleSheet);else for(let a of o){let l=document.createElement("style"),n=ai.litNonce;if(n!==void 0)l.setAttribute("nonce",n);l.textContent=a.cssText,i.appendChild(l)}},na=(i)=>{let o="";for(let a of i.cssRules)o+=a.cssText;return la(o)},Mi=wi?(i)=>i:(i)=>i instanceof CSSStyleSheet?na(i):i;var{is:sa,defineProperty:ra,getOwnPropertyDescriptor:oo,getOwnPropertyNames:ca,getOwnPropertySymbols:_a,getPrototypeOf:ao}=Object,da=!1,F=globalThis;if(da)F.customElements??=customElements;var H=!0,Z,lo=F.trustedTypes,ga=lo?lo.emptyScript:"",so=H?F.reactiveElementPolyfillSupportDevMode:F.reactiveElementPolyfillSupport;if(H)F.litIssuedWarnings??=new Set,Z=(i,o)=>{if(o+=` See https://lit.dev/msg/${i} for more information.`,!F.litIssuedWarnings.has(o)&&!F.litIssuedWarnings.has(i))console.warn(o),F.litIssuedWarnings.add(o)},queueMicrotask(()=>{if(Z("dev-mode","Lit is in dev mode. Not recommended for production!"),F.ShadyDOM?.inUse&&so===void 0)Z("polyfill-support-missing","Shadow DOM is being polyfilled via `ShadyDOM` but the `polyfill-support` module has not been loaded.")});var ha=H?(i)=>{if(!F.emitLitDebugLogEvents)return;F.dispatchEvent(new CustomEvent("lit-debug",{detail:i}))}:void 0,C=(i,o)=>i,D={toAttribute(i,o){switch(o){case Boolean:i=i?ga:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i);break}return i},fromAttribute(i,o){let a=i;switch(o){case Boolean:a=i!==null;break;case Number:a=i===null?null:Number(i);break;case Object:case Array:try{a=JSON.parse(i)}catch(l){a=null}break}return a}},li=(i,o)=>!sa(i,o),no={attribute:!0,type:String,converter:D,reflect:!1,useDefault:!1,hasChanged:li};Symbol.metadata??=Symbol("metadata");F.litPropertyMetadata??=new WeakMap;class v extends HTMLElement{static addInitializer(i){this.__prepare(),(this._initializers??=[]).push(i)}static get observedAttributes(){return this.finalize(),this.__attributeToPropertyMap&&[...this.__attributeToPropertyMap.keys()]}static createProperty(i,o=no){if(o.state)o.attribute=!1;if(this.__prepare(),this.prototype.hasOwnProperty(i))o=Object.create(o),o.wrapped=!0;if(this.elementProperties.set(i,o),!o.noAccessor){let a=H?Symbol.for(`${String(i)} (@property() cache)`):Symbol(),l=this.getPropertyDescriptor(i,a,o);if(l!==void 0)ra(this.prototype,i,l)}}static getPropertyDescriptor(i,o,a){let{get:l,set:n}=oo(this.prototype,i)??{get(){return this[o]},set(s){this[o]=s}};if(H&&l==null){if("value"in(oo(this.prototype,i)??{}))throw Error(`Field ${JSON.stringify(String(i))} on ${this.name} was declared as a reactive property but it's actually declared as a value on the prototype. Usually this is due to using @property or @state on a method.`);Z("reactive-property-without-getter",`Field ${JSON.stringify(String(i))} on ${this.name} was declared as a reactive property but it does not have a getter. This will be an error in a future version of Lit.`)}return{get:l,set(s){let r=l?.call(this);n?.call(this,s),this.requestUpdate(i,r,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(i){return this.elementProperties.get(i)??no}static __prepare(){if(this.hasOwnProperty(C("elementProperties",this)))return;let i=ao(this);if(i.finalize(),i._initializers!==void 0)this._initializers=[...i._initializers];this.elementProperties=new Map(i.elementProperties)}static finalize(){if(this.hasOwnProperty(C("finalized",this)))return;if(this.finalized=!0,this.__prepare(),this.hasOwnProperty(C("properties",this))){let o=this.properties,a=[...ca(o),..._a(o)];for(let l of a)this.createProperty(l,o[l])}let i=this[Symbol.metadata];if(i!==null){let o=litPropertyMetadata.get(i);if(o!==void 0)for(let[a,l]of o)this.elementProperties.set(a,l)}this.__attributeToPropertyMap=new Map;for(let[o,a]of this.elementProperties){let l=this.__attributeNameForProperty(o,a);if(l!==void 0)this.__attributeToPropertyMap.set(l,o)}if(this.elementStyles=this.finalizeStyles(this.styles),H){if(this.hasOwnProperty("createProperty"))Z("no-override-create-property","Overriding ReactiveElement.createProperty() is deprecated. The override will not be called with standard decorators");if(this.hasOwnProperty("getPropertyDescriptor"))Z("no-override-get-property-descriptor","Overriding ReactiveElement.getPropertyDescriptor() is deprecated. The override will not be called with standard decorators")}}static finalizeStyles(i){let o=[];if(Array.isArray(i)){let a=new Set(i.flat(1/0).reverse());for(let l of a)o.unshift(Mi(l))}else if(i!==void 0)o.push(Mi(i));return o}static __attributeNameForProperty(i,o){let a=o.attribute;return a===!1?void 0:typeof a==="string"?a:typeof i==="string"?i.toLowerCase():void 0}constructor(){super();this.__instanceProperties=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this.__reflectingProperty=null,this.__initialize()}__initialize(){this.__updatePromise=new Promise((i)=>this.enableUpdating=i),this._$changedProperties=new Map,this.__saveInstanceProperties(),this.requestUpdate(),this.constructor._initializers?.forEach((i)=>i(this))}addController(i){if((this.__controllers??=new Set).add(i),this.renderRoot!==void 0&&this.isConnected)i.hostConnected?.()}removeController(i){this.__controllers?.delete(i)}__saveInstanceProperties(){let i=new Map,o=this.constructor.elementProperties;for(let a of o.keys())if(this.hasOwnProperty(a))i.set(a,this[a]),delete this[a];if(i.size>0)this.__instanceProperties=i}createRenderRoot(){let i=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return io(i,this.constructor.elementStyles),i}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this.__controllers?.forEach((i)=>i.hostConnected?.())}enableUpdating(i){}disconnectedCallback(){this.__controllers?.forEach((i)=>i.hostDisconnected?.())}attributeChangedCallback(i,o,a){this._$attributeToProperty(i,a)}__propertyToAttribute(i,o){let l=this.constructor.elementProperties.get(i),n=this.constructor.__attributeNameForProperty(i,l);if(n!==void 0&&l.reflect===!0){let r=(l.converter?.toAttribute!==void 0?l.converter:D).toAttribute(o,l.type);if(H&&this.constructor.enabledWarnings.includes("migration")&&r===void 0)Z("undefined-attribute-value",`The attribute value for the ${i} property is undefined on element ${this.localName}. The attribute will be removed, but in the previous version of \`ReactiveElement\`, the attribute would not have changed.`);if(this.__reflectingProperty=i,r==null)this.removeAttribute(n);else this.setAttribute(n,r);this.__reflectingProperty=null}}_$attributeToProperty(i,o){let a=this.constructor,l=a.__attributeToPropertyMap.get(i);if(l!==void 0&&this.__reflectingProperty!==l){let n=a.getPropertyOptions(l),s=typeof n.converter==="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:D;this.__reflectingProperty=l;let r=s.fromAttribute(o,n.type);this[l]=r??this.__defaultValues?.get(l)??r,this.__reflectingProperty=null}}requestUpdate(i,o,a,l=!1,n){if(i!==void 0){if(H&&i instanceof Event)Z("","The requestUpdate() method was called with an Event as the property name. This is probably a mistake caused by binding this.requestUpdate as an event listener. Instead bind a function that will call it with no arguments: () => this.requestUpdate()");let s=this.constructor;if(l===!1)n=this[i];if(a??=s.getPropertyOptions(i),(a.hasChanged??li)(n,o)||a.useDefault&&a.reflect&&n===this.__defaultValues?.get(i)&&!this.hasAttribute(s.__attributeNameForProperty(i,a)))this._$changeProperty(i,o,a);else return}if(this.isUpdatePending===!1)this.__updatePromise=this.__enqueueUpdate()}_$changeProperty(i,o,{useDefault:a,reflect:l,wrapped:n},s){if(a&&!(this.__defaultValues??=new Map).has(i)){if(this.__defaultValues.set(i,s??o??this[i]),n!==!0||s!==void 0)return}if(!this._$changedProperties.has(i)){if(!this.hasUpdated&&!a)o=void 0;this._$changedProperties.set(i,o)}if(l===!0&&this.__reflectingProperty!==i)(this.__reflectingProperties??=new Set).add(i)}async __enqueueUpdate(){this.isUpdatePending=!0;try{await this.__updatePromise}catch(o){Promise.reject(o)}let i=this.scheduleUpdate();if(i!=null)await i;return!this.isUpdatePending}scheduleUpdate(){let i=this.performUpdate();if(H&&this.constructor.enabledWarnings.includes("async-perform-update")&&typeof i?.then==="function")Z("async-perform-update",`Element ${this.localName} returned a Promise from performUpdate(). This behavior is deprecated and will be removed in a future version of ReactiveElement.`);return i}performUpdate(){if(!this.isUpdatePending)return;if(ha?.({kind:"update"}),!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),H){let n=[...this.constructor.elementProperties.keys()].filter((s)=>this.hasOwnProperty(s)&&(s in ao(this)));if(n.length)throw Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${n.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`)}if(this.__instanceProperties){for(let[l,n]of this.__instanceProperties)this[l]=n;this.__instanceProperties=void 0}let a=this.constructor.elementProperties;if(a.size>0)for(let[l,n]of a){let{wrapped:s}=n,r=this[l];if(s===!0&&!this._$changedProperties.has(l)&&r!==void 0)this._$changeProperty(l,void 0,n,r)}}let i=!1,o=this._$changedProperties;try{if(i=this.shouldUpdate(o),i)this.willUpdate(o),this.__controllers?.forEach((a)=>a.hostUpdate?.()),this.update(o);else this.__markUpdated()}catch(a){throw i=!1,this.__markUpdated(),a}if(i)this._$didUpdate(o)}willUpdate(i){}_$didUpdate(i){if(this.__controllers?.forEach((o)=>o.hostUpdated?.()),!this.hasUpdated)this.hasUpdated=!0,this.firstUpdated(i);if(this.updated(i),H&&this.isUpdatePending&&this.constructor.enabledWarnings.includes("change-in-update"))Z("change-in-update",`Element ${this.localName} scheduled an update (generally because a property was set) after an update completed, causing a new update to be scheduled. This is inefficient and should be avoided unless the next update can only be scheduled as a side effect of the previous update.`)}__markUpdated(){this._$changedProperties=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.__updatePromise}shouldUpdate(i){return!0}update(i){this.__reflectingProperties&&=this.__reflectingProperties.forEach((o)=>this.__propertyToAttribute(o,this[o])),this.__markUpdated()}updated(i){}firstUpdated(i){}}v.elementStyles=[];v.shadowRootOptions={mode:"open"};v[C("elementProperties",v)]=new Map;v[C("finalized",v)]=new Map;so?.({ReactiveElement:v});if(H){v.enabledWarnings=["change-in-update","async-perform-update"];let i=function(o){if(!o.hasOwnProperty(C("enabledWarnings",o)))o.enabledWarnings=o.enabledWarnings.slice()};v.enableWarning=function(o){if(i(this),!this.enabledWarnings.includes(o))this.enabledWarnings.push(o)},v.disableWarning=function(o){i(this);let a=this.enabledWarnings.indexOf(o);if(a>=0)this.enabledWarnings.splice(a,1)}}(F.reactiveElementVersions??=[]).push("2.1.2");if(H&&F.reactiveElementVersions.length>1)queueMicrotask(()=>{Z("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});var A=globalThis,e=(i)=>{if(!A.emitLitDebugLogEvents)return;A.dispatchEvent(new CustomEvent("lit-debug",{detail:i}))},ua=0,U;A.litIssuedWarnings??=new Set,U=(i,o)=>{if(o+=i?` See https://lit.dev/msg/${i} for more information.`:"",!A.litIssuedWarnings.has(o)&&!A.litIssuedWarnings.has(i))console.warn(o),A.litIssuedWarnings.add(o)},queueMicrotask(()=>{U("dev-mode","Lit is in dev mode. Not recommended for production!")});var N=A.ShadyDOM?.inUse&&A.ShadyDOM?.noPatch===!0?A.ShadyDOM.wrap:(i)=>i,ni=A.trustedTypes,ro=ni?ni.createPolicy("lit-html",{createHTML:(i)=>i}):void 0,ka=(i)=>i,_i=(i,o,a)=>ka,ea=(i)=>{if(P!==_i)throw Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");P=i},ya=()=>{P=_i},vi=(i,o,a)=>{return P(i,o,a)},eo="$lit$",J=`lit$${Math.random().toFixed(9).slice(2)}$`,yo="?"+J,fa=`<${yo}>`,Q=document,R=()=>Q.createComment(""),X=(i)=>i===null||typeof i!="object"&&typeof i!="function",Ai=Array.isArray,ta=(i)=>Ai(i)||typeof i?.[Symbol.iterator]==="function",bi=`[ 	
\f\r]`,wa=`[^ 	
\f\r"'\`<>=]`,ma=`[^\\s"'>=/]`,T=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,co=1,zi=2,pa=3,_o=/-->/g,go=/>/g,B=new RegExp(`>|${bi}(?:(${ma}+)(${bi}*=${bi}*(?:${wa}|("|')|))|$)`,"g"),Ma=0,ho=1,ba=2,uo=3,Fi=/'/g,Hi=/"/g,fo=/^(?:script|style|textarea|title)$/i,za=1,si=2,ri=3,Ki=1,ci=2,Fa=3,Ha=4,va=5,Zi=6,Aa=7,Ni=(i)=>(o,...a)=>{if(o.some((l)=>l===void 0))console.warn(`Some template strings are undefined.
This is probably caused by illegal octal escape sequences.`);if(a.some((l)=>l?._$litStatic$))U("",`Static values 'literal' or 'unsafeStatic' cannot be used as values to non-static templates.
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:i,strings:o,values:a}},k=Ni(za),y=Ni(si),cl=Ni(ri),x=Symbol.for("lit-noChange"),M=Symbol.for("lit-nothing"),ko=new WeakMap,$=Q.createTreeWalker(Q,129),P=_i;function to(i,o){if(!Ai(i)||!i.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
...
`;class z{ctx;constructor(i){this.ctx=i}drawCloud(i,o,a,l){let n=this.ctx.shadowBlur,s=this.ctx.shadowColor,r=this.ctx.globalAlpha;this.ctx.shadowBlur=a*0.25,this.ctx.shadowColor=`rgba(255, 255, 255, ${l*0.4})`,this.ctx.globalAlpha=l*0.85,this.ctx.fillStyle="rgba(255, 255, 255, 1)",[{x:i,y:o,r:a*0.4},{x:i+a*0.35,y:o,r:a*0.5},{x:i+a*0.65,y:o,r:a*0.48},{x:i+a*0.92,y:o,r:a*0.38},{x:i+a*0.18,y:o-a*0.28,r:a*0.38},{x:i+a*0.52,y:o-a*0.32,r:a*0.42},{x:i+a*0.78,y:o-a*0.28,r:a*0.38},{x:i+a*0.32,y:o-a*0.42,r:a*0.32},{x:i+a*0.62,y:o-a*0.48,r:a*0.36},{x:i+a*0.82,y:o-a*0.42,r:a*0.32}].forEach((_)=>{this.ctx.beginPath(),this.ctx.arc(_.x,_.y,_.r,0,Math.PI*2),this.ctx.fill()}),this.ctx.shadowBlur=n,this.ctx.shadowColor=s,this.ctx.globalAlpha=r}drawClouds(i,o,a,l=0.5){let n=Math.max(2,Math.floor(o/150*l));for(let s=0;s<n;s++){let r=(i*3+s*150)%(o+200)-100,c=a*(0.2+s%3*0.15)+Math.sin(i*0.2+s)*8,_=40+s%3*15,h=0.6+s%2*0.2;this.drawCloud(r,c,_,h)}}}class Qi extends z{draw(i,o,a,l){let n=Date.now()*0.001,s=xo(l,o,a),r=s.x,c=s.y;if(l.type==="day"||l.type==="sunrise"||l.type==="sunset"){if(this.drawSun(r,c,n),l.type==="sunrise"||l.type==="sunset")this.drawHorizonReflection(r,c,a,n)}else if(l.type==="night")this.drawNightSky(o,a,n);this.drawClouds(n,o,a,0.3)}drawSun(i,o,a){let l=48+Math.sin(a*0.15)*1.5,n=this.ctx.createRadialGradient(i,o,l*0.3,i,o,l*3.5);n.addColorStop(0,"rgba(255, 248, 230, 0.25)"),n.addColorStop(0.15,"rgba(255, 240, 200, 0.2)"),n.addColorStop(0.3,"rgba(255, 230, 170, 0.15)"),n.addColorStop(0.5,"rgba(255, 220, 140, 0.1)"),n.addColorStop(0.7,"rgba(255, 210, 120, 0.06)"),n.addColorStop(0.85,"rgba(255, 200, 100, 0.03)"),n.addColorStop(1,"rgba(255, 190, 90, 0)"),this.ctx.fillStyle=n,this.ctx.beginPath(),this.ctx.arc(i,o,l*3.5,0,Math.PI*2),this.ctx.fill();let s=this.ctx.createRadialGradient(i,o,l*0.5,i,o,l*2.2);s.addColorStop(0,"rgba(255, 250, 220, 0.35)"),s.addColorStop(0.3,"rgba(255, 240, 190, 0.25)"),s.addColorStop(0.6,"rgba(255, 230, 160, 0.15)"),s.addColorStop(0.85,"rgba(255, 220, 140, 0.08)"),s.addColorStop(1,"rgba(255, 210, 120, 0)"),this.ctx.fillStyle=s,this.ctx.beginPath(),this.ctx.arc(i,o,l*2.2,0,Math.PI*2),this.ctx.fill();let r=this.ctx.createRadialGradient(i,o,l*0.6,i,o,l*1.6);r.addColorStop(0,"rgba(255, 252, 240, 0.5)"),r.addColorStop(0.4,"rgba(255, 245, 210, 0.35)"),r.addColorStop(0.7,"rgba(255, 235, 180, 0.2)"),r.addColorStop(1,"rgba(255, 225, 150, 0)"),this.ctx.fillStyle=r,this.ctx.beginPath(),this.ctx.arc(i,o,l*1.6,0,Math.PI*2),this.ctx.fill();let c=this.ctx.createRadialGradient(i-l*0.1,o-l*0.1,0,i,o,l);c.addColorStop(0,"#FFFEF5"),c.addColorStop(0.15,"#FFF9E6"),c.addColorStop(0.3,"#FFF4D6"),c.addColorStop(0.5,"#FFEDC0"),c.addColorStop(0.7,"#FFE4A8"),c.addColorStop(0.85,"#FFDC95"),c.addColorStop(1,"#FFD37F"),this.ctx.fillStyle=c,this.ctx.beginPath(),this.ctx.arc(i,o,l,0,Math.PI*2),this.ctx.fill()}drawHorizonReflection(i,o,a,l){let n=48+Math.sin(l*0.15)*1.5,s=a*0.85;if(o>=s-50){let r=Math.max(0,(s-o)/50)*0.3;this.ctx.fillStyle=`rgba(255, 140, 0, ${r})`,this.ctx.beginPath(),this.ctx.ellipse(i,s,n*1.5,n*0.5,0,0,Math.PI*2),this.ctx.fill()}}drawNightSky(i,o,a){this.ctx.fillStyle="#FFFFFF";for(let s=0;s<20;s++){let r=(i*0.2+s*47)%i,c=(o*0.2+s*23)%(o*0.6),_=Math.sin(a*0.8+s)*0.5+0.5;this.ctx.globalAlpha=_*0.8,this.ctx.beginPath(),this.ctx.arc(r,c,1.5,0,Math.PI*2),this.ctx.fill()}let l=i*0.75,n=o*0.3;this.ctx.globalAlpha=0.9,this.ctx.fillStyle="#F0F0F0",this.ctx.beginPath(),this.ctx.arc(l,n,25,0,Math.PI*2),this.ctx.fill(),this.ctx.fillStyle="#1a1a2e",this.ctx.beginPath(),this.ctx.arc(l-8,n-5,22,0,Math.PI*2),this.ctx.fill(),this.ctx.globalAlpha=1}}class E extends z{rainDrops=[];lastTime=0;draw(i,o,a,l,n=!1){let s=Date.now()*0.001;this.drawClouds(s,o,a,n?1:0.8),this.drawRain(o,a,n)}drawRain(i,o,a){let l=a?130:90;if(this.rainDrops.length!==l){this.rainDrops=[];for(let c=0;c<l;c++)this.rainDrops.push({x:Math.random()*i,y:Math.random()*o-Math.random()*200,speed:a?80+Math.random()*100:60+Math.random()*80,windOffset:(Math.random()-0.5)*30,width:a?1.2+Math.random()*1:0.8+Math.random()*0.7,length:a?8+Math.random()*10:6+Math.random()*8,alpha:a?0.75+Math.random()*0.15:0.65+Math.random()*0.2,phase:Math.random()*Math.PI*2})}let n=Date.now()*0.001,s=this.lastTime>0?Math.min(n-this.lastTime,0.1):0.016666666666666666;this.lastTime=n;let r=n;for(let c=0;c<this.rainDrops.length;c++){let _=this.rainDrops[c];if(_.y+=_.speed*s,_.y>o+50)_.y=-50-Math.random()*100,_.x=Math.random()*i;let h=_.windOffset*(1+Math.sin(r*0.5+_.phase)*0.2),u=_.x+h;if(u<-10)_.x=i+10;else if(u>i+10)_.x=-10;this.drawRainDrop(u,_.y,_)}}drawRainDrop(i,o,a){this.ctx.save(),this.ctx.globalAlpha=a.alpha;let l=o-a.length*0.5,n=o+a.length*0.5,s=a.alpha,r=a.alpha*0.5;this.ctx.fillStyle="rgba(220, 240, 255, "+s+")",this.ctx.strokeStyle="rgba(240, 250, 255, "+r+")",this.ctx.lineWidth=0.4,this.ctx.beginPath(),this.ctx.moveTo(i,l),this.ctx.quadraticCurveTo(i-a.width*0.3,o,i-a.width,n-a.width*0.3),this.ctx.arc(i,n,a.width,Math.PI,0,!1),this.ctx.quadraticCurveTo(i+a.width*0.3,o,i,l),this.ctx.closePath(),this.ctx.fill(),this.ctx.stroke(),this.ctx.restore()}}class xi extends z{snowflakes=[];lastTime=0;draw(i,o,a,l){let n=Date.now()*0.001;this.drawClouds(n,o,a,0.7),this.drawSnowflakes(o,a)}drawSnowflakes(i,o){let a=Math.floor(i*o/5000),l=Math.max(30,Math.min(a,80));if(this.snowflakes.length!==l){this.snowflakes=[];for(let c=0;c<l;c++)this.snowflakes.push({x:Math.random()*i,y:Math.random()*o-Math.random()*100,speedY:15+Math.random()*10,speedX:(Math.random()-0.5)*8,size:1.5+Math.random()*1.5,alpha:0.6+Math.random()*0.3,rotation:Math.random()*Math.PI*2,rotationSpeed:(Math.random()-0.5)*0.3,swayPhase:Math.random()*Math.PI*2,swaySpeed:0.5+Math.random()*0.5})}let n=Date.now()*0.001,s=this.lastTime>0?Math.min(n-this.lastTime,0.1):0.016666666666666666;this.lastTime=n;let r=n;this.ctx.lineCap="round";for(let c=0;c<this.snowflakes.length;c++){let _=this.snowflakes[c],h=Math.sin(r*_.swaySpeed+_.swayPhase)*2;if(_.y+=_.speedY*s,_.x+=(_.speedX+h)*s,_.rotation+=_.rotationSpeed*s,_.y>o+20)_.y=-20-Math.random()*50,_.x=Math.random()*i;if(_.x<-10)_.x=i+10;else if(_.x>i+10)_.x=-10;this.drawSnowflake(_.x,_.y,_.size,_.alpha,_.rotation)}}drawSnowflake(i,o,a,l,n){this.ctx.save(),this.ctx.translate(i,o),this.ctx.rotate(n),this.ctx.strokeStyle=`rgba(255, 255, 255, ${l})`,this.ctx.lineWidth=1,this.ctx.beginPath();for(let s=0;s<6;s++){let r=Math.PI/3*s,c=Math.cos(r),_=Math.sin(r);this.ctx.moveTo(0,0),this.ctx.lineTo(_*a*2.5,c*a*2.5);let h=_*a*1.5+c*a*0.5,u=c*a*1.5-_*a*0.5,f=_*a*1.8+c*a*1.2,m=c*a*1.8-_*a*1.2;this.ctx.moveTo(h,u),this.ctx.lineTo(f,m);let p=_*a*1.5-c*a*0.5,K=c*a*1.5+_*a*0.5,fi=_*a*1.8-c*a*1.2,ti=c*a*1.8+_*a*1.2;this.ctx.moveTo(p,K),this.ctx.lineTo(fi,ti)}this.ctx.stroke(),this.ctx.restore()}}class Pi extends z{draw(i,o,a,l){let n=Date.now()*0.001;this.drawClouds(n,o,a,0.7)}}class Ci extends z{draw(i,o,a,l){let n=Date.now()*0.0003;this.ctx.fillStyle="rgba(200, 200, 200, 0.4)";for(let s=0;s<3;s++){let r=a*(0.4+s*0.2),c=Math.sin(n+s)*20;this.ctx.beginPath(),this.ctx.moveTo(0,r);for(let _=0;_<=o;_+=5){let h=Math.sin((_/o+n)*Math.PI*4+s)*15;this.ctx.lineTo(_,r+h+c)}this.ctx.lineTo(o,a),this.ctx.lineTo(0,a),this.ctx.closePath(),this.ctx.fill()}}}class ji extends z{hailStones=[];draw(i,o,a,l){let n=Date.now()*0.001;this.drawClouds(n,o,a,1),this.drawHailStones(o,a)}drawHailStones(i,o){if(this.hailStones.length!==60){this.hailStones=[];for(let n=0;n<60;n++)this.hailStones.push({startX:Math.random()*i,startY:Math.random()*(o+150)-75,speed:120+Math.random()*80,windOffset:(Math.random()-0.5)*20,size:2+Math.random()*3,alpha:0.8+Math.random()*0.15,phase:Math.random()*Math.PI*2})}let l=Date.now()*0.002;this.ctx.fillStyle="rgba(240, 250, 255, 1)",this.ctx.strokeStyle="rgba(255, 255, 255, 0.9)",this.ctx.lineWidth=0.5;for(let n=0;n<this.hailStones.length;n++){let s=this.hailStones[n],r=(s.startY+l*s.speed)%(o+150);if(r>o+30)s.startY=-30-Math.random()*30,s.startX=Math.random()*i;let c=s.windOffset*(1+Math.sin(l*0.6+s.phase)*0.15),_=(s.startX+c+l*20%i)%i;if(_<-5)s.startX=i+5;else if(_>i+5)s.startX=-5;this.drawHailStone(_,r,s)}}drawHailStone(i,o,a){this.ctx.save(),this.ctx.globalAlpha=a.alpha,this.ctx.beginPath(),this.ctx.ellipse(i,o,a.size,a.size*0.9,0,0,Math.PI*2),this.ctx.fill(),this.ctx.stroke(),this.ctx.fillStyle="rgba(255, 255, 255, 0.6)",this.ctx.beginPath(),this.ctx.ellipse(i-a.size*0.3,o-a.size*0.3,a.size*0.3,a.size*0.25,0,0,Math.PI*2),this.ctx.fill(),this.ctx.fillStyle="rgba(240, 250, 255, 1)",this.ctx.restore()}}class Gi extends z{rainyAnimation;constructor(i){super(i);this.rainyAnimation=new E(i)}draw(i,o,a,l,n=!0){let s=Date.now()*0.001;if(this.drawClouds(s,o,a,1),n)this.rainyAnimation.draw(i,o,a,l,!1);this.drawLightning(o,a,s)}drawLightning(i,o,a){let l=Math.sin(a*2.5)*Math.sin(a*5.3)*Math.sin(a*7.1),n=Math.max(0,l);if(n>0.4){let s=(n-0.4)/0.6,r=s*0.6,c=Math.min(r,Math.sin(s*Math.PI)*0.6);this.ctx.fillStyle=`rgba(255, 255, 255, ${c})`,this.ctx.fillRect(0,0,i,o)}}}class Di{canvas=null;ctx=null;animationFrame=null;animations={};resizeObserver=null;width=0;height=0;container=null;getDrawParams;handleVisibilityChange=()=>{if(document.hidden)this.stopAnimation();else this.startAnimation()};constructor(i){this.getDrawParams=i}setup(i){if(this.container=i,this.setupCanvas(),this.canvas&&this.ctx)this.initializeAnimations(),this.startAnimation(),this.setupResizeObserver(),document.addEventListener("visibilitychange",this.handleVisibilityChange)}destroy(){if(document.removeEventListener("visibilitychange",this.handleVisibilityChange),this.stopAnimation(),this.resizeObserver)this.resizeObserver.disconnect(),this.resizeObserver=null;this.canvas=null,this.ctx=null,this.container=null}resize(){if(this.canvas&&this.ctx)this.resizeCanvas()}setupCanvas(){if(!this.container)return;let i=this.container.querySelector("canvas");if(i)i.remove();this.canvas=document.createElement("canvas"),this.container.appendChild(this.canvas),this.resizeCanvas()}resizeCanvas(){if(!this.canvas||!this.container)return;let i=this.container.getBoundingClientRect();if(i.width===0||i.height===0)return;let o=window.devicePixelRatio||2;if(this.canvas.width=i.width*o,this.canvas.height=i.height*o,this.canvas.style.width="100%",this.canvas.style.height="100%",this.ctx=this.canvas.getContext("2d"),this.ctx)this.ctx.scale(o,o);this.width=i.width,this.height=i.height,this.initializeAnimations()}setupResizeObserver(){if(!this.container)return;this.resizeObserver=new ResizeObserver(()=>{this.resizeCanvas()}),this.resizeObserver.observe(this.container)}initializeAnimations(){if(!this.ctx)return;this.animations={sunny:new Qi(this.ctx),rainy:new E(this.ctx),snowy:new xi(this.ctx),cloudy:new Pi(this.ctx),foggy:new Ci(this.ctx),hail:new ji(this.ctx),thunderstorm:new Gi(this.ctx)}}startAnimation(){if(this.animationFrame)return;let i=()=>{this.draw(),this.animationFrame=requestAnimationFrame(i)};i()}stopAnimation(){if(this.animationFrame)cancelAnimationFrame(this.animationFrame),this.animationFrame=null}draw(){if(!this.ctx||!this.canvas)return;if(!this.width||!this.height){if(this.resizeCanvas(),!this.width||!this.height)return}let i=this.getDrawParams();if(!i)return;let{condition:o,timeOfDay:a}=i,l=this.width,n=this.height;switch(this.ctx.clearRect(0,0,l,n),o.toLowerCase()){case"sunny":case"clear":this.animations.sunny?.draw(Date.now(),l,n,a);break;case"clear-night":this.animations.sunny?.draw(Date.now(),l,n,{type:"night",progress:0});break;case"rainy":case"rain":this.animations.rainy?.draw(Date.now(),l,n,a,!1);break;case"pouring":this.animations.rainy?.draw(Date.now(),l,n,a,!0);break;case"snowy":case"snow":this.animations.snowy?.draw(Date.now(),l,n,a);break;case"snowy-rainy":this.animations.rainy?.draw(Date.now(),l,n,a,!1),this.animations.snowy?.draw(Date.now(),l,n,a);break;case"hail":this.animations.hail?.draw(Date.now(),l,n,a);break;case"foggy":case"fog":this.animations.foggy?.draw(Date.now(),l,n,a);break;case"lightning":this.animations.thunderstorm?.draw(Date.now(),l,n,a,!1);break;case"lightning-rainy":this.animations.thunderstorm?.draw(Date.now(),l,n,a,!0);break;case"cloudy":case"partlycloudy":default:this.animations.cloudy?.draw(Date.now(),l,n,a);break}}}class Ti{hourlyForecast=[];dailyForecast=[];hourlySubscription=null;dailySubscription=null;onUpdate;constructor(i){this.onUpdate=i}getHourlyData(){return this.hourlyForecast}getDailyData(){return this.dailyForecast}async subscribe(i,o,a){if(!i||!o)return;this.unsubscribe();try{if(this.hourlySubscription=i.connection.subscribeMessage((l)=>{if(l.forecast&&l.forecast.length>0)this.hourlyForecast=l.forecast,this.onUpdate()},{type:"weather/subscribe_forecast",forecast_type:"hourly",entity_id:o}),a)this.dailySubscription=i.connection.subscribeMessage((l)=>{if(l.forecast&&l.forecast.length>0)this.dailyForecast=l.forecast,this.onUpdate()},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:o})}catch{}}async unsubscribe(){if(this.hourlySubscription){try{(await this.hourlySubscription)()}catch{}this.hourlySubscription=null}if(this.dailySubscription){try{(await this.dailySubscription)()}catch{}this.dailySubscription=null}}getHourlyForecast(i,o){let a=Math.max(1,Math.floor(Number(i??g.hourlyForecastHours)));if(this.hourlyForecast&&this.hourlyForecast.length>0)return this.hourlyForecast.slice(0,a);if(!o?.forecast||o.forecast.length===0)return[];let l=new Date,n=new Date(l.getFullYear(),l.getMonth(),l.getDate()),s=new Date(n);return s.setDate(s.getDate()+1),o.forecast.filter((c)=>{if(!c.datetime)return!1;let _=new Date(c.datetime),h=new Date(_.getFullYear(),_.getMonth(),_.getDate());return h.getTime()===n.getTime()||h.getTime()===s.getTime()&&_.getHours()<=l.getHours()}).sort((c,_)=>new Date(c.datetime).getTime()-new Date(_.datetime).getTime()).slice(0,a)}getDailyForecast(i,o){let a=Math.max(1,Math.floor(Number(i??g.dailyForecastDays)));if(this.dailyForecast&&this.dailyForecast.length>0)return this.dailyForecast.slice(0,a);if(!o?.forecast||o.forecast.length===0)return[];let l=new Date,n=new Date(l.getFullYear(),l.getMonth(),l.getDate()),s=new Date(n);s.setDate(s.getDate()+a);let r=(_)=>{let h=_.getFullYear(),u=String(_.getMonth()+1).padStart(2,"0"),f=String(_.getDate()).padStart(2,"0");return`${h}-${u}-${f}`},c=new Map;return o.forecast.forEach((_)=>{if(!_.datetime)return;let h=new Date(_.datetime);if(Number.isNaN(h.getTime()))return;if(h<n||h>=s)return;let u=r(h),f=Math.abs(h.getHours()+h.getMinutes()/60-12),m=c.get(u);if(!m||f<m.hourScore)c.set(u,{item:_,itemDate:h,hourScore:f})}),Array.from(c.values()).sort((_,h)=>_.itemDate.getTime()-h.itemDate.getTime()).map((_)=>_.item).slice(0,a)}}class Vi{holdTimer=null;lastTap=null;holdFired=!1;holdDelay=500;getHass;getConfig;fireEvent;constructor(i,o,a){this.getHass=i,this.getConfig=o,this.fireEvent=a}handleTap(i){if(i.target.closest(".forecast-item")||i.target.closest(".info-item"))return;if(this.lastTap&&Date.now()-this.lastTap<300){this.handleDoubleTap(),this.lastTap=null;return}this.lastTap=Date.now(),setTimeout(()=>{if(this.lastTap)this.handleAction(this.getConfig().tapAction),this.lastTap=null},300)}handlePointerDown(){this.holdTimer=window.setTimeout(()=>{this.handleHold(),this.holdFired=!0},this.holdDelay)}handlePointerUp(i){if(this.holdTimer)clearTimeout(this.holdTimer);if(this.holdFired)i.preventDefault(),i.stopPropagation(),this.holdFired=!1}handleHold(){this.handleAction(this.getConfig().holdAction)}handleDoubleTap(){this.handleAction(this.getConfig().doubleTapAction)}handleAction(i){let o=this.getHass(),a=this.getConfig();if(!i||!o)return;switch(i.action||"more-info"){case"more-info":this.fireEvent("hass-more-info",{entityId:i.entity||a.entity});break;case"toggle":o.callService("homeassistant","toggle",{entity_id:i.entity||a.entity});break;case"call-service":if(i.service){let[n,s]=i.service.split(".");o.callService(n,s,i.service_data||{})}break;case"navigate":if(i.navigation_path)window.history.pushState(null,"",i.navigation_path),this.fireEvent("location-changed",{replace:!1});break;case"url":if(i.url_path)window.open(i.url_path);break;case"none":default:break}}}function Ra(i,o){if(!i||!o)return null;let a=i.states[o];return a?a.state:null}function ui(i,o){if(!i||!o)return{};let a=i.states[o];return a?a.attributes:{}}function Ui(i,o,a,l){let n=Ra(i,o),s=ui(i,o),r=s.condition||n||"sunny",c=null;if(a.templowAttribute&&s[a.templowAttribute]!=null)c=s[a.templowAttribute];else{for(let _ of Ao)if(s[_]!=null){c=s[_];break}if(c==null)c=(s.forecast&&s.forecast[0]?s.forecast[0].templow??null:null)||(s.forecast_hourly&&s.forecast_hourly[0]?s.forecast_hourly[0].native_templow??null:null)}return{condition:r,temperature:s.temperature!=null?s.temperature:null,apparentTemperature:s.apparent_temperature||null,humidity:s.humidity!=null?s.humidity:null,windSpeed:s.wind_speed!=null?s.wind_speed:null,windGust:s.wind_gust_speed||s.wind_gust||null,windBearing:s.wind_bearing!=null?s.wind_bearing:null,windDirection:s.wind_direction||null,pressure:s.pressure||null,forecast:s.forecast||s.forecast_hourly||l||[],friendlyName:s.friendly_name||d.t("weather"),templow:c}}class Vo extends b{constructor(){super(...arguments);this.format=null;this.currentTime=""}clockInterval=null;static styles=S`
    :host {
      display: block;
    }
  ...
  `;connectedCallback(){if(super.connectedCallback(),this.format)this.updateTime(),this.clockInterval=window.setInterval(()=>this.updateTime(),1000)}disconnectedCallback(){if(super.disconnectedCallback(),this.clockInterval)clearInterval(this.clockInterval),this.clockInterval=null}updated(i){if(super.updated(i),i.has("format")){if(this.clockInterval)clearInterval(this.clockInterval),this.clockInterval=null;if(this.format)this.updateTime(),this.clockInterval=window.setInterval(()=>this.updateTime(),1000)}}updateTime(){if(!this.format)return;this.currentTime=Do(new Date,this.format,d.t("am"),d.t("pm"))}render(){if(!this.format)return k``;return k`<div class="clock">${this.currentTime}</div>`}}t([w({type:String})],Vo.prototype,"format",void 0),t([di()],Vo.prototype,"currentTime",void 0);customElements.define("weather-clock",Vo);var Xa={wind:y`
...
`,Ya={sunny:y`
  ...
  `};function ii(i,...o){let a=Xa[i];if(typeof a==="function")return a(...o);return a||""}function ki(i){if(!i)return"";return Ya[i.toLowerCase()]||""}class Ro extends b{constructor(){super(...arguments);this.weather=null;this.sunData=null;this.config=null;this.entityAttributes=null;this.compact=!1}static styles=S`
    :host {
      display: block;
    }
  ...
  `;hasContent(){if(!this.weather||!this.config)return!1;return this.config.showHumidity&&this.weather.humidity!=null||this.config.showWind&&this.weather.windSpeed!=null||this.config.showSunriseSunset&&this.sunData?.hasSunData===!0}renderHumidity(){if(!this.config?.showHumidity||this.weather?.humidity==null)return k``;return k`
    ...
    `}renderSunrise(){if(!this.config?.showSunriseSunset||!this.sunData?.hasSunData||!this.sunData.sunrise)return k``;return k`
      <div class="info-item">
        ...
        <span>${Wi(this.sunData.sunrise,this.config.clockFormat,d.t("am"),d.t("pm"))}</span>
      </div>
    `}renderWind(){if(!this.config?.showWind||this.weather?.windSpeed==null)return k``;let i=this.entityAttributes||{},o=$i(this.weather.windSpeed,i,this.config.windSpeedUnit),a=Go(i,this.config.windSpeedUnit,d.t.bind(d)),l="";if(this.config.showWindGust&&this.weather.windGust)l=` / ${$i(this.weather.windGust,i,this.config.windSpeedUnit)} ${a}`;let n=this.config.showWindDirection&&this.weather.windBearing!=null?Uo(this.weather.windBearing):ii("wind");return k`
      <div class="info-item">
    ...
    `}renderSunset(){if(!this.config?.showSunriseSunset||!this.sunData?.hasSunData||!this.sunData.sunset)return k``;return k`
      <div class="info-item">
        ...
        <span>${Wi(this.sunData.sunset,this.config.clockFormat,d.t("am"),d.t("pm"))}</span>
      </div>
    ...
    `}}t([w({type:Object})],Ro.prototype,"weather",void 0),t([w({type:Object})],Ro.prototype,"sunData",void 0),t([w({type:Object})],Ro.prototype,"config",void 0),t([w({type:Object})],Ro.prototype,"entityAttributes",void 0),t([w({type:Boolean,reflect:!0})],Ro.prototype,"compact",void 0);customElements.define("weather-details",Ro);var ei=S`
  :host {
    display: block;
  }
...
`;class Xo extends b{constructor(){super(...arguments);this.forecast=[];this.clockFormat="24h"}static styles=ei;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=hi(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(i){return Math.round(i.temperature??i.temp??i.native_temperature??0)}render(){if(this.forecast.length===0)return k``;return k`
      <div class="forecast-container">
        <div class="forecast-title">${d.t("forecast_title")}</div>
        <div class="forecast-scroll">
          ${this.forecast.map((i)=>k`
            <div class="forecast-item">
              <div class="forecast-time">${Co(i.datetime,this.clockFormat,d.t("am"),d.t("pm"))}</div>
              <div class="forecast-icon">${ki(i.condition||"sunny")}</div>
              <div class="forecast-temp">${this.getTemperature(i)}°</div>
            </div>
          `)}
        </div>
      </div>
    `}}t([w({type:Array})],Xo.prototype,"forecast",void 0),t([w({type:String})],Xo.prototype,"clockFormat",void 0);customElements.define("hourly-forecast",Xo);class Yo extends b{constructor(){super(...arguments);this.forecast=[];this.lang="en"}static styles=ei;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=hi(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(i){return Math.round(i.temperature??i.temp??i.native_temperature??0)}render(){if(this.forecast.length===0)return k``;return k`
      <div class="forecast-container">
        <div class="forecast-title">${d.t("daily_forecast_title")}</div>
        <div class="forecast-scroll">
          ${this.forecast.map((i)=>k`
            <div class="forecast-item">
              <div class="forecast-time">${jo(i.datetime,this.lang)}</div>
              <div class="forecast-icon">${ki(i.condition||"sunny")}</div>
              <div class="forecast-temp">${this.getTemperature(i)}°</div>
            </div>
          `)}
    ...
    `}}t([w({type:Array})],Yo.prototype,"forecast",void 0),t([w({type:String})],Yo.prototype,"lang",void 0);customElements.define("daily-forecast",Yo);class Ri extends b{animationManager;forecastService;actionHandler;subscribedEntity=null;subscribedShowDaily=!1;_testTimeOfDay;static get styles(){return To}static getConfigElement(){return document.createElement("dynamic-weather-card-editor")}static getStubConfig(){return{type:"custom:dynamic-weather-card",entity:"weather.home",show_hourly_forecast:!0,hourly_forecast_hours:g.hourlyForecastHours,show_daily_forecast:!0,daily_forecast_days:g.dailyForecastDays}}constructor(){super();this.config={},this.animationManager=new Di(()=>this.getDrawParams()),this.forecastService=new Ti(()=>this.requestUpdate()),this.actionHandler=new Vi(()=>this.hass,()=>this.config,(i,o)=>this.fireEvent(i,o))}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{setTimeout(()=>{let i=this.shadowRoot?.querySelector(".canvas-container");if(i)this.animationManager.setup(i)},100)})}disconnectedCallback(){super.disconnectedCallback(),this.animationManager.destroy(),this.forecastService.unsubscribe()}updated(i){if(super.updated(i),i.has("hass")||i.has("config")){let a=this.config.entity,l=this.config.showDailyForecast??!1;if(this.hass&&a&&(a!==this.subscribedEntity||l!==this.subscribedShowDaily))this.subscribedEntity=a,this.subscribedShowDaily=l,this.forecastService.subscribe(this.hass,a,l)}let o=O({configLang:this.config?.language,hassLang:this.hass?.language});if(d.lang!==o)d.setLanguage(o)}getDrawParams(){if(!this.hass||!this.config.entity)return null;let i=Ui(this.hass,this.config.entity,this.config,this.forecastService.getHourlyData()),o=this.hass.states[this.config.entity],a=Si(o||{},this.config.sunriseEntity,this.config.sunsetEntity,this.hass),l=this._testTimeOfDay||Bi(a);return{condition:i.condition,timeOfDay:l}}getDetailsConfig(){return{showHumidity:this.config.showHumidity??!0,showWind:this.config.showWind??!0,showWindGust:this.config.showWindGust??!0,showWindDirection:this.config.showWindDirection??!0,showSunriseSunset:this.config.showSunriseSunset??!0,clockFormat:this.config.clockFormat??"24h",windSpeedUnit:this.config.windSpeedUnit??"ms"}}setConfig(i){if(!i.entity)throw Error("Please define a weather entity");let o=i.show_hourly_forecast??i.show_forecast;if(this.config={type:"custom:dynamic-weather-card",entity:i.entity,icons_path:i.icons_path,name:i.name,height:i.height||g.height,showFeelsLike:i.show_feels_like!==!1,showWind:i.show_wind!==!1,showWindGust:i.show_wind_gust!==!1,showWindDirection:i.show_wind_direction!==!1,showHumidity:i.show_humidity!==!1,showMinTemp:i.show_min_temp!==!1,showForecast:i.show_forecast===!0,showHourlyForecast:o===!0,showDailyForecast:i.show_daily_forecast===!0,hourlyForecastHours:i.hourly_forecast_hours??g.hourlyForecastHours,dailyForecastDays:i.daily_forecast_days??g.dailyForecastDays,showSunriseSunset:i.show_sunrise_sunset!==!1,showClock:i.show_clock===!0,clockPosition:i.clock_position||g.clockPosition,clockFormat:i.clock_format||g.clockFormat,overlayOpacity:i.overlay_opacity!==void 0?i.overlay_opacity:g.overlayOpacity,textShadow:i.text_shadow!==void 0?i.text_shadow:g.textShadow,language:i.language||g.language,windSpeedUnit:i.wind_speed_unit||g.windSpeedUnit,layout:i.layout||g.layout,sunriseEntity:i.sunrise_entity||null,sunsetEntity:i.sunset_entity||null,templowAttribute:i.templow_attribute||null,tapAction:i.tap_action||{action:"more-info"},holdAction:i.hold_action||{action:"none"},doubleTapAction:i.double_tap_action||{action:"none"}},this.config.language)d.setLanguage(this.config.language)}fireEvent(i,o={}){let a=new CustomEvent(i,{detail:o,bubbles:!0,composed:!0});this.dispatchEvent(a)}getCardSize(){return 1}render(){if(!this.hass)return k`<div>No Home Assistant connection</div>`;let i=Ui(this.hass,this.config.entity,this.config,this.forecastService.getHourlyData()),o=this.hass.states[this.config.entity],a=Si(o,this.config.sunriseEntity,this.config.sunsetEntity,this.hass),l=this._testTimeOfDay||Bi(a),n=`weather-card ${l.type}`,s=this.config.layout==="minimal",r=s?"56px":"200px",c=this.config.height?`${this.config.height}px`:r,_=Po(l),h=_?`background: linear-gradient(135deg, rgb(${_.start.r}, ${_.start.g}, ${_.start.b}), rgb(${_.end.r}, ${_.end.g}, ${_.end.b}));`:"",f=`--overlay-opacity: ${this.config.overlayOpacity!==void 0?this.config.overlayOpacity:g.overlayOpacity};`,m=this.config.textShadow??g.textShadow,p=m===0?"none":[`0 1px 2px rgba(0,0,0,${Math.min(1,0.4*m).toFixed(2)})`,`0 2px 6px rgba(0,0,0,${Math.min(1,0.3*m).toFixed(2)})`,`0 4px 12px rgba(0,0,0,${Math.min(1,0.2*m).toFixed(2)})`].join(", "),K=m===0?"none":`drop-shadow(0px 1px 3px rgba(0,0,0,${Math.min(1,0.6*m).toFixed(2)}))`,fi=`--card-text-shadow: ${p}; --card-icon-filter: ${K};`,ti=this.config.showHourlyForecast?this.forecastService.getHourlyForecast(this.config.hourlyForecastHours??g.hourlyForecastHours,i):[],oa=this.config.showDailyForecast?this.forecastService.getDailyForecast(this.config.dailyForecastDays??g.dailyForecastDays,i):[],Ii=`min-height: ${c}; ${h}; ${f} ${fi} cursor: pointer;`,Oi=this.hass;return k`
      <ha-card
        @click=${(G)=>this.actionHandler.handleTap(G)}
        @pointerdown=${()=>this.actionHandler.handlePointerDown()}
        @pointerup=${(G)=>this.actionHandler.handlePointerUp(G)}
        @pointercancel=${(G)=>this.actionHandler.handlePointerUp(G)}
      >
        ${s?this.renderMinimal(i,a,Oi,n,Ii):this.renderDefault(i,a,ti,oa,Oi,n,Ii)}
      </ha-card>
    `}renderDefault(i,o,a,l,n,s,r){return k`
      <div class="${s}" style="${r}">
        ...
        <div class="content">
          ...
          <div class="details ${this.config.showClock&&this.config.clockPosition==="details"?"details--clock":""}">
            <weather-details
              ...
              .entityAttributes=${ui(n,this.config.entity)}
            ></weather-details>
            <weather-clock
    ...
    `}renderMinimal(i,o,a,l,n){let s=i.temperature!=null?Math.round(i.temperature)+"°":d.t("no_data"),r=i.templow!=null?`↓ ${Math.round(i.templow)}°`:null;return k`
      <div class="${l} layout--minimal" style="${n}">
        <div class="canvas-container"></div>
        <div class="content">
          ...
          <div class="mini-details">
            ...
            <weather-details
              ...
              .sunData=${o}
              .config=${this.getDetailsConfig()}
              .entityAttributes=${ui(a,this.config.entity)}
              .compact=${!0}
            ></weather-details>
          </div>
    ...
    `}}t([w({type:Object})],Ri.prototype,"hass",void 0),t([w({type:Object})],Ri.prototype,"config",void 0);class Xi extends b{constructor(){super(...arguments);this._config={}}setConfig(i){this._config={name:"",layout:g.layout,height:g.height,show_feels_like:g.showFeelsLike,show_wind:g.showWind,show_wind_gust:g.showWindGust,show_wind_direction:g.showWindDirection,show_humidity:g.showHumidity,show_min_temp:g.showMinTemp,show_hourly_forecast:g.showHourlyForecast,hourly_forecast_hours:g.hourlyForecastHours,show_daily_forecast:g.showDailyForecast,daily_forecast_days:g.dailyForecastDays,show_sunrise_sunset:g.showSunriseSunset,show_clock:g.showClock,clock_position:g.clockPosition,clock_format:g.clockFormat,overlay_opacity:g.overlayOpacity,language:g.language,wind_speed_unit:g.windSpeedUnit,sunrise_entity:"",sunset_entity:"",...i}}updated(i){if(super.updated(i),i.has("hass")){let o=O({hassLang:this.hass?.language});if(d.lang!==o)d.setLanguage(o),this.requestUpdate()}}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:["weather"]}}},{name:"name",selector:{text:{}}},{name:"layout",selector:{select:{options:[{label:d.t("editor.layout_default"),value:"default"},{label:d.t("editor.layout_minimal"),value:"minimal"}]}}},{name:"height",selector:{number:{min:50,max:800,step:10,mode:"box"}}},{name:"show_feels_like",selector:{boolean:{}}},{name:"show_wind",selector:{boolean:{}}},{name:"show_wind_gust",selector:{boolean:{}}},{name:"show_wind_direction",selector:{boolean:{}}},{name:"show_humidity",selector:{boolean:{}}},{name:"show_min_temp",selector:{boolean:{}}},{name:"show_hourly_forecast",selector:{boolean:{}}},{name:"hourly_forecast_hours",selector:{number:{min:1,max:24,step:1,mode:"box"}}},{name:"show_daily_forecast",selector:{boolean:{}}},{name:"daily_forecast_days",selector:{number:{min:1,max:14,step:1,mode:"box"}}},{name:"show_sunrise_sunset",selector:{boolean:{}}},{name:"sunrise_entity",selector:{entity:{domain:["sensor"]}}},{name:"sunset_entity",selector:{entity:{domain:["sensor"]}}},{name:"show_clock",selector:{boolean:{}}},{name:"clock_position",selector:{select:{options:[{label:d.t("editor.clock_position_top"),value:"top"},{label:d.t("editor.clock_position_details"),value:"details"}]}}},{name:"clock_format",selector:{select:{options:[{label:d.t("editor.clock_format_24h"),value:"24h"},{label:d.t("editor.clock_format_12h"),value:"12h"}]}}},{name:"overlay_opacity",selector:{number:{min:0,max:1,step:0.05,mode:"box"}}},{name:"language",selector:{select:{options:[{label:d.t("editor.language_auto"),value:"auto"},{label:d.t("editor.language_en"),value:"en"},{label:d.t("editor.language_ru"),value:"ru"},{label:d.t("editor.language_de"),value:"de"},{label:d.t("editor.language_nl"),value:"nl"},{label:d.t("editor.language_fr"),value:"fr"},{label:d.t("editor.language_es"),value:"es"},{label:d.t("editor.language_it"),value:"it"},{label:d.t("editor.language_sk"),value:"sk"},{label:d.t("editor.language_hu"),value:"hu"}]}}},{name:"wind_speed_unit",selector:{select:{options:[{label:d.t("editor.wind_speed_unit_ms"),value:"ms"},{label:d.t("editor.wind_speed_unit_kmh"),value:"kmh"}]}}}]}_computeLabel=(i)=>{let o=`editor.${i.name}`,a=d.t(o);return a===o?i.name:a};_valueChanged(i){let o=i.detail?.value;if(!o)return;this._config=o,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}render(){if(!this.hass)return k``;return k`
      ...
      ></ha-form>
    `}}t([w({attribute:!1})],Xi.prototype,"hass",void 0),t([di()],Xi.prototype,"_config",void 0);var Lo={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Io=(i)=>(...o)=>({["_$litDirective$"]:i,values:o});class Yi{constructor(i){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(i,o,a){this.__part=i,this._$parent=o,this.__attributeIndex=a}_$resolve(i,o){return this.update(i,o)}update(i,o){return this.render(...o)}}var La=!0,hr=La&&window.ShadyDOM?.inUse&&window.ShadyDOM?.noPatch===!0?window.ShadyDOM.wrap:(i)=>i;var Oo=(i)=>i.strings===void 0;var Ia=!0,oi=(i,o)=>{let a=i._$disconnectableChildren;if(a===void 0)return!1;for(let l of a)l._$notifyDirectiveConnectionChanged?.(o,!1),oi(l,o);return!0},yi=(i)=>{let o,a;do{if((o=i._$parent)===void 0)break;a=o._$disconnectableChildren,a.delete(i),i=o}while(a?.size===0)},Eo=(i)=>{for(let o;o=i._$parent;i=o){let a=o._$disconnectableChildren;if(a===void 0)o._$disconnectableChildren=a=new Set;else if(a.has(i))break;a.add(i),il(o)}};function Oa(i){if(this._$disconnectableChildren!==void 0)yi(this),this._$parent=i,Eo(this);else this._$parent=i}function Ea(i,o=!1,a=0){let l=this._$committedValue,n=this._$disconnectableChildren;if(n===void 0||n.size===0)return;if(o){if(Array.isArray(l))for(let s=a;s<l.length;s++)oi(l[s],!1),yi(l[s]);else if(l!=null)oi(l,!1),yi(l)}else oi(this,i)}var il=(i)=>{if(i.type==Lo.CHILD)i._$notifyConnectionChanged??=Ea,i._$reparentDisconnectables??=Oa};class Li extends Yi{constructor(){super(...arguments);this._$disconnectableChildren=void 0}_$initialize(i,o,a){super._$initialize(i,o,a),Eo(this),this.isConnected=i._$isConnected}["_$notifyDirectiveConnectionChanged"](i,o=!0){if(i!==this.isConnected)if(this.isConnected=i,i)this.reconnected?.();else this.disconnected?.();if(o)oi(this,i),yi(this)}setValue(i){if(Oo(this.__part))this.__part._$setValue(i,this);else{if(Ia&&this.__attributeIndex===void 0)throw Error("Expected this.__attributeIndex to be a number");let o=[...this.__part._$committedValue];o[this.__attributeIndex]=i,this.__part._$setValue(o,this,0)}}disconnected(){}reconnected(){}}class ia extends Li{_key="";_onLangChange=null;render(i){return this._key=i,d.t(i)}reconnected(){this._onLangChange=()=>{this.setValue(d.t(this._key))},window.addEventListener("language-changed",this._onLangChange)}disconnected(){if(this._onLangChange)window.removeEventListener("language-changed",this._onLangChange)}}var ol=Io(ia);try{customElements.define("dynamic-weather-card",Ri),customElements.define("dynamic-weather-card-editor",Xi),console.log(`%cDynamic Weather Card %c${vo}`,"color: #007AFF; font-weight: bold; font-size: 14px;","color: #666; font-size: 12px;",`
Динамическая карточка погоды`),window.customCards=window.customCards||[];let i={type:"dynamic-weather-card",name:"Dynamic Weather Card",description:"Динамическая карточка погоды",preview:!0,documentationURL:"https://github.com/teuchezh/dynamic-weather-card"};window.customCards.push(i)}catch(i){console.error("❌ Ошибка при регистрации Dynamic Weather Card:",i)}export{ol as t,O as resolveLanguage,d as i18n};
